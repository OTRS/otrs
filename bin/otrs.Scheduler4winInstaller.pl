...
# --
# $Id: otrs.Scheduler4winInstaller.pl,v 1.1 2011-02-08 16:50:21 cr Exp $
# --
...
my %ServiceConfig = (
    ...
    user       => '',
    passwd     => '',
    parameters => '"' . $WorkDir . '\otrs.Scheduler4win.pl' . '"',
...
# Internal
sub _help {
    print "otrs.Scheduler4WinInstaller.pl <Revision $VERSION> - OTRS Schaduler Deamon\n";

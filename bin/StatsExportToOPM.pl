...
# --
# $Id: StatsExportToOPM.pl,v 1.1 2006-12-04 07:06:00 tr Exp $
# --
...
# check needed params
if ($Opts{'h'}) {
    print "StatsExportToOPM.pl <Revision $VERSION> - export all stats of a system and create a package for the package manager\n";
    print "Copyright (c) 2001-2006 OTRS GmbH, http//otrs.org/\n";
    print "usage: StatsExportToOPM.pl [-n <PACKAGE_NAME>] [-v <PACKAGE_VERSION>]\n";
    print "       [-d 'yes' for delete existing stats if the opm will be installed] [-h for help]\n";
    exit 1;
}
if ($Opts{'n'}) {
    $PackageName = $Opts{'n'};

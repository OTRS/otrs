#!/usr/bin/perl -w
# --
# public.pl - the global FastCGI handle file for OTRS
# Copyright (C) 2001-2009 OTRS AG, http://otrs.org/
# --
# $Id: public.pl,v 1.1.2.1 2009-12-02 08:38:36 mb Exp $
# --
...
while (my $WebRequest = new CGI::Fast) {
    # create new object
    my $Interface = Kernel::System::Web::InterfacePublic->new(Debug => $Debug, WebRequest => $WebRequest);

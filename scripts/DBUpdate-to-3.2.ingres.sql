-- ----------------------------------------------------------
--  driver: ingres, generated: 2012-07-19 10:27:17
-- ----------------------------------------------------------
-- ----------------------------------------------------------
--  alter table ticket
-- ----------------------------------------------------------
...
CREATE SEQUENCE pm_process_145;\g
CREATE TABLE pm_process (
    id INTEGER NOT NULL DEFAULT pm_process_145.NEXTVAL,
...
CREATE SEQUENCE pm_activity_377;\g
CREATE TABLE pm_activity (
    id INTEGER NOT NULL DEFAULT pm_activity_377.NEXTVAL,
    entity_id VARCHAR(50) NOT NULL,
    name VARCHAR(200) NOT NULL,
    config LONG BYTE NOT NULL,
    create_time TIMESTAMP NOT NULL,
...
CREATE SEQUENCE pm_activity_dialog_754;\g
CREATE TABLE pm_activity_dialog (
    id INTEGER NOT NULL DEFAULT pm_activity_dialog_754.NEXTVAL,
    entity_id VARCHAR(50) NOT NULL,
    name VARCHAR(200) NOT NULL,
    config LONG BYTE NOT NULL,
    create_time TIMESTAMP NOT NULL,
...
CREATE SEQUENCE pm_transition_477;\g
CREATE TABLE pm_transition (
    id INTEGER NOT NULL DEFAULT pm_transition_477.NEXTVAL,
    entity_id VARCHAR(50) NOT NULL,
    name VARCHAR(200) NOT NULL,
    config LONG BYTE NOT NULL,
    create_time TIMESTAMP NOT NULL,
...
CREATE SEQUENCE pm_transition_action_32;\g
CREATE TABLE pm_transition_action (
    id INTEGER NOT NULL DEFAULT pm_transition_action_32.NEXTVAL,
    entity_id VARCHAR(50) NOT NULL,
    name VARCHAR(200) NOT NULL,
    config LONG BYTE NOT NULL,
    create_time TIMESTAMP NOT NULL,

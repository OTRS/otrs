-- ----------------------------------------------------------
--  driver: ingres, generated: 2012-08-17 12:53:16
-- ----------------------------------------------------------
-- ----------------------------------------------------------
--  alter table ticket
-- ----------------------------------------------------------
...
CREATE SEQUENCE pm_process_354;\g
CREATE TABLE pm_process (
    id INTEGER NOT NULL DEFAULT pm_process_354.NEXTVAL,
...
CREATE SEQUENCE pm_activity_592;\g
CREATE TABLE pm_activity (
    id INTEGER NOT NULL DEFAULT pm_activity_592.NEXTVAL,
    entity_id VARCHAR(50) NOT NULL,
    name VARCHAR(200) NOT NULL,
    config LONG BYTE NOT NULL,
    create_time TIMESTAMP NOT NULL,
...
CREATE SEQUENCE pm_activity_dialog_958;\g
CREATE TABLE pm_activity_dialog (
    id INTEGER NOT NULL DEFAULT pm_activity_dialog_958.NEXTVAL,
    entity_id VARCHAR(50) NOT NULL,
    name VARCHAR(200) NOT NULL,
    config LONG BYTE NOT NULL,
    create_time TIMESTAMP NOT NULL,
...
CREATE SEQUENCE pm_transition_106;\g
CREATE TABLE pm_transition (
    id INTEGER NOT NULL DEFAULT pm_transition_106.NEXTVAL,
    entity_id VARCHAR(50) NOT NULL,
    name VARCHAR(200) NOT NULL,
    config LONG BYTE NOT NULL,
    create_time TIMESTAMP NOT NULL,
...
CREATE SEQUENCE pm_transition_action_954;\g
CREATE TABLE pm_transition_action (
    id INTEGER NOT NULL DEFAULT pm_transition_action_954.NEXTVAL,
    entity_id VARCHAR(50) NOT NULL,
    name VARCHAR(200) NOT NULL,
    config LONG BYTE NOT NULL,
    create_time TIMESTAMP NOT NULL,

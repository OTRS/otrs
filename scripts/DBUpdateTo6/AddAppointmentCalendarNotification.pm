...
package scripts::DBUpdateTo6::AddAppointmentCalendarNotification;
...
Add AppointmentCalendar notification.
...
Don't use the constructor directly, use the ObjectManager instead:
    ...
    my $DBUpdateTo6Object = $Kernel::OM->Get('scripts::DBUpdateTo6::AddAppointmentCalendarNotification');

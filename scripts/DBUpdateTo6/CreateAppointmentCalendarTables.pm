...
package scripts::DBUpdateTo6::CreateAppointmentCalendarTables;
...
Create AppointmentCalendar tables.
...
Don't use the constructor directly, use the ObjectManager instead:
    ...
    my $DBUpdateTo6Object = $Kernel::OM->Get('scripts::DBUpdateTo6::CreateAppointmentCalendarTables');

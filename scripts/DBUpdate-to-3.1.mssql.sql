-- ----------------------------------------------------------
--  driver: mssql, generated: 2011-08-17 18:03:08
-- ----------------------------------------------------------
GO
...
CREATE TABLE gi_object_lock_state (
    ...
    create_time DATETIME NOT NULL,
    change_time DATETIME NOT NULL,
    CONSTRAINT gi_object_lock_state_U_4 UNIQUE (webservice_id, object_type, object_id)
);
...
CREATE TABLE dynamic_field_value (
    ...
    change_time DATETIME NOT NULL,
    change_by INTEGER NOT NULL,
    CONSTRAINT dynamic_field_value_U_142 UNIQUE (ticket_id, article_id, field_id)
);

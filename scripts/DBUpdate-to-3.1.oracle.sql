-- ----------------------------------------------------------
--  driver: oracle, generated: 2011-08-22 16:57:27
-- ----------------------------------------------------------
SET DEFINE OFF;
...
CREATE TABLE gi_object_lock_state (
    ...
    create_time DATE NOT NULL,
    change_time DATE NOT NULL,
    CONSTRAINT gi_object_lock_state_U_176 UNIQUE (webservice_id, object_type, object_id)
);
...
CREATE TABLE dynamic_field_value (
    ...
    CONSTRAINT dynamic_field_value_U_613 UNIQUE (field_id, object_type, object_id)
);
...
CREATE TABLE dynamic_field (
    ...
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL,
    CONSTRAINT dynamic_field_U_695 UNIQUE (name)
);

-- ----------------------------------------------------------
--  driver: oracle, generated: 2011-08-18 12:18:48
-- ----------------------------------------------------------
SET DEFINE OFF;
...
CREATE TABLE gi_object_lock_state (
    ...
    create_time DATE NOT NULL,
    change_time DATE NOT NULL,
    CONSTRAINT gi_object_lock_state_U_575 UNIQUE (webservice_id, object_type, object_id)
);
...
CREATE TABLE dynamic_field_value (
    ...
    CONSTRAINT dynamic_field_value_U_347 UNIQUE (field_id, object_type, object_id)
);
...
CREATE TABLE dynamic_field (
    ...
    change_time DATE NOT NULL,
    change_by NUMBER (12, 0) NOT NULL,
    CONSTRAINT dynamic_field_U_733 UNIQUE (name)
);

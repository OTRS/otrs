...
my @Tests = (
    ...
    },
    {
        ...
        Options => [
            '--name', $RandomName, '--source-path', "$Home/development/webservices/GenericTicketConnectorSOAP.wsdl"
        ],
        ExitCode => 1,
    },
    {
        ...
        Options => [
            '--name', $RandomName, '--source-path', "$Home/development/samples/process/BookOrdering.yml"
        ],
        ExitCode => 1,
    },
    {
        ...
        Options => [
            '--name', $RandomName, '--source-path', "$Home/development/webservices/GenericTicketConnectorSOAP.yml"
        ],
        ExitCode => 0,
    },
    {

...
my $DynamicFieldName = 'UnitTestDF' . int rand 1_000_000_000;
...
# Cleanup
my $Success = $DynamicFieldBackendObject->AllValuesDelete(
    DynamicFieldConfig => $DynamicFieldConfig,
    UserID             => 1,
);
$Self->True(
    $Success,
    "AllValuesDelete() for dynamic field $DynamicFieldName",
);
...
$Self->True(
    $Success,
    "DynamicFieldDelete() for dynamic field $DynamicFieldName",
);

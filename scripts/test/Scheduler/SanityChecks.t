# --
# SanityChecks.t - Scheduler tests
...
# get the system data object from the scheduler registration object
my $SystemDataObject = $SchedulerObject->{RegistrationObject}->{SystemDataObject};

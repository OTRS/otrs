...
my $TicketID1 = $TicketObject->TicketCreate(
    Title        => 'Test LinkObject ticket 1',
    Queue        => 'Raw',
    Lock         => 'unlock',
    Priority     => '3 normal',
    State        => 'new',
...
my $TicketID2 = $TicketObject->TicketCreate(
    Title        => 'Test LinkObject ticket 2',
    Queue        => 'Raw',
    Lock         => 'unlock',
    Priority     => '3 normal',
    State        => 'new',
...
my $TicketLinkAdded = $LinkObject->LinkAdd(
    SourceObject => 'Ticket',
    SourceKey    => $TicketID1,
    TargetObject => 'Ticket',
    TargetKey    => $TicketID2,
...
my $LinkList1 = $LinkObject->LinkList(
    Object    => 'Ticket',
    Key       => $TicketID1,
    Object2   => 'Ticket',
    State     => 'Valid',
...
$Self->IsDeeply(
    ...
    'Check $LinkList1 result matches expected value.',
);

my $LinkList2 = $LinkObject->LinkList(
    Object    => 'Ticket',
    Key       => $TicketID1,
    Object2   => 'Ticket',
    State     => 'Valid',
...
$Self->IsDeeply(
    ...
    'Check $LinkList2 result matches expected value.',
);

my $LinkList3 = $LinkObject->LinkList(
    Object    => 'Ticket',
    Key       => $TicketID2,
    Object2   => 'Ticket',
    State     => 'Valid',
...
$Self->IsDeeply(
    ...
    'Check $LinkList3 result matches expected value.',
);

my $LinkList4 = $LinkObject->LinkList(
    Object    => 'Ticket',
    Key       => $TicketID2,
    Object2   => 'Ticket',
    State     => 'Valid',
...
$Self->IsDeeply(
    ...
    'Check $LinkList4 result matches expected value.',
);

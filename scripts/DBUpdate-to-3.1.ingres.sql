-- ----------------------------------------------------------
--  driver: ingres, generated: 2012-03-22 12:00:39
-- ----------------------------------------------------------
-- ----------------------------------------------------------
...
CREATE SEQUENCE gi_webservice_config_539;\g
CREATE TABLE gi_webservice_config (
    id INTEGER NOT NULL DEFAULT gi_webservice_config_539.NEXTVAL,
...
CREATE SEQUENCE gi_webservice_config_history_672;\g
CREATE TABLE gi_webservice_config_history (
    id BIGINT NOT NULL DEFAULT gi_webservice_config_history_672.NEXTVAL,
...
CREATE SEQUENCE scheduler_task_list_68;\g
CREATE TABLE scheduler_task_list (
    id BIGINT NOT NULL DEFAULT scheduler_task_list_68.NEXTVAL,
...
CREATE SEQUENCE gi_debugger_entry_160;\g
CREATE TABLE gi_debugger_entry (
    id BIGINT NOT NULL DEFAULT gi_debugger_entry_160.NEXTVAL,
...
CREATE SEQUENCE gi_debugger_entry_content_565;\g
CREATE TABLE gi_debugger_entry_content (
    id BIGINT NOT NULL DEFAULT gi_debugger_entry_content_565.NEXTVAL,
...
CREATE SEQUENCE smime_signer_cert_relations_226;\g
CREATE TABLE smime_signer_cert_relations (
    id INTEGER NOT NULL DEFAULT smime_signer_cert_relations_226.NEXTVAL,
...
CREATE SEQUENCE dynamic_field_value_534;\g
CREATE TABLE dynamic_field_value (
    id INTEGER NOT NULL DEFAULT dynamic_field_value_534.NEXTVAL,
...
CREATE SEQUENCE dynamic_field_301;\g
CREATE TABLE dynamic_field (
    id INTEGER NOT NULL DEFAULT dynamic_field_301.NEXTVAL,
    name VARCHAR(200) NOT NULL,

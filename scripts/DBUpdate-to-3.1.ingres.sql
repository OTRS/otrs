-- ----------------------------------------------------------
--  driver: ingres, generated: 2011-08-25 11:19:31
-- ----------------------------------------------------------
-- ----------------------------------------------------------
...
CREATE SEQUENCE gi_webservice_config_257;\g
CREATE TABLE gi_webservice_config (
    id INTEGER NOT NULL DEFAULT gi_webservice_config_257.NEXTVAL,
...
CREATE SEQUENCE gi_webservice_config_history_723;\g
CREATE TABLE gi_webservice_config_history (
    id BIGINT NOT NULL DEFAULT gi_webservice_config_history_723.NEXTVAL,
...
CREATE SEQUENCE scheduler_task_list_511;\g
CREATE TABLE scheduler_task_list (
    id BIGINT NOT NULL DEFAULT scheduler_task_list_511.NEXTVAL,
...
CREATE SEQUENCE gi_debugger_entry_75;\g
CREATE TABLE gi_debugger_entry (
    id BIGINT NOT NULL DEFAULT gi_debugger_entry_75.NEXTVAL,
...
CREATE SEQUENCE gi_debugger_entry_content_239;\g
CREATE TABLE gi_debugger_entry_content (
    id BIGINT NOT NULL DEFAULT gi_debugger_entry_content_239.NEXTVAL,
...
CREATE SEQUENCE smime_signer_cert_relations_901;\g
CREATE TABLE smime_signer_cert_relations (
    id INTEGER NOT NULL DEFAULT smime_signer_cert_relations_901.NEXTVAL,
...
CREATE SEQUENCE dynamic_field_value_861;\g
CREATE TABLE dynamic_field_value (
    id INTEGER NOT NULL DEFAULT dynamic_field_value_861.NEXTVAL,
...
CREATE SEQUENCE dynamic_field_956;\g
CREATE TABLE dynamic_field (
    id INTEGER NOT NULL DEFAULT dynamic_field_956.NEXTVAL,
    name VARCHAR(200) NOT NULL,

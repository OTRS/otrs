-- ----------------------------------------------------------
--  driver: ingres, generated: 2011-08-22 16:57:27
-- ----------------------------------------------------------
-- ----------------------------------------------------------
...
CREATE SEQUENCE gi_webservice_config_114;\g
CREATE TABLE gi_webservice_config (
    id INTEGER NOT NULL DEFAULT gi_webservice_config_114.NEXTVAL,
...
CREATE SEQUENCE gi_webservice_config_history_729;\g
CREATE TABLE gi_webservice_config_history (
    id BIGINT NOT NULL DEFAULT gi_webservice_config_history_729.NEXTVAL,
...
CREATE SEQUENCE scheduler_task_list_437;\g
CREATE TABLE scheduler_task_list (
    id BIGINT NOT NULL DEFAULT scheduler_task_list_437.NEXTVAL,
...
CREATE SEQUENCE gi_debugger_entry_522;\g
CREATE TABLE gi_debugger_entry (
    id BIGINT NOT NULL DEFAULT gi_debugger_entry_522.NEXTVAL,
...
CREATE SEQUENCE gi_debugger_entry_content_972;\g
CREATE TABLE gi_debugger_entry_content (
    id BIGINT NOT NULL DEFAULT gi_debugger_entry_content_972.NEXTVAL,
...
CREATE SEQUENCE smime_signer_cert_relations_208;\g
CREATE TABLE smime_signer_cert_relations (
    id INTEGER NOT NULL DEFAULT smime_signer_cert_relations_208.NEXTVAL,
...
CREATE SEQUENCE dynamic_field_575;\g
CREATE TABLE dynamic_field (
    id INTEGER NOT NULL DEFAULT dynamic_field_575.NEXTVAL,
    name VARCHAR(200) NOT NULL,

-- ----------------------------------------------------------
--  driver: ingres, generated: 2011-02-15 16:20:47
-- ----------------------------------------------------------
-- ----------------------------------------------------------
...
CREATE SEQUENCE gi_webservice_config_84;\g
CREATE TABLE gi_webservice_config (
    id INTEGER NOT NULL DEFAULT gi_webservice_config_84.NEXTVAL,
...
CREATE SEQUENCE gi_webservice_config_history_68;\g
CREATE TABLE gi_webservice_config_history (
    id BIGINT NOT NULL DEFAULT gi_webservice_config_history_68.NEXTVAL,
...
CREATE SEQUENCE scheduler_task_list_229;\g
CREATE TABLE scheduler_task_list (
    id BIGINT NOT NULL DEFAULT scheduler_task_list_229.NEXTVAL,
...
CREATE SEQUENCE gi_debugger_entry_561;\g
-- ----------------------------------------------------------
--  create table gi_debugger_entry
-- ----------------------------------------------------------
CREATE TABLE gi_debugger_entry (
    id BIGINT NOT NULL DEFAULT gi_debugger_entry_561.NEXTVAL,
...
CREATE SEQUENCE gi_debugger_entry_content_804;\g
-- ----------------------------------------------------------
--  create table gi_debugger_entry_content
-- ----------------------------------------------------------
CREATE TABLE gi_debugger_entry_content (
    id BIGINT NOT NULL DEFAULT gi_debugger_entry_content_804.NEXTVAL,

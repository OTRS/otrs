-- ----------------------------------------------------------
--  driver: ingres, generated: 2011-08-19 17:27:31
-- ----------------------------------------------------------
-- ----------------------------------------------------------
...
CREATE SEQUENCE gi_webservice_config_663;\g
CREATE TABLE gi_webservice_config (
    id INTEGER NOT NULL DEFAULT gi_webservice_config_663.NEXTVAL,
...
CREATE SEQUENCE gi_webservice_config_history_752;\g
CREATE TABLE gi_webservice_config_history (
    id BIGINT NOT NULL DEFAULT gi_webservice_config_history_752.NEXTVAL,
...
CREATE SEQUENCE scheduler_task_list_919;\g
CREATE TABLE scheduler_task_list (
    id BIGINT NOT NULL DEFAULT scheduler_task_list_919.NEXTVAL,
...
CREATE SEQUENCE gi_debugger_entry_263;\g
CREATE TABLE gi_debugger_entry (
    id BIGINT NOT NULL DEFAULT gi_debugger_entry_263.NEXTVAL,
...
CREATE SEQUENCE gi_debugger_entry_content_63;\g
CREATE TABLE gi_debugger_entry_content (
    id BIGINT NOT NULL DEFAULT gi_debugger_entry_content_63.NEXTVAL,
...
CREATE SEQUENCE smime_signer_cert_relations_390;\g
CREATE TABLE smime_signer_cert_relations (
    id INTEGER NOT NULL DEFAULT smime_signer_cert_relations_390.NEXTVAL,
...
CREATE SEQUENCE dynamic_field_958;\g
CREATE TABLE dynamic_field (
    id INTEGER NOT NULL DEFAULT dynamic_field_958.NEXTVAL,
    name VARCHAR(200) NOT NULL,

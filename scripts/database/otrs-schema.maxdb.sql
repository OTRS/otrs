// ----------------------------------------------------------
//  database: maxdb, generated: Tue Jan 30 11:38:20 2007
// ----------------------------------------------------------
// ----------------------------------------------------------
//  create table valid
// ----------------------------------------------------------
...
//
CREATE INDEX index_user_preferenc33 ON user_preferences (user_id)
//
// ----------------------------------------------------------
//  create table groups
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_queue_v83 ON ticket (ticket_state_id, ticket_lock_id, group_id)
//
CREATE INDEX index_ticket_answere62 ON ticket (ticket_answered)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_history_ticke85 ON ticket_history (ticket_id)
//
...
//
CREATE INDEX article_flag_article11 ON article_flag (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_attachment_a65 ON article_attachment (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_index_t50 ON ticket_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_loop_pr96 ON ticket_loop_protection (sent_to)
//
CREATE INDEX index_ticket_loop_pr41 ON ticket_loop_protection (sent_date)
//
// ----------------------------------------------------------

// ----------------------------------------------------------
//  driver: maxdb, generated: 2009-03-25 02:23:42
// ----------------------------------------------------------
// ----------------------------------------------------------
//  create table valid
// ----------------------------------------------------------
...
//
CREATE INDEX user_preferences_use27 ON user_preferences (user_id)
//
// ----------------------------------------------------------
//  create table groups
// ----------------------------------------------------------
...
//
CREATE INDEX group_customer_user_18 ON group_customer_user (group_id)
//
CREATE INDEX group_customer_user_12 ON group_customer_user (user_id)
//
// ----------------------------------------------------------
//  create table roles
// ----------------------------------------------------------
...
//
CREATE INDEX personal_queues_queu16 ON personal_queues (queue_id)
//
CREATE INDEX personal_queues_user20 ON personal_queues (user_id)
//
// ----------------------------------------------------------
//  create table theme
// ----------------------------------------------------------
...
//
CREATE INDEX queue_preferences_qu19 ON queue_preferences (queue_id)
//
// ----------------------------------------------------------
//  create table ticket
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_customer_user3 ON ticket (customer_user_id)
//
CREATE INDEX ticket_escalation_re24 ON ticket (escalation_response_time)
//
CREATE INDEX ticket_escalation_so58 ON ticket (escalation_solution_time)
//
CREATE INDEX ticket_escalation_ti13 ON ticket (escalation_time)
//
CREATE INDEX ticket_escalation_up45 ON ticket (escalation_update_time)
//
...
//
CREATE INDEX ticket_responsible_u75 ON ticket (responsible_user_id)
//
CREATE INDEX ticket_ticket_lock_i46 ON ticket (ticket_lock_id)
//
CREATE INDEX ticket_ticket_priori38 ON ticket (ticket_priority_id)
//
CREATE INDEX ticket_ticket_state_17 ON ticket (ticket_state_id)
//
...
//
CREATE INDEX ticket_history_creat47 ON ticket_history (create_time)
//
CREATE INDEX ticket_history_histo86 ON ticket_history (history_type_id)
//
CREATE INDEX ticket_history_owner66 ON ticket_history (owner_id)
//
CREATE INDEX ticket_history_prior8 ON ticket_history (priority_id)
//
CREATE INDEX ticket_history_queue20 ON ticket_history (queue_id)
//
CREATE INDEX ticket_history_state87 ON ticket_history (state_id)
//
CREATE INDEX ticket_history_ticke22 ON ticket_history (ticket_id)
//
CREATE INDEX ticket_history_type_36 ON ticket_history (type_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_article_send9 ON article (article_sender_type_id)
//
CREATE INDEX article_article_type9 ON article (article_type_id)
//
...
//
CREATE INDEX article_search_artic98 ON article_search (article_sender_type_id)
//
CREATE INDEX article_search_artic39 ON article_search (article_type_id)
//
CREATE INDEX article_search_messa35 ON article_search (a_message_id)
//
CREATE INDEX article_search_ticke57 ON article_search (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_plain_articl62 ON article_plain (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_attachment_a73 ON article_attachment (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX time_accounting_tick34 ON time_accounting (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_watcher_ticke53 ON ticket_watcher (ticket_id)
//
CREATE INDEX ticket_watcher_user_85 ON ticket_watcher (user_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX service_preferences_33 ON service_preferences (service_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX service_customer_use72 ON service_customer_user (customer_user_login)
//
CREATE INDEX service_customer_use48 ON service_customer_user (service_id)
//
// ----------------------------------------------------------
//  create table sla
// ----------------------------------------------------------
...
//
CREATE INDEX sla_preferences_sla_1 ON sla_preferences (sla_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_index_group_i93 ON ticket_index (group_id)
//
CREATE INDEX ticket_index_queue_i46 ON ticket_index (queue_id)
//
CREATE INDEX ticket_index_ticket_4 ON ticket_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_lock_index_ti91 ON ticket_lock_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX customer_preferences76 ON customer_preferences (user_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_loop_protecti52 ON ticket_loop_protection (sent_date)
//
...
//
CREATE INDEX postmaster_filter_f_76 ON postmaster_filter (f_name)
//
// ----------------------------------------------------------
...
//
CREATE INDEX generic_agent_jobs_j36 ON generic_agent_jobs (job_name)
//
// ----------------------------------------------------------
...
//
CREATE INDEX search_profile_login33 ON search_profile (login)
//
CREATE INDEX search_profile_profi95 ON search_profile (profile_name)
//
// ----------------------------------------------------------
...
//
CREATE INDEX xml_storage_key_type0 ON xml_storage (xml_key, xml_type)
//
CREATE INDEX xml_storage_xml_cont72 ON xml_storage (xml_content_key)
//
// ----------------------------------------------------------

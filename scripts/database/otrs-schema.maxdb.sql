...
//
CREATE INDEX index_user_preferenc34 ON user_preferences (user_id)
//
// ----------------------------------------------------------
//  create table groups
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_answere33 ON ticket (ticket_answered)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_history_ticke98 ON ticket_history (ticket_id)
//
...
//
CREATE INDEX article_flag_article38 ON article_flag (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_plain_articl30 ON article_plain (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_index_t4 ON ticket_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_lock_ti86 ON ticket_lock_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_customer_prefe84 ON customer_preferences (user_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_loop_pr54 ON ticket_loop_protection (sent_to)
//
CREATE INDEX index_ticket_loop_pr32 ON ticket_loop_protection (sent_date)
//
// ----------------------------------------------------------

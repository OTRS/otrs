// ----------------------------------------------------------
//  driver: maxdb, generated: 2009-03-24 12:44:05
// ----------------------------------------------------------
// ----------------------------------------------------------
//  create table valid
// ----------------------------------------------------------
...
//
CREATE INDEX user_preferences_use87 ON user_preferences (user_id)
//
// ----------------------------------------------------------
//  create table groups
// ----------------------------------------------------------
...
//
CREATE INDEX group_customer_user_61 ON group_customer_user (group_id)
//
CREATE INDEX group_customer_user_95 ON group_customer_user (user_id)
//
// ----------------------------------------------------------
//  create table roles
// ----------------------------------------------------------
...
//
CREATE INDEX personal_queues_queu10 ON personal_queues (queue_id)
//
CREATE INDEX personal_queues_user78 ON personal_queues (user_id)
//
// ----------------------------------------------------------
//  create table theme
// ----------------------------------------------------------
...
//
CREATE INDEX queue_preferences_qu50 ON queue_preferences (queue_id)
//
// ----------------------------------------------------------
//  create table ticket
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_customer_user26 ON ticket (customer_user_id)
//
CREATE INDEX ticket_escalation_re69 ON ticket (escalation_response_time)
//
CREATE INDEX ticket_escalation_so56 ON ticket (escalation_solution_time)
//
CREATE INDEX ticket_escalation_ti54 ON ticket (escalation_time)
//
CREATE INDEX ticket_escalation_up10 ON ticket (escalation_update_time)
//
...
//
CREATE INDEX ticket_responsible_u30 ON ticket (responsible_user_id)
//
CREATE INDEX ticket_ticket_lock_i97 ON ticket (ticket_lock_id)
//
CREATE INDEX ticket_ticket_priori45 ON ticket (ticket_priority_id)
//
CREATE INDEX ticket_ticket_state_87 ON ticket (ticket_state_id)
//
...
//
CREATE INDEX ticket_history_creat55 ON ticket_history (create_time)
//
CREATE INDEX ticket_history_histo20 ON ticket_history (history_type_id)
//
CREATE INDEX ticket_history_owner98 ON ticket_history (owner_id)
//
CREATE INDEX ticket_history_prior37 ON ticket_history (priority_id)
//
CREATE INDEX ticket_history_queue94 ON ticket_history (queue_id)
//
CREATE INDEX ticket_history_state95 ON ticket_history (state_id)
//
CREATE INDEX ticket_history_ticke11 ON ticket_history (ticket_id)
//
CREATE INDEX ticket_history_type_56 ON ticket_history (type_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_flag_article13 ON article_flag (article_id)
//
CREATE INDEX article_flag_create_2 ON article_flag (create_by)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_article_send60 ON article (article_sender_type_id)
//
CREATE INDEX article_article_type64 ON article (article_type_id)
//
...
//
CREATE INDEX article_search_artic14 ON article_search (article_sender_type_id)
//
CREATE INDEX article_search_artic84 ON article_search (article_type_id)
//
CREATE INDEX article_search_messa69 ON article_search (a_message_id)
//
CREATE INDEX article_search_ticke20 ON article_search (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_plain_articl5 ON article_plain (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_attachment_a91 ON article_attachment (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX time_accounting_tick66 ON time_accounting (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_watcher_ticke97 ON ticket_watcher (ticket_id)
//
CREATE INDEX ticket_watcher_user_66 ON ticket_watcher (user_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX service_preferences_93 ON service_preferences (service_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX service_customer_use97 ON service_customer_user (customer_user_login)
//
CREATE INDEX service_customer_use56 ON service_customer_user (service_id)
//
// ----------------------------------------------------------
//  create table sla
// ----------------------------------------------------------
...
//
CREATE INDEX sla_preferences_sla_45 ON sla_preferences (sla_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_index_group_i81 ON ticket_index (group_id)
//
CREATE INDEX ticket_index_queue_i88 ON ticket_index (queue_id)
//
CREATE INDEX ticket_index_ticket_72 ON ticket_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_lock_index_ti47 ON ticket_lock_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX customer_preferences47 ON customer_preferences (user_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_loop_protecti15 ON ticket_loop_protection (sent_date)
//
CREATE INDEX ticket_loop_protecti31 ON ticket_loop_protection (sent_to)
//
// ----------------------------------------------------------
...
//
CREATE INDEX postmaster_filter_f_14 ON postmaster_filter (f_name)
//
// ----------------------------------------------------------
...
//
CREATE INDEX generic_agent_jobs_j94 ON generic_agent_jobs (job_name)
//
// ----------------------------------------------------------
...
//
CREATE INDEX search_profile_login61 ON search_profile (login)
//
CREATE INDEX search_profile_profi46 ON search_profile (profile_name)
//
// ----------------------------------------------------------
...
//
CREATE INDEX xml_storage_key_type70 ON xml_storage (xml_key, xml_type)
//
CREATE INDEX xml_storage_xml_cont33 ON xml_storage (xml_content_key)
//
// ----------------------------------------------------------

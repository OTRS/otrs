// ----------------------------------------------------------
//  driver: maxdb, generated: 2009-03-11 22:46:13
// ----------------------------------------------------------
// ----------------------------------------------------------
//  create table valid
// ----------------------------------------------------------
...
//
CREATE INDEX user_preferences_use58 ON user_preferences (user_id)
//
// ----------------------------------------------------------
//  create table groups
// ----------------------------------------------------------
...
//
CREATE INDEX group_customer_user_65 ON group_customer_user (group_id)
//
CREATE INDEX group_customer_user_71 ON group_customer_user (user_id)
//
// ----------------------------------------------------------
//  create table roles
// ----------------------------------------------------------
...
//
CREATE INDEX personal_queues_queu12 ON personal_queues (queue_id)
//
CREATE INDEX personal_queues_user94 ON personal_queues (user_id)
//
// ----------------------------------------------------------
//  create table theme
// ----------------------------------------------------------
...
//
CREATE INDEX queue_preferences_qu37 ON queue_preferences (queue_id)
//
// ----------------------------------------------------------
//  create table ticket
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_customer_user41 ON ticket (customer_user_id)
//
CREATE INDEX ticket_escalation_re17 ON ticket (escalation_response_time)
//
CREATE INDEX ticket_escalation_so3 ON ticket (escalation_solution_time)
//
CREATE INDEX ticket_escalation_ti7 ON ticket (escalation_time)
//
CREATE INDEX ticket_escalation_up30 ON ticket (escalation_update_time)
//
...
//
CREATE INDEX ticket_responsible_u32 ON ticket (responsible_user_id)
//
CREATE INDEX ticket_ticket_lock_i51 ON ticket (ticket_lock_id)
//
CREATE INDEX ticket_ticket_priori97 ON ticket (ticket_priority_id)
//
CREATE INDEX ticket_ticket_state_78 ON ticket (ticket_state_id)
//
...
//
CREATE INDEX ticket_history_creat66 ON ticket_history (create_time)
//
CREATE INDEX ticket_history_histo29 ON ticket_history (history_type_id)
//
CREATE INDEX ticket_history_owner35 ON ticket_history (owner_id)
//
CREATE INDEX ticket_history_prior71 ON ticket_history (priority_id)
//
CREATE INDEX ticket_history_queue46 ON ticket_history (queue_id)
//
CREATE INDEX ticket_history_state62 ON ticket_history (state_id)
//
CREATE INDEX ticket_history_ticke76 ON ticket_history (ticket_id)
//
CREATE INDEX ticket_history_type_38 ON ticket_history (type_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_flag_article47 ON article_flag (article_id)
//
CREATE INDEX article_flag_create_31 ON article_flag (create_by)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_article_send39 ON article (article_sender_type_id)
//
...
//
CREATE INDEX article_search_artic13 ON article_search (article_sender_type_id)
//
CREATE INDEX article_search_artic67 ON article_search (article_type_id)
//
CREATE INDEX article_search_messa57 ON article_search (a_message_id)
//
CREATE INDEX article_search_ticke12 ON article_search (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_plain_articl19 ON article_plain (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_attachment_a8 ON article_attachment (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX time_accounting_tick61 ON time_accounting (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_watcher_ticke57 ON ticket_watcher (ticket_id)
//
CREATE INDEX ticket_watcher_user_98 ON ticket_watcher (user_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX service_preferences_96 ON service_preferences (service_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX service_customer_use10 ON service_customer_user (customer_user_login)
//
CREATE INDEX service_customer_use55 ON service_customer_user (service_id)
//
// ----------------------------------------------------------
//  create table sla
// ----------------------------------------------------------
...
//
CREATE INDEX sla_preferences_sla_61 ON sla_preferences (sla_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_index_group_i71 ON ticket_index (group_id)
//
CREATE INDEX ticket_index_queue_i44 ON ticket_index (queue_id)
//
CREATE INDEX ticket_index_ticket_61 ON ticket_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_lock_index_ti18 ON ticket_lock_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX customer_preferences22 ON customer_preferences (user_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_loop_protecti18 ON ticket_loop_protection (sent_date)
//
CREATE INDEX ticket_loop_protecti94 ON ticket_loop_protection (sent_to)
//
// ----------------------------------------------------------
...
//
CREATE INDEX postmaster_filter_f_35 ON postmaster_filter (f_name)
//
// ----------------------------------------------------------
...
//
CREATE INDEX generic_agent_jobs_j68 ON generic_agent_jobs (job_name)
//
// ----------------------------------------------------------
...
//
CREATE INDEX search_profile_login59 ON search_profile (login)
//
CREATE INDEX search_profile_profi93 ON search_profile (profile_name)
//
// ----------------------------------------------------------
...
//
CREATE INDEX xml_storage_key_type34 ON xml_storage (xml_key, xml_type)
//
CREATE INDEX xml_storage_xml_cont45 ON xml_storage (xml_content_key)
//
// ----------------------------------------------------------

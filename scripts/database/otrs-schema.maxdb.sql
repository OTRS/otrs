...
//
CREATE INDEX index_ticket_queue_v51 ON ticket (ticket_state_id, ticket_lock_id, group_id)
//
CREATE INDEX index_ticket_answere70 ON ticket (ticket_answered)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_history_creat63 ON ticket_history (create_time)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_plain_articl98 ON article_plain (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_index_t29 ON ticket_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_lock_ti89 ON ticket_lock_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_customer_prefe36 ON customer_preferences (user_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_loop_pr14 ON ticket_loop_protection (sent_to)
//
CREATE INDEX index_ticket_loop_pr87 ON ticket_loop_protection (sent_date)
//
// ----------------------------------------------------------

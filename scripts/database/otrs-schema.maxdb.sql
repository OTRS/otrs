...
//
CREATE INDEX index_user_preferenc5 ON user_preferences (user_id)
//
// ----------------------------------------------------------
//  create table groups
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_queue_v95 ON ticket (ticket_state_id, ticket_lock_id, group_id)
//
CREATE INDEX index_ticket_answere35 ON ticket (ticket_answered)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_history_ticke36 ON ticket_history (ticket_id)
//
...
//
CREATE INDEX article_flag_create_56 ON article_flag (create_by)
//
...
//
CREATE INDEX article_attachment_a29 ON article_attachment (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_time_accountin92 ON time_accounting (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_index_t16 ON ticket_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_lock_ti65 ON ticket_lock_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_customer_prefe97 ON customer_preferences (user_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_loop_pr44 ON ticket_loop_protection (sent_to)
//
CREATE INDEX index_ticket_loop_pr37 ON ticket_loop_protection (sent_date)
//
// ----------------------------------------------------------

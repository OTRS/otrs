// ----------------------------------------------------------
//  database: maxdb, generated: Tue Jan 30 18:26:51 2007
// ----------------------------------------------------------
// ----------------------------------------------------------
//  create table valid
// ----------------------------------------------------------
...
//
CREATE INDEX index_user_preferenc22 ON user_preferences (user_id)
//
// ----------------------------------------------------------
//  create table groups
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_queue_v46 ON ticket (ticket_state_id, ticket_lock_id, group_id)
//
CREATE INDEX index_ticket_answere66 ON ticket (ticket_answered)
//
// ----------------------------------------------------------
...
//
CREATE INDEX ticket_history_ticke42 ON ticket_history (ticket_id)
//
CREATE INDEX ticket_history_creat24 ON ticket_history (create_time)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_flag_create_69 ON article_flag (create_by)
//
CREATE INDEX article_flag_article30 ON article_flag (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_plain_articl47 ON article_plain (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX article_attachment_a55 ON article_attachment (article_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_time_accountin28 ON time_accounting (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_index_t30 ON ticket_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_lock_ti77 ON ticket_lock_index (ticket_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_customer_prefe29 ON customer_preferences (user_id)
//
// ----------------------------------------------------------
...
//
CREATE INDEX index_ticket_loop_pr3 ON ticket_loop_protection (sent_date)
//
// ----------------------------------------------------------

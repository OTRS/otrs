...
ALTER TABLE ticket_priority ADD CONSTRAINT fk_ticket_priority_create_by49 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE ticket_priority ADD CONSTRAINT fk_ticket_priority_change_by20 FOREIGN KEY (change_by) REFERENCES system_user(id);
...
ALTER TABLE ticket_lock_type ADD CONSTRAINT fk_ticket_lock_type_change_b59 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE ticket_lock_type ADD CONSTRAINT fk_ticket_lock_type_valid_id85 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE group_customer_user ADD CONSTRAINT fk_group_customer_user_group34 FOREIGN KEY (group_id) REFERENCES groups(id);
ALTER TABLE group_customer_user ADD CONSTRAINT fk_group_customer_user_creat33 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE group_customer_user ADD CONSTRAINT fk_group_customer_user_chang32 FOREIGN KEY (change_by) REFERENCES system_user(id);
...
ALTER TABLE ticket_state_type ADD CONSTRAINT fk_ticket_state_type_create_91 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE ticket_state_type ADD CONSTRAINT fk_ticket_state_type_change_36 FOREIGN KEY (change_by) REFERENCES system_user(id);
...
ALTER TABLE follow_up_possible ADD CONSTRAINT fk_follow_up_possible_create69 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE follow_up_possible ADD CONSTRAINT fk_follow_up_possible_change51 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE follow_up_possible ADD CONSTRAINT fk_follow_up_possible_valid_61 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE queue_preferences ADD CONSTRAINT fk_queue_preferences_queue_i10 FOREIGN KEY (queue_id) REFERENCES queue(id);
ALTER TABLE ticket ADD CONSTRAINT fk_ticket_ticket_lock_id_id FOREIGN KEY (ticket_lock_id) REFERENCES ticket_lock_type(id);
ALTER TABLE ticket ADD CONSTRAINT fk_ticket_ticket_priority_id19 FOREIGN KEY (ticket_priority_id) REFERENCES ticket_priority(id);
...
ALTER TABLE ticket ADD CONSTRAINT fk_ticket_responsible_user_i58 FOREIGN KEY (responsible_user_id) REFERENCES system_user(id);
...
ALTER TABLE ticket_history ADD CONSTRAINT fk_ticket_history_priority_i76 FOREIGN KEY (priority_id) REFERENCES ticket_priority(id);
...
ALTER TABLE ticket_history ADD CONSTRAINT fk_ticket_history_history_ty93 FOREIGN KEY (history_type_id) REFERENCES ticket_history_type(id);
ALTER TABLE ticket_history ADD CONSTRAINT fk_ticket_history_article_id36 FOREIGN KEY (article_id) REFERENCES article(id);
...
ALTER TABLE ticket_history_type ADD CONSTRAINT fk_ticket_history_type_creat30 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE ticket_history_type ADD CONSTRAINT fk_ticket_history_type_chang39 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE ticket_history_type ADD CONSTRAINT fk_ticket_history_type_valid1 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE article_sender_type ADD CONSTRAINT fk_article_sender_type_creat73 FOREIGN KEY (create_by) REFERENCES system_user(id);
...
ALTER TABLE article_sender_type ADD CONSTRAINT fk_article_sender_type_valid45 FOREIGN KEY (valid_id) REFERENCES valid(id);
ALTER TABLE article_flag ADD CONSTRAINT fk_article_flag_create_by_id FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE article ADD CONSTRAINT fk_article_article_sender_ty50 FOREIGN KEY (article_sender_type_id) REFERENCES article_sender_type(id);
...
ALTER TABLE article_attachment ADD CONSTRAINT fk_article_attachment_create78 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE article_attachment ADD CONSTRAINT fk_article_attachment_change2 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE article_attachment ADD CONSTRAINT fk_article_attachment_articl92 FOREIGN KEY (article_id) REFERENCES article(id);
ALTER TABLE standard_response ADD CONSTRAINT fk_standard_response_create_16 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE standard_response ADD CONSTRAINT fk_standard_response_change_29 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE standard_response ADD CONSTRAINT fk_standard_response_valid_i44 FOREIGN KEY (valid_id) REFERENCES valid(id);
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_c85 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_c3 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_s35 FOREIGN KEY (standard_response_id) REFERENCES standard_response(id);
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_q44 FOREIGN KEY (queue_id) REFERENCES queue(id);
ALTER TABLE standard_attachment ADD CONSTRAINT fk_standard_attachment_creat21 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE standard_attachment ADD CONSTRAINT fk_standard_attachment_chang82 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE standard_attachment ADD CONSTRAINT fk_standard_attachment_valid54 FOREIGN KEY (valid_id) REFERENCES valid(id);
ALTER TABLE standard_response_attachment ADD CONSTRAINT fk_standard_response_attachm90 FOREIGN KEY (create_by) REFERENCES system_user(id);
...
ALTER TABLE standard_response_attachment ADD CONSTRAINT fk_standard_response_attachm93 FOREIGN KEY (standard_response_id) REFERENCES standard_response(id);
ALTER TABLE standard_response_attachment ADD CONSTRAINT fk_standard_response_attachm44 FOREIGN KEY (standard_attachment_id) REFERENCES standard_attachment(id);
ALTER TABLE auto_response_type ADD CONSTRAINT fk_auto_response_type_create2 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE auto_response_type ADD CONSTRAINT fk_auto_response_type_change60 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE auto_response_type ADD CONSTRAINT fk_auto_response_type_valid_6 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE auto_response ADD CONSTRAINT fk_auto_response_system_addr34 FOREIGN KEY (system_address_id) REFERENCES system_address(id);
...
ALTER TABLE queue_auto_response ADD CONSTRAINT fk_queue_auto_response_auto_79 FOREIGN KEY (auto_response_id) REFERENCES auto_response(id);
ALTER TABLE queue_auto_response ADD CONSTRAINT fk_queue_auto_response_creat19 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE queue_auto_response ADD CONSTRAINT fk_queue_auto_response_chang87 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE queue_auto_response ADD CONSTRAINT fk_queue_auto_response_queue37 FOREIGN KEY (queue_id) REFERENCES queue(id);
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_create_by83 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_change_by9 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_article_i84 FOREIGN KEY (article_id) REFERENCES article(id);
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_ticket_id18 FOREIGN KEY (ticket_id) REFERENCES ticket(id);
...
ALTER TABLE service_customer_user ADD CONSTRAINT fk_service_customer_user_cre56 FOREIGN KEY (create_by) REFERENCES system_user(id);
...
ALTER TABLE package_repository ADD CONSTRAINT fk_package_repository_change24 FOREIGN KEY (change_by) REFERENCES system_user(id);

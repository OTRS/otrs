...
ALTER TABLE ticket_priority ADD CONSTRAINT fk_ticket_priority_create_by12 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE ticket_priority ADD CONSTRAINT fk_ticket_priority_change_by52 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE ticket_lock_type ADD CONSTRAINT fk_ticket_lock_type_create_b17 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE ticket_lock_type ADD CONSTRAINT fk_ticket_lock_type_change_b88 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE ticket_lock_type ADD CONSTRAINT fk_ticket_lock_type_valid_id15 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE group_customer_user ADD CONSTRAINT fk_group_customer_user_group30 FOREIGN KEY (group_id) REFERENCES groups(id);
ALTER TABLE group_customer_user ADD CONSTRAINT fk_group_customer_user_creat42 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE group_customer_user ADD CONSTRAINT fk_group_customer_user_chang61 FOREIGN KEY (change_by) REFERENCES system_user(id);
...
ALTER TABLE ticket_state_type ADD CONSTRAINT fk_ticket_state_type_create_53 FOREIGN KEY (create_by) REFERENCES system_user(id);
...
ALTER TABLE follow_up_possible ADD CONSTRAINT fk_follow_up_possible_create96 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE follow_up_possible ADD CONSTRAINT fk_follow_up_possible_change44 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE follow_up_possible ADD CONSTRAINT fk_follow_up_possible_valid_44 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE ticket ADD CONSTRAINT fk_ticket_ticket_priority_id53 FOREIGN KEY (ticket_priority_id) REFERENCES ticket_priority(id);
...
ALTER TABLE ticket_history ADD CONSTRAINT fk_ticket_history_history_ty50 FOREIGN KEY (history_type_id) REFERENCES ticket_history_type(id);
ALTER TABLE ticket_history ADD CONSTRAINT fk_ticket_history_article_id15 FOREIGN KEY (article_id) REFERENCES article(id);
...
ALTER TABLE ticket_history_type ADD CONSTRAINT fk_ticket_history_type_creat4 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE ticket_history_type ADD CONSTRAINT fk_ticket_history_type_chang4 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE ticket_history_type ADD CONSTRAINT fk_ticket_history_type_valid76 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE article_sender_type ADD CONSTRAINT fk_article_sender_type_creat14 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE article_sender_type ADD CONSTRAINT fk_article_sender_type_chang68 FOREIGN KEY (change_by) REFERENCES system_user(id);
...
ALTER TABLE article ADD CONSTRAINT fk_article_article_sender_ty41 FOREIGN KEY (article_sender_type_id) REFERENCES article_sender_type(id);
...
ALTER TABLE article_attachment ADD CONSTRAINT fk_article_attachment_create70 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE article_attachment ADD CONSTRAINT fk_article_attachment_change74 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE article_attachment ADD CONSTRAINT fk_article_attachment_articl23 FOREIGN KEY (article_id) REFERENCES article(id);
ALTER TABLE standard_response ADD CONSTRAINT fk_standard_response_create_66 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE standard_response ADD CONSTRAINT fk_standard_response_change_65 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE standard_response ADD CONSTRAINT fk_standard_response_valid_i10 FOREIGN KEY (valid_id) REFERENCES valid(id);
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_c24 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_c39 FOREIGN KEY (change_by) REFERENCES system_user(id);
...
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_q97 FOREIGN KEY (queue_id) REFERENCES queue(id);
ALTER TABLE standard_attachment ADD CONSTRAINT fk_standard_attachment_creat65 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE standard_attachment ADD CONSTRAINT fk_standard_attachment_chang76 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE standard_attachment ADD CONSTRAINT fk_standard_attachment_valid43 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE standard_response_attachment ADD CONSTRAINT fk_standard_response_attachm24 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE standard_response_attachment ADD CONSTRAINT fk_standard_response_attachm71 FOREIGN KEY (standard_response_id) REFERENCES standard_response(id);
ALTER TABLE standard_response_attachment ADD CONSTRAINT fk_standard_response_attachm88 FOREIGN KEY (standard_attachment_id) REFERENCES standard_attachment(id);
ALTER TABLE auto_response_type ADD CONSTRAINT fk_auto_response_type_create33 FOREIGN KEY (create_by) REFERENCES system_user(id);
...
ALTER TABLE auto_response_type ADD CONSTRAINT fk_auto_response_type_valid_47 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE queue_auto_response ADD CONSTRAINT fk_queue_auto_response_auto_78 FOREIGN KEY (auto_response_id) REFERENCES auto_response(id);
ALTER TABLE queue_auto_response ADD CONSTRAINT fk_queue_auto_response_creat33 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE queue_auto_response ADD CONSTRAINT fk_queue_auto_response_chang63 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE queue_auto_response ADD CONSTRAINT fk_queue_auto_response_queue43 FOREIGN KEY (queue_id) REFERENCES queue(id);
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_create_by9 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_change_by48 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_article_i71 FOREIGN KEY (article_id) REFERENCES article(id);
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_ticket_id92 FOREIGN KEY (ticket_id) REFERENCES ticket(id);
...
ALTER TABLE package_repository ADD CONSTRAINT fk_package_repository_create70 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE package_repository ADD CONSTRAINT fk_package_repository_change37 FOREIGN KEY (change_by) REFERENCES system_user(id);

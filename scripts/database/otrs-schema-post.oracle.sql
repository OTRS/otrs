...
ALTER TABLE ticket_priority ADD CONSTRAINT fk_ticket_priority_create_by86 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE ticket_priority ADD CONSTRAINT fk_ticket_priority_change_by69 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE ticket_lock_type ADD CONSTRAINT fk_ticket_lock_type_create_b8 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE ticket_lock_type ADD CONSTRAINT fk_ticket_lock_type_change_b8 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE ticket_lock_type ADD CONSTRAINT fk_ticket_lock_type_valid_id68 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE group_customer_user ADD CONSTRAINT fk_group_customer_user_group87 FOREIGN KEY (group_id) REFERENCES groups(id);
ALTER TABLE group_customer_user ADD CONSTRAINT fk_group_customer_user_creat65 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE group_customer_user ADD CONSTRAINT fk_group_customer_user_chang65 FOREIGN KEY (change_by) REFERENCES system_user(id);
...
ALTER TABLE ticket_state_type ADD CONSTRAINT fk_ticket_state_type_create_34 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE ticket_state_type ADD CONSTRAINT fk_ticket_state_type_change_72 FOREIGN KEY (change_by) REFERENCES system_user(id);
...
ALTER TABLE follow_up_possible ADD CONSTRAINT fk_follow_up_possible_change5 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE follow_up_possible ADD CONSTRAINT fk_follow_up_possible_valid_98 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE ticket ADD CONSTRAINT fk_ticket_responsible_user_i88 FOREIGN KEY (responsible_user_id) REFERENCES system_user(id);
ALTER TABLE ticket ADD CONSTRAINT fk_ticket_valid_id_id FOREIGN KEY (valid_id) REFERENCES valid(id);
ALTER TABLE ticket_history ADD CONSTRAINT fk_ticket_history_priority_i30 FOREIGN KEY (priority_id) REFERENCES ticket_priority(id);
...
ALTER TABLE ticket_history ADD CONSTRAINT fk_ticket_history_history_ty46 FOREIGN KEY (history_type_id) REFERENCES ticket_history_type(id);
ALTER TABLE ticket_history ADD CONSTRAINT fk_ticket_history_article_id32 FOREIGN KEY (article_id) REFERENCES article(id);
...
ALTER TABLE ticket_history_type ADD CONSTRAINT fk_ticket_history_type_creat60 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE ticket_history_type ADD CONSTRAINT fk_ticket_history_type_chang91 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE ticket_history_type ADD CONSTRAINT fk_ticket_history_type_valid10 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE article_sender_type ADD CONSTRAINT fk_article_sender_type_creat47 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE article_sender_type ADD CONSTRAINT fk_article_sender_type_chang82 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE article_sender_type ADD CONSTRAINT fk_article_sender_type_valid36 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE article_attachment ADD CONSTRAINT fk_article_attachment_change15 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE article_attachment ADD CONSTRAINT fk_article_attachment_articl36 FOREIGN KEY (article_id) REFERENCES article(id);
ALTER TABLE standard_response ADD CONSTRAINT fk_standard_response_create_35 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE standard_response ADD CONSTRAINT fk_standard_response_change_11 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE standard_response ADD CONSTRAINT fk_standard_response_valid_i18 FOREIGN KEY (valid_id) REFERENCES valid(id);
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_c43 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_c5 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_s80 FOREIGN KEY (standard_response_id) REFERENCES standard_response(id);
ALTER TABLE queue_standard_response ADD CONSTRAINT fk_queue_standard_response_q9 FOREIGN KEY (queue_id) REFERENCES queue(id);
ALTER TABLE standard_attachment ADD CONSTRAINT fk_standard_attachment_creat72 FOREIGN KEY (create_by) REFERENCES system_user(id);
...
ALTER TABLE standard_attachment ADD CONSTRAINT fk_standard_attachment_valid83 FOREIGN KEY (valid_id) REFERENCES valid(id);
ALTER TABLE standard_response_attachment ADD CONSTRAINT fk_standard_response_attachm97 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE standard_response_attachment ADD CONSTRAINT fk_standard_response_attachm64 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE standard_response_attachment ADD CONSTRAINT fk_standard_response_attachm87 FOREIGN KEY (standard_response_id) REFERENCES standard_response(id);
ALTER TABLE standard_response_attachment ADD CONSTRAINT fk_standard_response_attachm22 FOREIGN KEY (standard_attachment_id) REFERENCES standard_attachment(id);
ALTER TABLE auto_response_type ADD CONSTRAINT fk_auto_response_type_create59 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE auto_response_type ADD CONSTRAINT fk_auto_response_type_change83 FOREIGN KEY (change_by) REFERENCES system_user(id);
ALTER TABLE auto_response_type ADD CONSTRAINT fk_auto_response_type_valid_29 FOREIGN KEY (valid_id) REFERENCES valid(id);
...
ALTER TABLE auto_response ADD CONSTRAINT fk_auto_response_system_addr92 FOREIGN KEY (system_address_id) REFERENCES system_address(id);
...
ALTER TABLE queue_auto_response ADD CONSTRAINT fk_queue_auto_response_auto_33 FOREIGN KEY (auto_response_id) REFERENCES auto_response(id);
ALTER TABLE queue_auto_response ADD CONSTRAINT fk_queue_auto_response_creat89 FOREIGN KEY (create_by) REFERENCES system_user(id);
...
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_create_by90 FOREIGN KEY (create_by) REFERENCES system_user(id);
...
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_article_i17 FOREIGN KEY (article_id) REFERENCES article(id);
ALTER TABLE time_accounting ADD CONSTRAINT fk_time_accounting_ticket_id17 FOREIGN KEY (ticket_id) REFERENCES ticket(id);
...
ALTER TABLE package_repository ADD CONSTRAINT fk_package_repository_create73 FOREIGN KEY (create_by) REFERENCES system_user(id);
ALTER TABLE package_repository ADD CONSTRAINT fk_package_repository_change67 FOREIGN KEY (change_by) REFERENCES system_user(id);

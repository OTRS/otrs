...
ALTER TABLE ticket_priority ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE ticket_priority ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE ticket_type ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE ticket_type ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE ticket_type ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE ticket_lock_type ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE ticket_lock_type ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE ticket_lock_type ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE users ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE users ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE users ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE user_preferences ADD FOREIGN KEY (user_id) REFERENCES users (id);
ALTER TABLE groups ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE groups ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE group_user ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE group_user ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE group_role ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE group_role ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE group_customer_user ADD FOREIGN KEY (group_id) REFERENCES groups (id);
ALTER TABLE group_customer_user ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE group_customer_user ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE roles ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE roles ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE roles ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE role_user ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE role_user ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE personal_queues ADD FOREIGN KEY (user_id) REFERENCES users (id);
ALTER TABLE theme ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE theme ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE ticket_state ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE ticket_state ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE ticket_state ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE ticket_state_type ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE ticket_state_type ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE salutation ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE salutation ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE salutation ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE signature ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE signature ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE signature ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE system_address ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE system_address ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE system_address ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE follow_up_possible ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE follow_up_possible ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE queue ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE queue ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE ticket ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE ticket ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE ticket_history ADD FOREIGN KEY (owner_id) REFERENCES users (id);
ALTER TABLE ticket_history ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE ticket_history ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE ticket_history ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE ticket_history_type ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE ticket_history_type ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE ticket_history_type ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE article_type ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE article_type ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE article_type ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE article_sender_type ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE article_sender_type ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE article_sender_type ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE article_flag ADD FOREIGN KEY (create_by) REFERENCES users (id);
...
ALTER TABLE article_attachment ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE article_attachment ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE standard_response ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE standard_response ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE queue_standard_response ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE queue_standard_response ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE standard_attachment ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE standard_attachment ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE standard_response_attachment ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE standard_response_attachment ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE auto_response_type ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE auto_response_type ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE auto_response ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE auto_response ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE queue_auto_response ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE queue_auto_response ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE time_accounting ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE time_accounting ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE service ADD FOREIGN KEY (create_by) REFERENCES users (id);
...
ALTER TABLE customer_user ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE customer_user ADD FOREIGN KEY (change_by) REFERENCES users (id);
ALTER TABLE customer_user ADD FOREIGN KEY (valid_id) REFERENCES valid (id);
ALTER TABLE mail_account ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE mail_account ADD FOREIGN KEY (change_by) REFERENCES users (id);
...
ALTER TABLE package_repository ADD FOREIGN KEY (create_by) REFERENCES users (id);
ALTER TABLE package_repository ADD FOREIGN KEY (change_by) REFERENCES users (id);

-- ----------------------------------------------------------
--  driver: db2, generated: 2007-06-12 16:51:43
-- ----------------------------------------------------------
-- ----------------------------------------------------------
--  create table valid
-- ----------------------------------------------------------
...
CREATE INDEX index_user_prefe35 ON user_preferences (user_id);
...
CREATE INDEX index_ticket_use32 ON ticket (user_id);

CREATE INDEX index_ticket_typ13 ON ticket (type_id);

CREATE INDEX index_ticket_que37 ON ticket (ticket_state_id, ticket_lock_id, group_id);
...
CREATE INDEX ticket_history_t16 ON ticket_history (ticket_id);

CREATE INDEX ticket_history_c95 ON ticket_history (create_time);
...
CREATE INDEX article_flag_cre82 ON article_flag (create_by);

CREATE INDEX article_flag_art55 ON article_flag (article_id);
...
CREATE INDEX article_ticket_i15 ON article (ticket_id);
...
CREATE INDEX article_plain_ar69 ON article_plain (article_id);
...
CREATE INDEX article_attachme14 ON article_attachment (article_id);
...
CREATE INDEX index_time_accou85 ON time_accounting (ticket_id);
...
CREATE INDEX service_customer91 ON service_customer_user (customer_user_login);

CREATE INDEX service_customer43 ON service_customer_user (service_id);
...
CREATE INDEX index_session_id27 ON sessions (session_id);
...
CREATE INDEX index_ticket_ind30 ON ticket_index (ticket_id);
...
CREATE INDEX index_ticket_loc9 ON ticket_lock_index (ticket_id);
...
CREATE INDEX index_customer_p98 ON customer_preferences (user_id);
...
CREATE INDEX index_ticket_loo57 ON ticket_loop_protection (sent_to);

CREATE INDEX index_ticket_loo21 ON ticket_loop_protection (sent_date);
...
CREATE INDEX xml_storage_xml_15 ON xml_storage (xml_content_key);

CREATE INDEX xml_storage_key_48 ON xml_storage (xml_key, xml_type);

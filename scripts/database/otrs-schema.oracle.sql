-- ----------------------------------------------------------
--  driver: oracle, generated: 2014-03-29 16:35:51
-- ----------------------------------------------------------
SET DEFINE OFF;
...
BEGIN
  EXECUTE IMMEDIATE 'DROP SEQUENCE SE_standard_response';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/
...
BEGIN
  EXECUTE IMMEDIATE 'DROP SEQUENCE SE_standard_response_attace7';
EXCEPTION
  WHEN OTHERS THEN NULL;
END;
/

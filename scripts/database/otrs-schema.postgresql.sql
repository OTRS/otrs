...
CREATE TABLE gi_object_lock_state (
    ...
    create_time timestamp(0) NOT NULL,
    change_time timestamp(0) NOT NULL,
    CONSTRAINT gi_object_lock_state_U_382 UNIQUE (webservice_id, object_type, object_id)
);
...
CREATE TABLE dynamic_field_value (
    ...
    CONSTRAINT dynamic_field_value_U_748 UNIQUE (field_id, object_type, object_id)
);

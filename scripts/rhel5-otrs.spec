...
Provides:     otrs
Requires:     perl vixie-cron perl(DBI) perl(URI) mod_perl httpd procmail perl(Date::Format) perl(LWP::UserAgent) perl(Net::DNS) perl(IO::Socket::SSL) perl(XML::Parser)
Autoreqprov:  no
Release:      01

...
# --
# $Id: auto_build.sh,v 1.112 2012-11-20 16:04:48 mh Exp $
# --
...
echo "auto_build.sh - build automatically OTRS tar, rpm and src-rpm <\$Revision: 1.112 $>"
...
SUPPORT_PACKAGE="http://ftp.otrs.org/pub/otrs/packages/Support-1.4.1.opm"

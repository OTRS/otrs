...
# --
# $Id: auto_build.sh,v 1.117 2013-01-17 09:18:59 mg Exp $
# --
...
echo "auto_build.sh - build automatically OTRS tar, rpm and src-rpm <\$Revision: 1.117 $>"
...
SUPPORT_PACKAGE="http://ftp.otrs.org/pub/otrs/packages/Support-1.4.3.opm"

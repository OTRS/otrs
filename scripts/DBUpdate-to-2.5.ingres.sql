-- ----------------------------------------------------------
--  driver: ingres, generated: 2010-02-23 14:03:41
-- ----------------------------------------------------------
-- ----------------------------------------------------------
--  alter table ticket
-- ----------------------------------------------------------
...
CREATE SEQUENCE virtual_fs_705;\g
CREATE TABLE virtual_fs (
    id BIGINT NOT NULL DEFAULT virtual_fs_705.NEXTVAL,
...
CREATE SEQUENCE virtual_fs_db_803;\g
CREATE TABLE virtual_fs_db (
    id BIGINT NOT NULL DEFAULT virtual_fs_db_803.NEXTVAL,
    filename VARCHAR(350) NOT NULL,

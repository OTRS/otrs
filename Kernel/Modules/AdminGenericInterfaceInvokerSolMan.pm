...
package Kernel::Modules::AdminGenericInterfaceInvokerSolMan;
...
sub _AddAction {
    ...
    my $Config = {
        ...
        RemoteSystemGuid => $Self->{ParamObject}->GetParam( Param => 'RemoteSystemGuid' ) || '',
    };
    ...
    my $RedirectURL
        = "Action=AdminGenericInterfaceInvokerSolMan;Subaction=Change;WebserviceID=$WebserviceID;";
    $RedirectURL
...
sub _ChangeAction {
    ...
    $InvokerConfig->{RemoteSystemGuid}
        = $Self->{ParamObject}->GetParam( Param => 'RemoteSystemGuid' )
        || '';
    ...
    my $RedirectURL
        = "Action=AdminGenericInterfaceInvokerSolMan;Subaction=Change;WebserviceID=$WebserviceID;Invoker=$GetParam{Invoker}";
...
sub _ShowScreen {
    ...
    $TemplateData{RemoteSystemGuid} = $Param{InvokerConfig}->{RemoteSystemGuid};
    ...
    $Output .= $Self->{LayoutObject}->Output(
        TemplateFile => 'AdminGenericInterfaceInvokerSolMan',
        Data         => {
            %Param,
            %TemplateData,

...
sub new {
    ...
    # Include translatable strings used by default notifications, workaround for bug#12387.
    my @DefaultNotificationStrings = (
        Translatable('Appointment reminder notification'),
        Translatable(

# --
# Kernel/Modules/AdminGenericInterfaceWebservice.pm - provides a web service view for administrators
...
sub Run {
    ...
    # ------------------------------------------------------------ #
        ...
        if ( $ImportedConfig->{FrameworkVersion} ne $Kernel::OM->Get('Kernel::Config')->Get('Version') ) {

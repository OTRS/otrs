...
# --
# $Id: Email.pm,v 1.72.2.6 2012-06-20 12:23:02 alm Exp $
# --
...
use vars qw($VERSION);
$VERSION = qw($Revision: 1.72.2.6 $) [1];
...
sub Send {
    ...
    if ( $Param{Attachment} ) {
        ...
        for my $Upload ( @{ $Param{Attachment} } ) {
            ...
            my @tConentType = grep { !/\s*name=/ } ( split /;/, $Upload->{ContentType} );
            $Upload->{ContentType} = join ';', @tConentType;
...
$Revision: 1.72.2.6 $ $Date: 2012-06-20 12:23:02 $

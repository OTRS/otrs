...
# --
# $Id: ingres.pm,v 1.1 2008-07-21 04:25:16 martin Exp $
# --
...
#    }
    ...
    foreach (@Seq) {
        push (@Return, $Self->SequenceCreate(
            Name => $_,
        ));
    }
    ...
    if ($PrimaryKey) {
        push (@Return, "ALTER TABLE $TableName ADD PRIMARY KEY ( $PrimKeyColName ) WITH index = base table structure");
    }
    # add indexs

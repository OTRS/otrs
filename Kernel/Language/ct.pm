# --
# Kernel/Language/ct.pm - provides es language translation
# Copyright (C) 2001-2008 OTRS AG, http://otrs.org/
# --
# $Id: ct.pm,v 1.1.2.2 2008-05-09 12:46:10 martin Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The recommended charset for your language is %s!' =>
            'El joc de caràcters recomanat per al seu idioma és %s!',
        'Passwords doesn\'t match! Please try it again!' =>
            'Les contrasenyes no coincideixen. Per favor intenti\'l de nou !',
        'Password is already in use! Please use an other password!' =>
            'La contrasenya ja s\'està utilitzant! Per Favor utilitzi altra!',
        'Password is already used! Please use an other password!' =>
            'La contrasenya ja va ser usada! Per Favor utilitzi altra!',
        ...
        'Logout successful. Thank you for using OTRS!' =>
            'Desconnexió reeixida. Gràcies per utilitzar OTRS!',
        ...
        'Session has timed out. Please log in again.' =>
            'La sessió ha expirat. Per favor iniciï una sessió novament.',
        'No Permission!' => 'No té Permís!',
        'To: (%s) replaced with database email!' =>
            'To: (%s) substituït amb email de la base de dades!',
        ...
        'Unable to parse Online Repository index document!' =>
            'Incapaç d\'interpretar el document índex del Repositorio en Línia!',
        ...
        'Select your QueueView refresh time.' =>
            'Seleccioni el temps d\'actualització de la vista de cues',
        ...
        'Can\'t update password, invalid characters!' =>
            'No es pot actualitzar la contrasenya, caràcters invàlids!',
        'Can\'t update password, need min. 8 characters!' =>
            'No es pot actualitzar la contrasenya, es necessiten almenys 8 caràcters',
        'Can\'t update password, need 2 lower and 2 upper characters!' =>
            'No es pot actualitzar la contrasenya, es necessiten almenys 2 en minúscula i 2 en majúscula!',
        'Can\'t update password, need min. 1 digit!' =>
            'No es pot actualitzar la contrasenya, es necessita almenys 1 dígit!',
        'Can\'t update password, need min. 2 characters!' =>
            'No es pot actualitzar la contrasenya, es necessiten almenys 2 caràcters!',
        ...
        'Please select one element for the X-axis!' =>
            'Per favor, seleccioni un element per a l\'eix X',
        ...
        'The selected end time is before the start time!' =>
            'La data de final és prèvia a la inicial!',
        ...
        'Please select only one or two elements via the checkbox!' =>
            'Per favor seleccioni només un o dos elements usant la casella de selecció!',
        ...
        'The selected start time is before the allowed start time!' =>
            'El període de temps inicial és anterior al permès!',
        'The selected end time is after the allowed end time!' =>
            'El període de temps final és posterior al permès!',
        ...
        'This is a HTML email. Click here to show it.' =>
            'Aquest és un missatge HTML. Faci clic aquí per a mostrar-lo.',
        ...
        'No such Ticket Number "%s"! Can\'t link it!' =>
            'No existeix el tiquet Nombre "%s"! No pot vincular-lo!',
        ...
        'Create new Email Ticket and send this out (Outbound)' =>
            'Crea nou tiquet de correu i ho envia (sortida)',
        ...
        'Ticket %s: first response time is over (%s)!' =>
            'Tiquet %s: Temps per a primera resposta ha vençut (%s)!',
        'Ticket %s: first response time will be over in %s!' =>
            'Tiquet %s: Temps per a primera resposta està per vèncer en %s!',
        'Ticket %s: update time is over (%s)!' =>
            'Tiquet %s: Temps per a actualització ha vençut (%s)!',
        'Ticket %s: update time will be over in %s!' =>
            'Tiquet %s: Temps per a actualització està per vèncer en %s!',
        'Ticket %s: solution time is over (%s)!' =>
            'Tiquet %s: Temps per a solució ha vençut (%s)!',
        'Ticket %s: solution time will be over in %s!' =>
            'Tiquet %s: Temps per a solució està per vèncer en %s!',
        ...
        'Select your screen after creating a new ticket.' =>
            'Seleccioni la pantalla a mostrar després de crear un tiquet ',
        'Closed Tickets'       => 'Tiquets tancats',
        'Show closed tickets.' => 'Mostrar tiquets tancats',
        'Max. shown Tickets a page in QueueView.' =>
            'Quantitat de Tiquets a mostrar en la Vista de Cua',
        ...
        'History::TimeAccounting' =>
            '%s unitat(s) de temps comptabilitzades. Nou total : %s unitat(s) de temps.',
        'History::Remove'               => '%s',
        ...
        'To get the first 20 character of the subject.' =>
            'Per a obtenir els primers 20 caràcters de l\'assumpte.',
        'To get the first 5 lines of the email.' => 'Per a obtenir les primeres 5 línies del correu.',
        'To get the realname of the sender (if given).' =>
            'Per a obtenir el nom real del remitent (si existeix).',
...
(<OTRS_CUSTOMER_From>, <OTRS_CUSTOMER_To>, <OTRS_CUSTOMER_Cc>, <OTRS_CUSTOMER_Subject> i <OTRS_CUSTOMER_Body>).',
        ...
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>).' =>
            'Opcions del propietari del tiquet (p.e., <OTRS_OWNER_UserFirstname>).',
        ...
        'Config options (e. g. <OTRS_CONFIG_HttpType>).' =>
            'Opcions de configuració (p.e., <OTRS_CONFIG_HttpType>).',
        ...
        'Read only access to the ticket in this group/queue.' =>
            'Accés de només lectura als tiquets en aquest grup/cua.',
        'rw' => 'rw',
        ...
        'Fulltext-Search in Article (e. g. "Mar*in" or "Baue*")' =>
            'Recerca de text en Article (ex. "Mar*in" or "Baue*") ',
        ...
        'No means, send agent and customer notifications on changes.' =>
            'No, significa enviar als agents i clients notificacions al realitzar canvis.',
        'Save' => 'Guardar',
        '%s Tickets affected! Do you really want to use this job?' =>
            '%s Tiquets Modificats! Realment desitja utilitzar aquesta tasca?',
        '"}' => '"}',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'Les notificacions se li envian a un agent o client',
        ...
        'Do you really want to uninstall this package?' =>
            'Segur que desitja desinstal·lar aquest paquet?',
        ...
        'Just use this feature if you want to log each request.' =>
            'Usi aquesta característica només si desitja registrar cada petició.',
        ...
        'Logfile too large, you need to reset it!' =>
            'Registre molt gran, necessita reinicialitzar-lo!',
        'Range'            => 'Rang',
        ...
        'Will be the sender address of this queue for email answers.' =>
            'Serà l\'adreça de l\'emissor en aquesta cua per a respostes per correu.',
        ...
        'Don\'t forget to add a new response a queue!' =>
            'No oblidi incloure una nova resposta en la cua!',
        ...
        'It\'s useful for a lot of users and groups.' =>
            'És útil per a gestionar molts usuaris i grups.',

        # Template: AdminRoleGroupChangeForm
        'Roles <-> Groups Management' => 'Rols <-> Gestió de Grups',
        'move_into'                   => 'moure_a',
        'Permissions to move tickets into this group/queue.' =>
            'Permís per a moure tiquets a aquest grup/cua',
        'create' => 'crear',
        'Permissions to create tickets in this group/queue.' =>
            'Permís per a crear tiquets en aquest grup/cua',
        'owner' => 'propietari',
        'Permissions to change the ticket owner in this group/queue.' =>
            'Permís per a canviar el propietari del tiquet en aquest grup/cua',
        'priority' => 'prioritat',
        ...
        'User will be needed to handle tickets.' =>
            'Es necessita un usuari per a manipular els tiquets.',
        'Don\'t forget to add a new user to groups and/or roles!' =>
            'No oblidi afegir els nous usuaris als grups i/o rols',
        ...
        'Discard all changes and return to the compose screen' =>
            'Descartar tots els canvis i tornar a la pantalla de redacció',
        ...
        'Select the restrictions to characterise the stat' =>
            'Seleccioni les restriccions per a caracteritzar l\'estadística',
        'Fixed' => 'Arreglat',
        'Please select only one element or turn off the button \'Fixed\'.' =>
            'Per favor seleccioni un element de desactivi el botó \'Arreglat\'',
        ...
        'Here you can make restrictions to your stat.' =>
            'Aquí pot declarar restriccions a les seves estadístiques.',
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.'
            => 'Si elimina la marca en la casella "Arreglat", l\'agent que genera l\'estadística pot canviar els atributs de l\'element corresponent',
        ...
        'In this form you can select the basic specifications.' =>
            'En aquesta pantalla pot seleccionar les especificacions bàsiques',
        'Attribute'          => 'Atribut',
        'Title of the stat.' => 'Títol de l\'estadística',
        'Here you can insert a description of the stat.' =>
            'Aquí pot inserir una descripció de l\'estadística.',
        'Dynamic-Object' => 'Objecte-Dinàmic',
        'Here you can select the dynamic object you want to use.' =>
            'Aquí pot seleccionar l\'element dinàmic que desitgi utilitzar',
        ...
        'If you need the sum of every row select yes' =>
            'Si necessita la suma de cada fila seleccioni Si',
        'If you need the sum of every column select yes.' =>
            'Si necessita la suma de cada columna seleccioni Si',
        ...
        '(Note: Useful for big databases and low performance server)' =>
            '(Nota: Útil per a bases de dades grans i servidors de baix rendiment)',
        'With an invalid stat it isn\'t feasible to generate a stat.' =>
            'Amb una estadística invàlida, no és possible generar estadístiques.',
        ...
        'Select the elements for the value series' =>
            'Seleccioni els elements per als valors de la sèrie',
        'Scale'   => 'Escala',
        'minimal' => 'mínim',
        ...
        'Select the element, which will be used at the X-axis' =>
            'Seleccioni l\'element, que serà utilitzat en l\'eix-X',
        ...
        '(Full qualified domain name of your system)' =>
            '(Nom complet del domini del seu sistema)',
        ...
        '(Logfile just needed for File-LogModule!)' =>
            '(Arxiu de traces només necessari para File-LogModule)',
        ...
        'After doing so your OTRS is up and running.' =>
            'Després de fer això el seu OTRS estarà actiu i executant-se',
        ...
        'Customer history search (e. g. "ID342425").' =>
            'Història de recerques del client (exemple: "ID342425").',
        'Close!'              => 'Tancar!',
        'for agent firstname' => 'nom de l\'agent',
        'The message being composed has been closed.  Exiting.' =>
            'El missatge que s\'estava redactant ha estat tancat.  Sortint.',
        'A web calendar' => 'Calendari Web',
        'to get the realname of the sender (if given)' =>
            'per a obtenir el nom de l\'emissor (si ho va proporcionar)',
        ...
        'Home'     => 'Inici',
        'Config options (e. g. <OTRS_CONFIG_HttpType>)' =>
            'Opcions de configuració (ej: <OTRS_CONFIG_HttpType>)',
        ...
        'This window must be called from compose window' =>
            'Aquesta finestra ha de ser cridada des de la finestra de redacció',
        'Minutes'                            => 'Minuts',

...
',
        ...
        'Defines the module to send emails. "Sendmail" directly uses the sendmail binary of your operating system. Any of the "SMTP" mechanisms use a specified (external) mailserver. "DoNotSendEmail" doesn\'t send emails and it is useful for test systems.' =>
            'Određuje module za slanje imejl poruka. "Sendmail" direktno koristi aplikaciju vašeg operativnog sistema za slanje imejla. Svaki od "SMTP" mehanizama koristi specifičan (eksterni) imejl server. "DoNotSendEmail" ne šalje imejlove i to je korisno pri testiranju sistema.',

...
sub Data {
    ...
    $Self->{Completeness}        = 0.530157970320728;
    ...
    $Self->{Translation} = {
        ...
        'Ticket Escalation Time (before/after)' => 'Tiempo para Escalada de Ticket (antes/después)',
        'Ticket Escalation Time (between)' => 'Tiempo para Escalada de Ticket (entre)',

...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'You need to activate %s first to use it!' =>
            '%s muss zuerst aktiviert werden um es zu benutzen!',
        'No suggestions' => 'Keine Vorschläge',
        'Word'           => 'Wort',
        'Ignore'         => 'Ignorieren',
        'replace with'   => 'ersetzen mit',
        'There is no account with that login name.' =>
            'Es existiert kein Benutzerkonto mit diesem Namen.',
        ...
        'Unable to parse Online Repository index document!' =>
            'Nicht möglich den Online Repository Index zu verarbeiten!',
        ...
        'Can\'t update password, invalid characters!' =>
            'Passwort konnte nicht aktualisiert werden, Zeichen ungülig.',
        'Can\'t update password, need min. 8 characters!' =>
            'Passwort konnte nicht aktualisiert werden, benötige min. 8 Zeichen.',
        ...
        'Can\'t update password, need min. 1 digit!' =>
            'Passwort konnte nicht aktualisiert werden, Passwort muss mit eine Zahl enthalten!',
        'Can\'t update password, need min. 2 characters!' =>
            'Passwort konnte nicht aktualisiert werden, Passwort muss zwei Buchstaben enthalten!',
        ...
        'Create new Email Ticket and send this out (Outbound)' =>
            'Neues Ticket wird erstellt und Email versendet',
        ...
        'To get the realname of the sender (if given).' =>
            'Der Name des Benutzers (soweit bekannt)',
        ...
        'Yes means, send no agent and customer notifications on changes.' =>
            'Ja bedeutet, es werden keine Benachrichtigungen an Kunden und Agents gesendet.',
        'No means, send agent and customer notifications on changes.' =>
            'Nein bedeutet, es werden die Kunden und Agents durch eine Benachrichtigung über die Änderung informiert.',
        'Save' => 'Speichern',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'Benachrichtigungen werden an Agenten und Kunden gesendet.',
        ...
        'Logfile too large, you need to reset it!' =>
            'Die Logdatei ist zu groß, bitte zurücksetzen!',
        'Range'            => 'Bereich',
        'Interface'        => 'Interface',
        'Requests'         => 'Anfragen',
        ...
        'It\'s useful for a lot of users and groups.' =>
            'Es ist sehr nützlich wenn man viele Gruppen und Benutzer hat.',

        # Template: AdminRoleGroupChangeForm
        'Roles <-> Groups Management' => 'Rollen <-> Gruppen Verwaltung',
        'move_into'                   => 'Verschieben in',
        'Permissions to move tickets into this group/queue.' =>
            'Rechte, um Tickets in eine Gruppe/Queue zu verschieben.',
        'create' => 'Erstellen',
        'Permissions to create tickets in this group/queue.' =>
            'Rechte, um in einer Gruppe/Queue Tickets zu erstellen.',
        'owner' => 'Besitzer',
        'Permissions to change the ticket owner in this group/queue.' =>
            'Rechte, um den Besitzer eines Ticket in einer Gruppe/Queue zu ändern.',
        'priority' => 'Priorität',
        ...
        'Download all system config changes.' =>
            'Herunterladen aller Änderungen der Konfiguration.',
        ...
        'User will be needed to handle tickets.' =>
            'Benutzer werden benötigt, um Tickets zu bearbeiten.',
        'Don\'t forget to add a new user to groups and/or roles!' =>
            'Ein neuer Benutzer muss einer Gruppe und/oder Rollen zugewiesen werden!',
        ...
        'Discard all changes and return to the compose screen' =>
            'Alle Änderungen verwerfen und zurück zum Verfassen-Fenster',
        ...
        'Here you can make restrictions to your stat.' =>
            'Dieses Formular wird dazu verwendet die Einschränkungen für die Statistik zu definieren.',
        ...
        'Here you can select the dynamic object you want to use.' =>
            'Hier kann das zu benutzende dynamische Objekt ausgewählt werden.',
        ...
        'Set customer user and customer id of a ticket' =>
            'Kundenbenutzer und Kundennummer des Tickets auswählen',
        ...
        'Customer history search (e. g. "ID342425").' =>
            'Kunden-Historie-Suche (z. B. "ID342425").',
        'for agent firstname' => 'für Vorname des Agents',
        'Close!'              => 'Schließen!',
        'Reporter'            => 'Melder',
        'Process-Path'        => 'Prozess-Path',
        'The message being composed has been closed.  Exiting.' =>
            'Die erstellte Nachricht wurde geschlossen.',
        'to get the realname of the sender (if given)' =>
            'Um den Realnamen des Senders zu erhalten (wenn möglich)',
        ...
        'to get the first 20 character of the subject' =>
            'Um die ersten 20 Zeichen des Betreffs zu erhalten',
        ...
        'Don\'t forget to add a new user to groups!' =>
            'Ein neuer Benutzer muss einer Gruppe zugewiesen werden!',

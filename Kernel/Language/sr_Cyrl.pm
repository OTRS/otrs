...
# --
# $Id: sr_Cyrl.pm,v 1.14 2011-09-06 10:26:54 mg Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2011-09-06 12:20:18
    ...
    $Self->{Translation} = {
        ...
        'New message!' => 'Нова порука!',
        'Please answer this ticket(s) to get back to the normal queue view!' => 'Молимо вас да одговорите на овај тикет да би сте се вратили на нормалан преглед реда!',
        ...
        'Security Note: You should activate %s because application is already running!' => 'Безбедносна напомена: Требало би да омогућите %s, јер је апликација већ покренута!',
        ...
        'No packages, or no new packages, found in selected repository.' => 'У изабраном спремишту нема пакета или нема нових пакета',
        ...
        'Can\'t update password, it must contain at least 2 lowercase  and 2 uppercase characters!' => 'Лозинка не може бити ажурирана. Мора да садржи бар 2 велика и 2 мала слова.',
        'Can\'t update password, it must contain at least 1 digit!' => 'Лозинка не може бити ажурирана. Мора да садржи бар једну бројку.',
        'Can\'t update password, it must contain at least 2 characters!' => 'Лозинка не може бити ажурирана. Мора да садржи најмање 2 знака.',
        'Can\'t update password, this password has already been used. Please choose a new one!' => 'Лозинка не може бити ажурирана. Унета лозинка је већ у употреби. Молимо изаберите неку другу.',
        'Select the separator character used in CSV files (stats and searches). If you don\'t select a separator here, the default separator for your language will be used.' => 'Изаберите раставни знак који ће се користи у "CSV" датотекама (статистика и претраге). Ако не изаберете раставни знак овде, користиће се подразумевани раставни знак за ваш језик',
        ...
        'Please select only one element or turn off the button \'Fixed\' where the select field is marked!' => 'Изаберите само један елемент или опозовите избор на ознаци поља "фиксирано"!',
        'If you use a checkbox you have to select some attributes of the select field!' => 'Ако користите ознаке селекције, морате да изаберете неке атрибуте селектованог поља!',
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' => 'Молимо да унесете вредност у изабрано поље или искључите ознаку "фиксирано"!',
        'The selected end time is before the start time!' => 'Изабрано време краја је пре времена почетка!',
        'You have to select one or more attributes from the select field!' => 'Морате да изаберете један или више атрибута из селектованог поља!',
        ...
        'If you use a time scale element you can only select one element!' => 'Уколико користите елемент временске скале, можете изабрати само један елемент!',
        'You have an error in your time selection!' => 'Имате грешку у вашем избору времена!',
        'Your reporting time interval is too small, please use a larger time scale!' => 'Ваш интервал извештаја је прекратак, молимо употребите већи временски размак!',
        ...
        'Attachment' => 'Прилог',
        'Attachments' => 'Прилози',
        'This message was written in a character set other than your own.' => 'Ова порука је написана скупом знакова различитим од оног који Ви користите.',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' => 'Ваш е-мејл са бројем тикета "<OTRS_TICKET>" је спојен са тикетом "<OTRS_MERGE_TO_TICKET>"!',
        ...
        'Send me a notification if a ticket is unlocked by the system.' => 'Пошаљи ми обавештење ако систем откључа тикет.)',
        ...
        'Send me a notification if a ticket is moved into one of "My Queues".' => 'Пошаљи ми обавештење кад се тикет премести у "Моје Редове".',
        'Send ticket move notifications' => 'Пошаљи обавештење о померању тикета',
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.' => 'Изабрани омиљени редови. Ако је активирано, добиђете и обавештење о овим редовима.',
        'Custom Queue' => 'Прилагођен ред',
        'QueueView refresh time' => 'Време освежавања реда',
        'If enabled, the QueueView will automatically refresh after the specified time.' => 'Ако је укључено, преглед реда ће бити освежен после задатог времена.',
        ...
        'All open tickets, these tickets have already been worked on, but need a response' => 'Сви отворени тикети, на овима је већ рађено, али на њих треба одговорити',
        ...
        'All tickets with a reminder set where the reminder date has been reached' => 'Сви тикети са подешеним подсетником, а датум подсетника је достигнут',
        'Archived tickets' => '',
        'Unarchived tickets' => '',
        ...
        'Select' => 'Изабери',
        'Hint' => 'Савет',
        'Customer will be needed to have a customer history and to login via customer panel.' => 'Корисници су потребни да би могли да имате историјат за корисника и да би могли да се пријаве на клијентски портал.',
        ...
        'This field is required and needs to be a valid email address.' => 'Ово је обавезно поње и мора да буде испаравна мејл адреса.',
        ...
        'Just use this feature if you want to define group permissions for customers.' => 'Употребите ову функцију ако желите да дефинишете групне дозволе за кориснике.',
        ...
        'You can manage these groups via the configuration setting "CustomerGroupAlwaysGroups".' => 'Можете управљати овим групама преко конфигурационих подешаванља "..."',
        'Filter for Groups' => 'Филетер за групе',
        'Select the customer:group permissions.' => 'Изабери дозволе за корисник:група',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the customer).' => 'Ако ништа није изабрано, онда нема дозвола у овој групи (тикети неће бити доступни кориснику).',
        ...
        'rw' => '"rw"',
        'Full read and write access to the tickets in this group/queue.' => 'Приступ без ограничења за тикете у овим Групама/Редовима.',
        ...
        'CMD' => '"CMD"',
        'This command will be executed. ARG[0] will be the ticket number. ARG[1] the ticket id.' => 'Ова наредба ће бити извршена. ARG[0] је број тикета, а ARG[1] ИД тикета.',
        ...
        'Warning: You used the DELETE option. All deleted tickets will be lost!' => 'УПОЗОРЕЊЕ: Употребили сте опцију за брисање. Сви обрисани тикети же бити изгубљени!',
        ...
        'All incoming emails with one account will be dispatched in the selected queue!' => 'Све долазне поруке са једног налога ће бити усмерене у изабрани ред!',
        'If your account is trusted, the already existing X-OTRS header at arrival time (for priority, ...) will be used! PostMaster filter will be used anyway.' => 'Ако је ваш налог од поверења, користиће се постојећа "X-OTRS" заглавља! "PostMaster" филтери се користе увек.',
        'Host' => 'Домаћин',
        ...
        'To get the first 20 character of the subject (of the latest agent article).' => 'Да видите првих 20 слова предмета (последњег чланка запосленог).',
        'To get the first 5 lines of the body (of the latest agent article).' => '',
        'To get the first 20 character of the subject (of the latest customer article).' => 'Да видите првих 20 слова предмета (последњег чланка запосленог)',
        'To get the first 5 lines of the body (of the latest customer article).' => 'Да видите првих 5 линија поруке (последњег чланка запосленог).',
        ...
        'Do you really want to reinstall this package? Any manual changes will be lost.' => 'Да ли стварно желите да поново инсталирате овај пакет? Све ручне промене ће бити изгубљене.',
        'Continue' => 'Настави',
        'Install' => 'Инсталирај',
        ...
        'To dispatch or filter incoming emails based on email headers. Matching using Regular Expressions is also possible.' => 'Ради отпреме или филтрирања долазних мејлова на основу заглавља. Поклапање помоћу Регуларних Израза је такође могуће.',
        'If you want to match only the email address, use EMAILADDRESS:info@example.com in From, To or Cc.' => 'Уколико желите поклапање само са е-мејл адресом, користите EMAILADDRESS:info@example.com у "Од", "За" или "Кк".',
        ...
        'If a ticket is closed and the customer sends a follow up the ticket will be locked to the old owner.' => 'Ако је тикет затворен, а корисник пошаље наставак, тикет ће бити закључан на старог власника.',
        ...
        'A response is default text to write faster answer (with default text) to customers.' => 'Одговор је подразумевани текст за брже писање (помоћу подразумеваног текста) одговора корисницима.',
        ...
        'Create a role and put groups in it. Then add the role to the users.' => 'Направи улогу и додај групе у њу. Онда додај улогу запосленима.',
        'There are no roles defined. Please use the \'Add\' button to create a new role.' => 'Нема дефинисаних улога. употребите дугме за додавање за креирање нове улоге.',
        'Add Role' => 'Додај улогу',
        ...
        'priority' => 'приоритет',
        'Permissions to change the ticket priority in this group/queue.' => 'Право да се мења приоритет тикета у овој групи/реду.',
        ...
        'In this way you can directly edit the certification and private keys in file system.' => 'На овај начин можете директно да уређујете цертификате и приватне кључеве у систему датотека.',
        'Hash' => 'Hash',
        'Create' => 'Отвори',
        ...
        'Secure mode will (normally) be set after the initial installation is completed.' => 'Сигуран мод ће (уобучајено) бити подешен након иницијалне инсталације.',
        'Secure mode must be disabled in order to reinstall using the web-installer.' => 'Сигуран мод мора бити искључен ради реинсталације преко "web" процедуре.',
        'If secure mode is not activated, activate it via SysConfig because your application is already running.' => 'Уколико сигуран мод није активиран, покрените га кроз системску конфигурацију јер је ваша апликација већ покренута.',

        # Template: AdminSelectBox
        'SQL Box' => '"SQL" Box',
        'Here you can enter SQL to send it directly to the application database.' => 'Овде можете унети "SQL" команде и послати их директно апликационој бази података.',
        'The syntax of your SQL query has a mistake. Please check it.' => 'Постоји грешка у синтакси вашег "SQL" упита. Молимо проверите.',
        'There is at least one parameter missing for the binding. Please check it.' => 'Најмање један параметар недостаје за повезивање. Молимо проверите.',
        ...
        'This config item is only available in a higher config level!' => 'Ова конфигурациона опција је доступна само на вишем конфигурационом нивоу',
        ...
        'All incoming email with this address in To or Cc will be dispatched to the selected queue.' => 'Све долазне поруке са овом адресом у пољу "За" или "Кк" биће отпремљени у изабрани ред.',
        ...
        'The display name and email address will be shown on mail you send.' => 'Приказано име и имејл адреса ће бити приказани на поруци коју сте послали.',
        ...
        'owner' => 'Власник',
        'Permissions to change the owner of tickets in this group/queue.' => 'Дозволе за промену власника тикета у овој групи/реду.',
        ...
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.' => 'Ако уклоните ознаку са елемента "Фиксирано", запослени који прави статистику ће моћи да мења атрибуте конкретног елемента.',
        'Fixed' => 'Фиксирано',
        ...
        'Permissions' => 'Дозволе',
        'You can select one or more groups to define access for different agents.' => 'Ради дефинисања приступа за запослене можете изабрати једну или више група.',
        ...
        'Most of the stats can be cached. This will speed up the presentation of this stat.' => 'Већина стат. података се може кеширати. Ово ће убрзати приказ статистике.',
        ...
        'If you don\'t select any attribute all attributes of the element will be used if you generate a stat, as well as new attributes which were added since the last configuration.' => 'Ако не изаберете ни један атрибут, приликом генерисања статистике биће употребљени сви атрибути елемента као и атрибути додани након последње конфигурације.',
        'Scale' => 'Скалирање',
        'minimal' => 'минимум',
        'Please remember, that the scale for value series has to be larger than the scale for the X-axis (e.g. X-Axis => Month, ValueSeries => Year).' => 'Молимо запамтите, да скала за опсеге вредности мода да буде већа од скале за X-Осу (нпр X-Оса => месец; Вредност опсега => година).',
        ...
        'With the input and select fields you can influence the format and contents of the statistic.' => 'Преко поља за унос и избор можете утицати на облик и сарджај статистике.',
        'Exactly what fields and formats you can influence is defined by the statistic administrator.' => 'На која поља и формате тачно можете да утичете је дефинисано од стране администратора статистике.',
        ...
        'To protect your privacy, active or/and remote content has blocked.' => 'Ради заштите ваше приватности, активни или/и удаљени садржај је блокиран.',
        ...
        'A popup of this screen is already open. Do you want to close it and load this one instead?' => 'Приказ овог екрана је већ отворен. Желите ли да га затворите и учитате овај уместо њега?',
        ...
        'If you have set a root password for your database, it must be entered here. If not, leave this field empty. For security reasons we do recommend setting a root password. For more information please refer to your database documentation.' => 'Ако сте подесили "root" лозинку за вашу базу података, она мора бити унета овде. Ако нема лозинке оставите поље празно. Из безбедносних разлога препоручујемо да је подесите. За више информација консултујте документацију о бази података.',
        'Currently only MySQL is supported in the web installer.' => 'Тренутно је само "MySQL" подржан у Web Инсталацији.',
        'If you want to install OTRS on another database type, please refer to the file README.database.' => 'Ако желите да инсталирате "OTRS" на неки други систем базе података, информације су у датотеци README.database.',
        'Database-User' => 'Корисник базе података',
        'New' => 'Нов',
        'A new database user with limited rights will be created for this OTRS system.' => 'Нови корисника базе са ограниченим правима ће бити креиран за овај "OTRS" систем',
        ...
        'OTRS runs with a huge lists of browsers, please upgrade to one of these.' => '"OTRS" фунционише на великом броју Web читача, молимо да инсталирате и користите један од ових.',
        ...
        # SysConfig
        'ACL module that allows closing parent tickets only if all its children are already closed ("State" shows which states are not available for the parent ticket until all child tickets are closed).' => '"ACL" модул који дозвољава да тикети родитељи буду затворени само ако су већ затворени сви тикети деца ("Статус" показује који статуси нису доступни за тикет родитељ док се не затворе сви тикети деца).',
        ...
        'Activates lost password feature for agents, in the agent interface.' => 'Активира опцију изгубљене лозинке за запослене, на интерфејсу за њих.',
        ...
        'Activates the ticket archive system to have a faster system by moving some tickets out of the daily scope. To search for these tickets, the archive flag has to be enabled in the ticket search.' => 'Активира архивски систем ради убрзања рада, тако што ћете неке тикетеуклонити ван дневног праћења. Да бисте пронашли ове тикете, маркер архиве мора бити омогућен за претрагу тикета.',
        'Activates time accounting.' => 'Активира мерење времена.',
        'Add a note to this ticket' => '',
        'Adds a suffix with the actual year and month to the OTRS log file. A logfile for every month will be created.' => '',
        'Adds customers email addresses to recipients in the ticket compose screen of the agent interface.' => 'Додаје корисничке имејл адресе примаоцима у прозору за отварање тикета на интерфејсу запосленог.',
        'Adds the one time vacation days for the indicated calendar. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => '',
        'Adds the one time vacation days. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Једнократно додаје нерадне дане. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the permanent vacation days for the indicated calendar. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => '',
        'Adds the permanent vacation days. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Трајно додаје нерадне дане. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        ...
        'Agent interface article notification module to check S/MIME.' => 'Модул интерфејса запослених за обавештавања о чланку, провера "S/MIME"',
        'Agent interface module to access fulltext search via nav bar.' => 'Модул интерфејса запослених за приступ текстуалном претраживању преко навигационе траке.',
        'Agent interface module to access search profiles via nav bar.' => 'Модул интерфејса запослених за приступ профилима претраживања преко навигационе траке.',
        'Agent interface module to check incoming emails in the Ticket-Zoom-View if the S/MIME-key is available and true.' => 'Модул интерфејса запослених за проверу долазних порука у увећаном прегледу тикета ако "S/MIME"-кључ постоји и доступан је.',
        'Agent interface notification module to check the used charset.' => 'Модул интерфејса запослених за проверу употребљеног карактерсета.',
        'Agent interface notification module to see the number of tickets an agent is responsible for.' => 'Модул интерфејса запослених за обвештавање, преглед броја тикета за које је агент одговоран.',
        'Agent interface notification module to see the number of watched tickets.' => 'Модул интерфејса запослених за обвештавање, преглед броја праћених тикета.',
        'Agents <-> Groups' => 'Запослени <-> Групе',
        'Agents <-> Roles' => 'Запослени <-> Улоге',
        'Allows adding notes in the close ticket screen of the agent interface.' => 'Дозвољава додавање напомена у прозор затвореног тикета интерфејса запосленог.',
        'Allows adding notes in the ticket free text screen of the agent interface.' => 'Дозвољава додавање напомена у прозор слободног текста интерфејса запосленог.',
        'Allows adding notes in the ticket note screen of the agent interface.' => 'Дозвољава додавање напомена у прозор напомене интерфејса запосленог.',
        'Allows adding notes in the ticket owner screen of a zoomed ticket in the agent interface.' => 'Дозвољава додавање напомена у прозор власника тикета на увећаном приказу у интерфејсу запосленог.',
        'Allows adding notes in the ticket pending screen of a zoomed ticket in the agent interface.' => 'Дозвољава додавање напомена у прозор на чекању увећаног приказа у интерфејсу запосленог.',
        'Allows adding notes in the ticket priority screen of a zoomed ticket in the agent interface.' => 'Дозвољава додавање напомена у прозор приоритета на увећаном приказу у интерфејсу запосленог.',
        'Allows adding notes in the ticket responsible screen of the agent interface.' => 'Дозвољава додавање напомена у прозор одговорног за тикет интерфејса запосленог.',
        'Allows agents to exchange the axis of a stat if they generate one.' => 'Дозвољава запосленима да замене осе на статистици ако је генеришу.',
        'Allows agents to generate individual-related stats.' => 'Дозвољава запосленима да генеришу индивидуачну статистику.',
        'Allows choosing between showing the attachments of a ticket in the browser (inline) or just make them downloadable (attachment).' => 'Дозвољава избор између приказа прилога у прегледачу или само омогућавања његовог преузимања.',
        'Allows choosing the next compose state for customer tickets in the customer interface.' => 'Дозвољава избор следећег стања за кориснички тикет у корисничком интерфејсу.',
        'Allows customers to change the ticket priority in the customer interface.' => 'Дозвољава корисницима да промене приоритет тикета у корисничком интерфејсу.',
        'Allows customers to set the ticket SLA in the customer interface.' => 'Дозвољава корисницима да подесе "SLA" за тикет у корисничком интерфејсу.',
        'Allows customers to set the ticket priority in the customer interface.' => 'Дозвољава корисницима да подесе приоритет тикета у корисничком интерфејсу.',
        'Allows customers to set the ticket queue in the customer interface. If this is set to \'No\', QueueDefault should be configured.' => 'Дозвољава корисницима да подесе ред тикета у корисничком интерфејсу. Ако је подешено на "Не", онда треба подесити "QueueDefault".',
        'Allows customers to set the ticket service in the customer interface.' => 'Дозвољава корисницима да подесе сервис за тикет у корисничком интерфејсу.',
        'Allows defining new types for ticket (if ticket type feature is enabled).' => 'Дозвољава дефинисање новог типа тикета (ако је опције типа тикета активирана).',
        'Allows defining services and SLAs for tickets (e. g. email, desktop, network, ...), and escalation attributes for SLAs (if ticket service/SLA feature is enabled).' => 'Дозвољава дефинисање сервиса и "SLA" за тикете (нпр имејл, радна површина, мрежа, ...), и ескалационе атрибуте за "SLA" (ако је активиран сервис/"SLA" за тикет).',
        ...
        'Article free text options shown in the close ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на екрану затвореног тикета на интерфејсу запосленог. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        'Article free text options shown in the email ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на имејл екрану тикета на интерфејсу запосленог. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        'Article free text options shown in the phone ticket screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на екрану телефонског тикета на интерфејсу запосленог. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        'Article free text options shown in the ticket compose screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на екрану за писање тикета на интерфејсу запосленог. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        'Article free text options shown in the ticket free text screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на екрану слободног текста тикета на интерфејсу запосленог. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        ...
        'Article free text options shown in the ticket note screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на екрану напомене тикета на интерфејсу запосленог. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        'Article free text options shown in the ticket owner screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на екрану власника тикета на интерфејсу запосленог при увећаном приказу. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        'Article free text options shown in the ticket pending screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на екрану чекања тикета на интерфејсу запосленог при увећаном приказу. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        ...
        'Article free text options shown in the ticket phone outbound screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на екрану одлазног телефонског тикета на интерфејсу запосленог. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        'Article free text options shown in the ticket priority screen of a zoomed ticket in the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на екрану приоритета тикета на интерфејсу запосленог. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        'Article free text options shown in the ticket responsible screen of the agent interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required.' => 'Опције слободног текста чланка приказане на екрану одговорног за тикет на интерфејсу запосленог. Могуће поставке: 0 = искључено, 1 = укључено, 2 = укључено и обавезно.',
        'Attachments <-> Responses' => 'Прилози <-> Одговори',
        'Auto Responses <-> Queues' => 'Аутоматски одговори <-> Редови',
        'Automated line break in text messages after x number of chars.' => 'Аутоматски крај реда у текстуалним порукама после "x" карактера.',
        'Automatically lock and set owner to current Agent after selecting for an Bulk Action.' => 'Аутоматско закључавање и подешавање власника на актуелног запосленог после избора масовне акције.',
        ...
        'Builds an article index right after the article\'s creation.' => 'Генерише индекс чланака одмах по креирању чланка.',
        ...
        'Controls if customers have the ability to sort their tickets.' => 'Контролише да ли корисници имају могућност да сортирају своје тикете.',
        ...
        'Default ticket ID used by the system in the agent interface.' => 'Подразумевани ИД тикета који користи систем у интерфејсу запослених.',
        'Default ticket ID used by the system in the customer interface.' => 'Подразумевани ИД тикета који користи систем у корисничком интерфејсу.',
        ...
        'Defines all the parameters for this item in the customer preferences.' => 'Одређује све параметре за ову ставку у корисничким подешавањима.',
        ...
        'Defines if composed messages have to be spell checked in the agent interface.' => 'Одређује да ли порукама написаним у интерфејсу запослених треба урадити проверу правописа.',
        'Defines if time accounting is mandatory in the agent interface.' => 'Одређује да ли је обрачун времена обавезан у интерфејсу запослених.',
        ...
        'Defines the column to store the keys for the preferences table.' => 'Одређује колону за чување кључева табеле подешавања.',
        ...
        'Defines the date input format used in forms (option or input fields).' => 'Одређује формат уноса датума у формуларе (опција за поља за унос).',
        ...
        'Defines the default priority of new customer tickets in the customer interface.' => 'Одређује подразумевани приоритет за нове корисничке тикете у корисничком интерфејсу.',
        'Defines the default priority of new tickets.' => 'Одређује подразумевани приоритет за нове тикете.',
        'Defines the default queue for new customer tickets in the customer interface.' => 'Одређује подразумевани ред за нове корисничке тикете у корисничком интерфејсу.',
        ...
        'Defines the maximal size (in bytes) for file uploads via the browser.' => 'Одређује максималну величину датотека (у бајтима) за слање.',
        ...
        'Replaces the original sender with current customer\'s email address on compose answer in the ticket compose screen of the agent interface.' => 'Замењује огиналног пошиљаоца са имејл адресом актуелног корисника при креирању одговора у прозору за писање одговора интерфејса запосаленог.',
        'Required permissions to change the customer of a ticket in the agent interface.' => 'Потребне дозволе за промену корисника тикета у интерфејсу запосленог.',
        'Required permissions to use the close ticket screen in the agent interface.' => 'Потребне дозволе за употребу прозора за затварање тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket bounce screen in the agent interface.' => 'Потребне дозволе за употребу прозора за одбијање тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket compose screen in the agent interface.' => 'Потребне дозволе за употребу прозора за отварање тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket forward screen in the agent interface.' => 'Потребне дозволе за употребу прозора за прослеђивање тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket free text screen in the agent interface.' => 'Потребне дозволе за употребу прозора слободног текста тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket merge screen of a zoomed ticket in the agent interface.' => 'Потребне дозволе за употребу прозора за спајање при увећаном приказу тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket note screen in the agent interface.' => 'Потребне дозволе за употребу прозора за напомене тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket owner screen of a zoomed ticket in the agent interface.' => 'Потребне дозволе за употребу прозора власника тукета при увећаном приказу тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket pending screen of a zoomed ticket in the agent interface.' => 'Потребне дозволе за употребу прозора чекања при увећаном приказу тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket phone inbound screen in the agent interface.' => '',
        'Required permissions to use the ticket phone outbound screen in the agent interface.' => 'Потребне дозволе за употребу прозора телефонског одлазног тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket priority screen of a zoomed ticket in the agent interface.' => 'Потребне дозволе за употребу прозора приоритета при увећаном приказу тикета у интерфејсу запосленог.',
        'Required permissions to use the ticket responsible screen in the agent interface.' => 'Потребне дозволе за употребу прозора одговорног за тикет у интерфејсу запосленог.',
        'Resets and unlocks the owner of a ticket if it was moved to another queue.' => 'Ресетује и откључава власника тикета ако је премештен у други ред.',
        'Responses <-> Queues' => 'Одговори <-> Редови',
        'Restores a ticket from the archive (only if the event is a state change, from closed to any open available state).' => 'Рестаурира тикет из архиве (само ако је догађај промена статуса од затвореног на било који доступан отворени статус).',
        ...
        'Types' => 'Типови',
        'Update Ticket "Seen" flag if every article got seen or a new Article got created.' => 'Ажурирај оѕнаку виђених тикета ако су сви прегледани или је креиран нови чланак.',
        ...
        '(Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behinde a dial-up line $!)' => '(Проверите "MX" записе употребљених имејл адреса  креирањем одговора. Немојте користити ову функцију ако је ваш "OTRS" сервер на "dial-up" линији!)',
        ...
        '(Note: It depends on your installation how many dynamic objects you can use)' => '(Напомена: Од ваше инсталације зависи број динамичких објеката које можете користити)',
        '(Ticket identifier. Some people want toset this to e. g. \'Ticket#\', \'Call#\' or \'MyTicket#\')' => '(Идентификација тикета. нпр. \'Ticket#\', \'Call#\' или \'MyTicket#\')',
        ...
        'Activates TypeAhead for the autocomplete feature, that enables users to type in whatever speed they desire, without losing any information. Often this means that keystrokes entered will not be displayed on the screen immediately.' => 'Активира "Куцање унапред" за функцију аутокомплетирања, која омогућава корисницима да укуцавају текс било којом брином, без губљења информација. Најчешће то значи да на екрану неће сваки притисак на тастер бити одмах приказан.',
        ...
        'Adds a suffix with the actual year and month to the otrs log file. A logfile for every month will be created.' => 'Додаје суфикс са актуелном годином и месецом у "ОТРС" датотеку дневника. Биће креиран дневник за сваки месец.',
        'Adds the one time vacation days for the calendar number 1. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Једнократно додаје нерадне дане за календар број 1. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the one time vacation days for the calendar number 2. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Једнократно додаје нерадне дане за календар број 2. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the one time vacation days for the calendar number 3. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Једнократно додаје нерадне дане за календар број 3. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the one time vacation days for the calendar number 4. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Једнократно додаје нерадне дане за календар број 4. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the one time vacation days for the calendar number 5. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Једнократно додаје нерадне дане за календар број 5. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the one time vacation days for the calendar number 6. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Једнократно додаје нерадне дане за календар број 6. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the one time vacation days for the calendar number 7. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Једнократно додаје нерадне дане за календар број 7. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the one time vacation days for the calendar number 8. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Једнократно додаје нерадне дане за календар број 8. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the one time vacation days for the calendar number 9. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Једнократно додаје нерадне дане за календар број 9. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the permanent vacation days for the calendar number 1. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Трајно додаје нерадне дане за календар број 1. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the permanent vacation days for the calendar number 2. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Трајно додаје нерадне дане за календар број 2. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the permanent vacation days for the calendar number 3. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Трајно додаје нерадне дане за календар број 3. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the permanent vacation days for the calendar number 4. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Трајно додаје нерадне дане за календар број 4. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the permanent vacation days for the calendar number 5. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Трајно додаје нерадне дане за календар број 5. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the permanent vacation days for the calendar number 6. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Трајно додаје нерадне дане за календар број 6. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the permanent vacation days for the calendar number 7. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Трајно додаје нерадне дане за календар број 7. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the permanent vacation days for the calendar number 8. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Трајно додаје нерадне дане за календар број 8. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        'Adds the permanent vacation days for the calendar number 9. Please use single digit pattern for numbers from 1 to 9 (instead of 01 - 09).' => 'Трајно додаје нерадне дане за календар број 9. Молимо Вас да користите једну цифру за бројеве од 1 до 9 (уместо 01 - 09).',
        ...
        'All Customer variables like defined in config option CustomerUser.' => 'Све корисничке варијабле као што су дефинисане у конфигурационим опцијама за корисника.',
        'All customer tickets.' => 'Сви тикети за корисника.',
        'All email addresses get excluded on replaying on composing an email.' => 'Све имејл адресе ће бити искључене при креирању одговора.',
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' => 'Све имејл поруке са овим примаоцем (За:) биће отпремљене у изабрани ред!',
        ...
        'Can\'t update password, must contain 2 lower and 2 upper characters!' => 'Лозинка се не може ажурирати. Мора да садржи најмање два мала и два велика слова.',
        ...
        'Can\'t update password, your new passwords do not match! Please try again!' => 'Лозинка се не може ажурирати, нова лозинка се не подудара! Молимо покушајте поново!',
        ...
        'Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behind a dial-up line!' => 'Проверите "MX" записе употребљених имејл адреса  креирањем одговора. Немојте користити ову функцију ако је ваш "OTRS" сервер на "dial-up" линији.',
        ...
        'Defines the default selection of the free key field number 1 for articles (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 1 за чланке (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 1 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 1 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 10 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 10 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 11 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 11 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 12 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 12 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 13 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 13 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 14 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 14 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 15 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 15 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 16 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 16 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 2 for articles (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 2 за чланке (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 2 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 2 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 3 for articles (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 3 за чланке (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 3 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 3 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 4 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 4 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 5 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 5 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 6 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 6 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 7 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 7 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 8 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 8 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free key field number 9 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног кључа поља број 9 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 1 for articles (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 1 за чланке (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 1 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 1 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 10 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 10 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 11 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 11 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 12 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 12 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 13 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 13 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 14 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 14 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 15 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 15 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 16 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 16 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 2 for articles (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 2 за чланке (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 2 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 2 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 3 for articles (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 3 за чланке (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 3 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 3 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 4 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 4 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 5 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 5 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 6 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 6 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 7 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 7 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 8 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 8 за тикете (ако има више од једне могућности).',
        'Defines the default selection of the free text field number 9 for tickets (if more than one option is provided).' => 'Одређује подразумевани избор слободног текст поља број 9 за тикете (ако има више од једне могућности).',
        'Defines the free key field number 1 for tickets to add a new ticket attribute.' => 'Одређује слободно поље кључа број 1 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 1 for articles to add a new article attribute.' => 'Одређује слободно текст поље број 1 за чланке ради додавања новог атрибута чланка.',
        'Defines the free text field number 1 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 1 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 10 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 10 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 11 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 11 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 12 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 12 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 13 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 13 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 14 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 14 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 15 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 15 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 16 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 16 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 2 for articles to add a new article attribute.' => 'Одређује слободно текст поље број 2 за чланке ради додавања новог атрибута чланка.',
        'Defines the free text field number 2 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 2 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 3 for articles to add a new article attribute.' => 'Одређује слободно текст поље број 3 за чланке ради додавања новог атрибута чланка.',
        'Defines the free text field number 3 for ticket to add a new ticket attribute.' => 'Одређује слободно текст поље број 3 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 4 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 4 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 5 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 5 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 6 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 6 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 7 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 7 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 8 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 8 за тикете ради додавања новог атрибута тикета.',
        'Defines the free text field number 9 for tickets to add a new ticket attribute.' => 'Одређује слободно текст поље број 9 за тикете ради додавања новог атрибута тикета.',
        ...
        'Defines the hours and week days of the calendar number 1, to count the working time.' => 'Одређује сате и дане у седмици за календар број 1, ради калкулација радног времена.',
        'Defines the hours and week days of the calendar number 2, to count the working time.' => 'Одређује сате и дане у седмици за календар број 2, ради калкулација радног времена.',
        'Defines the hours and week days of the calendar number 3, to count the working time.' => 'Одређује сате и дане у седмици за календар број 3, ради калкулација радног времена.',
        'Defines the hours and week days of the calendar number 4, to count the working time.' => 'Одређује сате и дане у седмици за календар број 4, ради калкулација радног времена.',
        'Defines the hours and week days of the calendar number 5, to count the working time.' => 'Одређује сате и дане у седмици за календар број 5, ради калкулација радног времена.',
        'Defines the hours and week days of the calendar number 6, to count the working time.' => 'Одређује сате и дане у седмици за календар број 6, ради калкулација радног времена.',
        'Defines the hours and week days of the calendar number 7, to count the working time.' => 'Одређује сате и дане у седмици за календар број 7, ради калкулација радног времена.',
        'Defines the hours and week days of the calendar number 8, to count the working time.' => 'Одређује сате и дане у седмици за календар број 8, ради калкулација радног времена.',
        'Defines the hours and week days of the calendar number 9, to count the working time.' => 'Одређује сате и дане у седмици за календар број 9, ради калкулација радног времена.',
        'Defines the http link for the free text field number 1 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 1 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 10 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 10 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 11 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 11 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 12 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 12 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 13 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 13 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 14 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 14 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 15 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 15 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 16 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 16 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 2 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 2 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 3 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 3 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 4 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 4 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 5 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 5 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 6 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 6 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 7 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 7 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 8 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 8 за тикете (бише кориштено у сваком прегледу тикета).',
        'Defines the http link for the free text field number 9 for tickets (it will be used in every ticket view).' => 'Одређује "http" везу за поље слободног текста број 9 за тикете (бише кориштено у сваком прегледу тикета).',
        ...
        'Defines whether the free time field number 1 is optional or not.' => 'Одређује да ли је слободно поље времена број 1 опционо или не.',
        'Defines whether the free time field number 2 is optional or not.' => 'Одређује да ли је слободно поље времена број 2 опционо или не.',
        'Defines whether the free time field number 3 is optional or not.' => 'Одређује да ли је слободно поље времена број 3 опционо или не.',
        'Defines whether the free time field number 4 is optional or not.' => 'Одређује да ли је слободно поље времена број 4 опционо или не.',
        'Defines whether the free time field number 5 is optional or not.' => 'Одређује да ли је слободно поље времена број 5 опционо или не.',
        'Defines whether the free time field number 6 is optional or not.' => 'Одређује да ли је слободно поље времена број 6 опционо или не.',
        ...
        'Do dispatch or filter incoming emails based on email X-Headers! RegExp is also possible.' => 'Отпеми ил филтрирај долазне порукена основу "X-Headers"! "RegExp" је такође могућ.',
        'Do you really want to delete this Object?' => 'Да ли стварно желите да обришете овај објект?',
        'Do you really want to reinstall this package (all manual changes get lost)?' => 'Да ли стварно желите да реинсталирате овај пакет (све ручне промене ће бити изгубљене)?',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' => 'Молимо да не користите "UserID 1" (Системски налог) за рад! Направите нове налоге!',
        ...
        'Follow up' => 'Наставак',
        'For very complex stats it is possible to include a hardcoded file.' => 'За веома сложене статистике могуће је придружити наменски програмирану датотеку.',
        ...
        'Help' => 'Помоћ',
        'Here you can define the x-axis. You can select one element via the radio button. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' => 'Овде можете подесити X осу. Можете изабрати један елемент од понуђених опција. Уколико ништа не изаберете, сви елементи ће бити употртебљени ако правите статистику. Такође, нови атрибут је додан након последње конфигурације.',
        ...
        'Home' => 'Почетна',
        'If a new hardcoded file is available this attribute will be shown and you can select one.' => 'Ако је нова програмирана датотека доступна, овај атрибут ће бити приказан и моћи ћете да изаберете један.',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.' => 'Ако је тикет затворен, а корисник пошаље наставак, тикет ће бити закључан за старог власника.',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' => 'Ако неће бити одговорено на тикет у овом времену, онда ће само овај тикет бити приказан.',
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.' => 'Ако запослени закључа тикет и не одговори за ово време, тикет ће аутоматски бити откључан. Овај тикет је онда видљив свим другим запосленим.',
        ...
        'Imported' => 'Увезено',
        'Imported by' => 'Увезао',
        'In order to experience OTRS, you\'ll need to enable Javascript in your browser.' => 'Како би сте максимално искористили све могућности "OTRS" система, потребно је да активрате Јава скрипт у вашем Web читачу.',
        'In this form you can select the basic specifications.' => 'Ово је место за избор општих података.',
        'In this way you can directly edit the keyring configured in Kernel/Config.pm.' => 'На овај начин можете непосредно уредити кључеве подешене у датотеци "Kernel/Config.pm".',
        ...
        'Login failed! Your username or password was entered incorrectly.' => 'Неуспешна пријава! Ваше корисничко име или лозинка су нетачно унети.',
        'Lookup' => 'Проналажење',
        ...
        'No Packages for requested Framework in this Online Repository, but Packages for other Frameworks!' => 'У мрежном спремишту нема пакета за тражени систем, ту су само пакети за друге верзије.',
        ...
        'OTRS sends an notification email to the customer if the ticket is moved.' => '"OTRS" шаље обавештење кориснику ако је тикет премештен.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' => '"OTRS" шаље обавештење кориснику ако је промењен власник тикета.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' => '"OTRS" шаље имејл са обавештењем кориснику уколико се промени статус тикета.',
        'Object already linked as %s.' => 'Објекат је већ повезан као %s.',
        'Of couse this feature will take some system performance it self!' => 'Када је ова функција активна, заузеће део системских перформанси.',
        'One or more errors occured!' => 'Догодила се јадна или више грешака!',
        'Only for ArticleCreate Event.' => 'Само за догађај креирања чланка.',
        'Open Tickets' => 'Отворени тикети',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' => 'Опције за податке актуелног корисника (нпр. <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>).' => 'Опције података за актуелног корисника (нпр. <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current user who requested this action (e. g. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)' => 'Подешавања за корисника који је захтевао ову акцију (нпр. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)' => 'Информације о актуелном кориснику који је тражио ову акцију (нпр. <OTRS_CURRENT_UserFirstname>)',
        'Options of the ticket data (e. g. &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)' => 'Опције пдатака о тикету (нпр. &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)',
        'Options of the ticket data (e. g. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' => 'Опције података о тикету (нпр. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' => 'Опције података о тикету (нпр. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Other Options' => 'Друге опције',
        'Out Of Office' => 'Ван канцеларије',
        'Outbound Mail Type' => 'Тип одлазне поште',
        'POP3 Account Management' => 'Управљање "POP3" налозима',
        'Package' => 'Пакет',
        'Package not correctly deployed! You should reinstall the Package again!' => 'Пакет није коректно инсталиран! Требало би га да поново инсталирате!',
        'Package not correctly deployed! You should reinstall the package again!' => 'Пакет није исправно смештен. Требало би да га инсталирате поново!',
        'Param 1' => 'Парам 1',
        'Param 2' => 'Парам 2',
        'Param 3' => 'Парам 3',
        'Param 4' => 'Парам 4',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' => 'Побрините се да ажурирате и подразумеване статусе у "Kernel/Config.pm" датотеци!',
        ...
        'The identify of the system. Each ticket number and each http session id starts with this number.' => 'Идентитет система. Сваки број тикета и сваки ИД "HTTP" сесије почиње са овим бројем.',
        ...
        'This email address already exists. Please log in or reset your password..' => 'Ова имејл адреса већ постоји. Молимо, пријавите се или ресетујте вашу лозинку',
        'This is useful if you want that no one can get the result of the stat or the stat isn\'t ready configurated.' => 'Ово је корисно уколико не желите да ико види резултате статистике или конфигурација статистике није завршена.',
        ...
        'Ticket owner options (e. g. &lt;OTRS_OWNER_USERFIRSTNAME&gt;)' => 'Опције власника тикета (нпр. &lt;OTRS_OWNER_USERFIRSTNAME&gt;)',
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>).' => 'Детаљи о опцијама власника (z. B. <OTRS_OWNER_UserFirstname>).',
        'Ticket responsible options (e. g. <OTRS_RESPONSIBLE_UserFirstname>).' => 'Опције о одговорности за тикет (z. B.<OTRS_RESPONSIBLE_UserFirstname>).',
        ...
        'Title{user}' => 'Титула',
        'To get the article attribute (e. g. (<OTRS_AGENT_From>, <OTRS_AGENT_To>, <OTRS_AGENT_Cc>, <OTRS_AGENT_Subject> and <OTRS_AGENT_Body>).' => 'Да би видели атрибуте чланка (нпр. (<OTRS_AGENT_From>, <OTRS_AGENT_To>, <OTRS_AGENT_Cc>, <OTRS_AGENT_Subject> und <OTRS_AGENT_Body>).',
        ...
        'To get the first 5 lines of the body (последњег чланка запосленог).' => 'Да видите првих 5 линија поруке (последњег чланка запосленог).',
        ...
        'Warning! This tickets will be removed from the database! This tickets are lost!' => 'Пажња! Ови тикети ће бити уклоњени из базе и трајно изгубљени!',
        ...
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.' => 'Уносом и избором поља можете конфигурисати статистику према вашим потреама. Које елементе статистике можете мењати зависи од администратора који је конфигурисао статистику.',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further information.' => 'Ваш имејл са тикетом број "<OTRS_TICKET>" је преусмерен за "<OTRS_BOUNCE_TO>". Контактирајте на ту адресу за додатне информације.',

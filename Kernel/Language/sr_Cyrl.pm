...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'e. g.' => 'нпр.',
        'Options of the current customer data' => 'Опције података о актуелном клијенту',
        ...
        'Please note that you can\'t register your system if your scheduler is not running correctly!' =>
            'Молимо да обратите пажњу да не можете регистровати ваш систем ако планер не ради коректно!',
        ...
        'Information received through the \'Service Center\' is saved by OTRS Group.' =>
            'OTRS Група чува информације примљене преко Сервисног центра',
        ...
        'Scheduler is an OTRS separated process that perform asynchronous tasks' =>
            'Планер је посебан OTRS процес који извршава асинхроне задатке',
        ...
        'It is necessary to have the Scheduler running to make the system work correctly!' =>
            'Неопходно је да Планер буде покренут да би систем исправно радио!',
        'Starting Scheduler' => 'Покретање Планера',
        ...
        'Change customer of ticket' => 'Промена клијента за тикет',
        ...
        'Columns that can be filtered in the escalation view of the agent interface. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default. Note: Only Ticket attributes and Dynamic Fields (DynamicField_NameX) are allowed.' =>
            'Колоне које могу бити филтриране на ескалационом прегледу у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Доступно, 2 = Подразумевано омогућено. Напомена: Дозвољени су само атрибути тикета и динамичка поља (DynamicField_NameX).',
        'Columns that can be filtered in the locked view of the agent interface. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default. Note: Only Ticket attributes and Dynamic Fields (DynamicField_NameX) are allowed.' =>
            'Колоне које могу бити филтриране на закључаном прегледу у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Доступно, 2 = Подразумевано омогућено. Напомена: Дозвољени су само атрибути тикета и динамичка поља (DynamicField_NameX).',
        'Columns that can be filtered in the queue view of the agent interface. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default. Note: Only Ticket attributes and Dynamic Fields (DynamicField_NameX) are allowed.' =>
            'Колоне које могу бити филтриране на прегледу реда у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Доступно, 2 = Подразумевано омогућено. Напомена: Дозвољени су само атрибути тикета и динамичка поља (DynamicField_NameX).',
        'Columns that can be filtered in the responsible view of the agent interface. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default. Note: Only Ticket attributes and Dynamic Fields (DynamicField_NameX) are allowed.' =>
            'Колоне које могу бити филтриране на прегледу одговорног у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Доступно, 2 = Подразумевано омогућено. Напомена: Дозвољени су само атрибути тикета и динамичка поља (DynamicField_NameX).',
        'Columns that can be filtered in the service view of the agent interface. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default. Note: Only Ticket attributes and Dynamic Fields (DynamicField_NameX) are allowed.' =>
            'Колоне које могу бити филтриране на сервисном прегледу у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Доступно, 2 = Подразумевано омогућено. Напомена: Дозвољени су само атрибути тикета и динамичка поља (DynamicField_NameX).',
        'Columns that can be filtered in the status view of the agent interface. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default. Note: Only Ticket attributes and Dynamic Fields (DynamicField_NameX) are allowed.' =>
            'Колоне које могу бити филтриране на статусном прегледу у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Доступно, 2 = Подразумевано омогућено. Напомена: Дозвољени су само атрибути тикета и динамичка поља (DynamicField_NameX).',
        'Columns that can be filtered in the ticket search result view of the agent interface. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default. Note: Only Ticket attributes and Dynamic Fields (DynamicField_NameX) are allowed.' =>
            'Колоне које могу бити филтриране на прегледу резултата претраге тикета у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Доступно, 2 = Подразумевано омогућено. Напомена: Дозвољени су само атрибути тикета и динамичка поља (DynamicField_NameX).',
        'Columns that can be filtered in the watch view of the agent interface. Possible settings: 0 = Disabled, 1 = Available, 2 = Enabled by default. Note: Only Ticket attributes and Dynamic Fields (DynamicField_NameX) are allowed.' =>
            'Колоне које могу бити филтриране на надзорном прегледу у интерфејсу оператера. Могућа подешавања: 0 = Онемогућено, 1 = Доступно, 2 = Подразумевано омогућено. Напомена: Дозвољени су само атрибути тикета и динамичка поља (DynamicField_NameX).',
        ...
        'Defines the default front-end (HTML) theme to be used by the agents and customers. If you like, you can add your own theme. Please refer the administrator manual located at http://doc.otrs.org/.' =>
            'Одређује подразумевану тему главног интерфејса (HTML) која ће бити коришћена од стране оператера или клијената. Уколико желите можете додати вашу личну тему. Молимо Вас да погледате упутство за администратора, које се налази на http://doc.otrs.org/.',
        ...
        'Defines the default next state for a ticket after customer follow up in the customer interface.' =>
            'Одређује подразумевани следећи статус тикета након што клијент уради наставак у интерфејсу клијента.',
        ...
        'Defines the default priority of follow up customer tickets in the ticket zoom screen in the customer interface.' =>
            'Одређује подразумевани приоритет тикета клијента за наставак при увећаном приказу екрана тикета у интерфејсу клијента.',
        ...
        'Defines the module to generate html refresh headers of html sites, in the customer interface.' =>
            'Одређује модул за генерисање html освежавања заглавља html сајтова у интерфејсу корисника.',
        ...
        'Defines the path of the shown info file, that is located under Kernel/Output/HTML/Standard/CustomerAccept.dtl.' =>
            'Одређује путању приказаног инфо директоријума који је лоциран под „Kernel/Output/HTML/Standard/CustomerAccept.tt”.**',
        ...
        'Determines the next screen after the follow up screen of a zoomed ticket in the customer interface.' =>
            'Одређује следећи приказ екрана, након приказа екрана наставка при увећању тикета у интерфејсу клијента.',
        ...
        'Enroll this ticket into a process' => 'Прикључи овај тикет процесу',
        ...
        'List of IE8-specific CSS files to always be loaded for the customer interface.' =>
            'Листа посебних IE8 CSS датотека које се увек учитавају за интерфејс клијента.',
        ...
        'Makes the session management use html cookies. If html cookies are disabled or if the client browser disabled html cookies, then the system will work as usual and append the session id to the links.' =>
            '',
        'Manage OTRS Group services.' => 'Управљај услугама OTRS Групе.',
        ...
        'My Queues and My Services' => 'Моји редови и Моје услуге',
        'My Queues or My Services' => 'Моји редови или Моје услуге',
        ...
        'No Notification' => 'Нема обавештења',
        'None' => 'Ни један',
        ...
        'Send me a notification if the service of a ticket is changed to a service in "My Services" and the ticket is in a queue where I have read permissions.' =>
            'Пошаљи ми обавештење за нови тикет у "Мојим Сервисима".',
        'Send me a notification if there is a new ticket in my queues/services.' =>
            'Пошаљи ми обавештење за нови тикет у мојим редовима/сервисима.',
        'Send new ticket notifications if subscribed to' => 'Ако постоји претплата, пошаљи обавештење о новом тикету ',
        'Send notifications to users.' => 'Пошаљи обавештења корисницима.',
        'Send service update notifications' => 'Пошаљи обавештења о ажурирању услуге',
        'Send ticket follow up notifications if subscribed to' => 'Ако постоји претплата, пошаљи обавештење о праћењу тикета',
        ...
        'Sends the notifications which are configured in the admin interface under "Notfication (Event)".' =>
            '',
        'Service update notification' => 'Обавештења о ажурирању услуге',
        'Service view' => 'Преглед услуге',
        ...
        'Sets the time type which should be shown.' => 'Подешава тип времена које ће бити приказано.',
        ...
        'Specifies the email address that should be used by the application when sending notifications. The email address is used to build the complete display name for the notification master (i.e. "OTRS Notification Master" otrs@your.example.com). You can use the OTRS_CONFIG_FQDN variable as set in your configuation, or choose another email address. Notifications are messages such as en::Customer::QueueUpdate or en::Agent::Move.' =>
            'Одређује имејл адресу коју би требала да користи апликација када шаље обавештења. Имејл адреса се користи за крађење комплетног приказаног назива главног обавештења (нпр. "OTRS Notification Master" otrs@your.example.com). Можете користити OTRS_CONFIG_FQDN варијаблу као подешавање у вашој конфигурацији или изаберите другу имејл адресу. Обавештења су поруке као en::Customer::QueueUpdate или en::Agent::Move.',
        ...
        'Specifies the name that should be used by the application when sending notifications. The sender name is used to build the complete display name for the notification master (i.e. "OTRS Notification Master" otrs@your.example.com). Notifications are messages such as en::Customer::QueueUpdate or en::Agent::Move.' =>
            'Одређује име које би требала да користи апликација када шаље обавештења. Име пошиљаоца се користи за грађење комплетног приказаног назива главног обавештења (нпр. "OTRS Notification Master" otrs@your.example.com). Обавештења су поруке као en::Customer::QueueUpdate или en::Agent::Move.',
        ...
        'This option defines the process tickets default priority.' => 'Ова опција одређује подразумевани приоритет процеса тикета.',
        ...
        'Write a new, outgoing mail' => 'Напишит нови, одлазни имејл',

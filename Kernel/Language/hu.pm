...
# Copyright (C) 2013 Csaba Nemeth <csaba@sopron.hu>
# Copyright (C) 2014, 2015, 2016, 2017 Balazs Ur <urbalazs@gmail.com>
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Table Status' => 'Táblaállapot',
        'Tables found which do not have a regular status.' => 'Olyan táblák találhatók, amelyeknek nincs szabványos állapotuk.',
        'MySQL 5.x or higher is required.' => 'MySQL 5.x vagy újabb szükséges.',
        'NLS_LANG Setting' => 'NLS_LANG beállítás',
        'NLS_LANG must be set to utf8 (e.g. german_germany.utf8).' => 'Az NLS_LANG értékét utf8 értékre kell állítani (például: german_germany.utf8).',
        ...
        'History::TypeUpdate' => 'History::TypeUpdate',
        'History::ServiceUpdate' => 'History::ServiceUpdate',
        'History::SLAUpdate' => 'History::SLAUpdate',
        'History::NewTicket' => 'History::NewTicket',
        'History::FollowUp' => 'History::FollowUp',
        'History::SendAutoReject' => 'History::SendAutoReject',
        'History::SendAutoReply' => 'History::SendAutoReply',
        'History::SendAutoFollowUp' => 'History::SendAutoFollowUp',
        'History::Forward' => 'History::Forward',
        'History::Bounce' => 'History::Bounce',
        'History::SendAnswer' => 'History::SendAnswer',
        'History::SendAgentNotification' => 'History::SendAgentNotification',
        'History::SendCustomerNotification' => 'History::SendCustomerNotification',
        'History::EmailAgent' => 'History::EmailAgent',
        'History::EmailCustomer' => 'History::EmailCustomer',
        'History::PhoneCallAgent' => 'History::PhoneCallAgent',
        'History::PhoneCallCustomer' => 'History::PhoneCallCustomer',
        'History::AddNote' => 'History::AddNote',
        'History::Lock' => 'History::Lock',
        'History::Unlock' => 'History::Unlock',
        'History::TimeAccounting' => 'History::TimeAccounting',
        'History::Remove' => 'History::Remove',
        'History::CustomerUpdate' => 'History::CustomerUpdate',
        'History::PriorityUpdate' => 'History::PriorityUpdate',
        'History::OwnerUpdate' => 'History::OwnerUpdate',
        'History::LoopProtection' => 'History::LoopProtection',
        'History::Misc' => 'History::Misc',
        'History::SetPendingTime' => 'History::SetPendingTime',
        'History::StateUpdate' => 'History::StateUpdate',
        'History::TicketDynamicFieldUpdate' => 'History::TicketDynamicFieldUpdate',
        'History::WebRequestCustomer' => 'History::WebRequestCustomer',
        'History::TicketLinkAdd' => 'History::TicketLinkAdd',
        'History::TicketLinkDelete' => 'History::TicketLinkDelete',
        'History::Subscribe' => 'History::Subscribe',
        'History::Unsubscribe' => 'History::Unsubscribe',
        'History::SystemRequest' => 'History::SystemRequest',
        'History::ResponsibleUpdate' => 'History::ResponsibleUpdate',
        'History::ArchiveFlagUpdate' => 'History::ArchiveFlagUpdate',
        'History::TicketTitleUpdate' => 'History::TicketTitleUpdate',
        ...
        'Search for customers.' => 'Ügyfelek keresése.',
        ...
        'Did not find a required feature? OTRS Group provides their service contract customers with exclusive Add-Ons:' =>
            'Nem találta meg a szükséges funkciót? Az OTRS csoport saját szolgáltatási szerződést biztosít az ügyfeleknek kizárólagos kiegészítőkkel:',
        ...
        'Feature Add-Ons' => 'Funkció kiegészítők',
        ...
        'Synchronize All Processes' => 'Minden folyamat szinkronizálása',
        ...
        'Please note that you can\'t register your system if your scheduler is not running correctly!' =>
            'Ne feledje, hogy nem tudja regisztrálni a rendszerét akkor, ha az ütemezője nem fut helyesen!',
        ...
        'Filter for SMIME certs' => 'Szűrő az S/MIME tanúsítványokhoz',
        ...
        'This option will force Scheduler to start even if the process is still registered in the database' =>
            'Ez a lehetőség indításra fogja kényszeríteni az ütemezőt még akkor is, ha a folyamat éppen regisztrálás alatt van az adatbázisban.',
        'Start scheduler' => 'Ütemező indítása',
        'Scheduler could not be started. Check if scheduler is not running and try it again with Force Start option' =>
            'Az ütemezőt nem lehetett elindítani. Ellenőrizze, hogy az ütemező fut-e, és próbálja meg az erőltetett indítás lehetőséggel.',
        ...
        'Query is executed.' => 'A lekérdezés végrehajtva.',
        ...
        'A standard template with this name already exists!' => 'Egy szabványos sablon már létezik ilyen névvel!',
        'Template' => 'Sablon',
        ...
        'Lastname' => 'Vezetéknév',
        'A user with this username already exists!' => 'Egy felhasználó már létezik ezzel a felhasználónévvel!',
        ...
        'For all pending* states.' => 'Minden várakozó* állapothoz.',
        ...
        'Agent interface notification module to check the used charset.' =>
            'Ügyintézői felület értesítési modul a használt karakterkészlet ellenőrzéséhez.',
        ...
        'Allows adding notes in the close ticket screen of the agent interface.' =>
            'Lehetővé teszi jegyzetek hozzáadását az ügyintézői felület jegylezárás képernyőjén.',
        'Allows adding notes in the ticket free text screen of the agent interface.' =>
            'Lehetővé teszi jegyzetek hozzáadását az ügyintézői felület jegy szabad szöveg képernyőjén.',
        'Allows adding notes in the ticket note screen of the agent interface.' =>
            'Lehetővé teszi jegyzetek hozzáadását az ügyintézői felület jegyjegyzet képernyőjén.',
        'Allows adding notes in the ticket owner screen of a zoomed ticket in the agent interface.' =>
            'Lehetővé teszi jegyzetek hozzáadását egy nagyított jegynek a jegytulajdonos képernyőjén az ügyintézői felületen.',
        'Allows adding notes in the ticket pending screen of a zoomed ticket in the agent interface.' =>
            'Lehetővé teszi jegyzetek hozzáadását egy nagyított jegynek a várakozó jegy képernyőjén az ügyintézői felületen.',
        'Allows adding notes in the ticket priority screen of a zoomed ticket in the agent interface.' =>
            'Lehetővé teszi jegyzetek hozzáadását egy nagyított jegynek a jegyprioritás képernyőjén az ügyintézői felületen.',
        'Allows adding notes in the ticket responsible screen of the agent interface.' =>
            'Lehetővé teszi jegyzetek hozzáadását az ügyintézői felület jegyfelelős képernyőjén.',
        ...
        'Closed tickets of customer' => 'Az ügyfél lezárt jegyei',
        ...
        'Controls if the admin is allowed to make changes to the database via AdminSelectBox.' =>
            'Azt szabályozza, hogy az adminisztrátornak lehetősége van-e módosításokat végrehajtania az adatbázison az AdminSelectBox használatával.',
        ...
        'Custom text for the page shown to customers that have no tickets yet.' =>
            'Egyéni szöveg arra az oldalra, amely azoknak az ügyfeleknek jelenik meg, akik még nem rendelkeznek jeggyel.',
        'Customer Company Administration' => 'Ügyfél cég adminisztráció',
        'Customer Company Administration.' => 'Ügyfél cég adminisztráció.',
        'Customer Company Information' => 'Ügyfél cég információk',
        'Customer Information Center.' => 'Ügyfél-információs központ',
        ...
        'Defines if time accounting is mandatory in the agent interface.' =>
            'Meghatározza, hogy az időelszámolás kötelező-e az ügyintézői felületen.',
        ...
        'Defines the HTTP hostname for the support data collection with the public module \'PublicSupportDataCollector\' (e.g. used from the OTRS Daemon).' =>
            'Meghatározza a HTTP gépnevet a „PublicSupportDataCollector” nyilvános modullal történő támogatási adatok gyűjtésénél (például az OTRS démonból használva).',
        ...
        'Defines the format of responses in the ticket compose screen of the agent interface ($QData{"OrigFrom"} is From 1:1, $QData{"OrigFromName"} is only realname of From).' =>
            'Meghatározza a válaszok formátumát az ügyintézői felület jegyírás képernyőjén ($QData{"OrigFrom"} = feladó 1:1, $QData{"OrigFromName"} csak a feladó valódi neve).',
        ...
        'Defines the maximum number of quoted lines to be added to responses.' =>
            'Meghatározza a válaszokhoz hozzáadandó idézett sorok legnagyobb számát.',
        ...
        'Disable HTTP header "Content-Security-Policy" to allow loading of external script contents. Disabling this HTTP header can be a security issue! Only disable it, if you know what you are doing!' =>
            'A „Content-Security-Policy” HTTP-fejléc letiltása a külső parancsfájltartalmak betöltésének lehetővé tételéhez. Ennek a HTTP-fejlécnek a letiltása biztonsági probléma lehet! Csak akkor tiltsa le, ha tudja, hogy mit csinál!',
        ...
        'Enables or disable the debug mode over frontend interface.' => 'Engedélyezi vagy letiltja a hibakereső módot az előtétprogram felületén.',
        ...
        'Event module that updates customer users after an update of the Customer Company.' =>
            'Eseménymodul, amely frissíti az ügyfél-felhasználókat az ügyfél cég frissítése után.',
        'Event module that updates tickets after an update of the Customer Company.' =>
            'Eseménymodul, amely frissíti a jegyeket az ügyfél cég frissítése után.',
        ...
        'Open tickets of customer' => 'Az ügyfél nyitott jegyei',
        ...
        'Sets if note must be filled in by the agent.' => 'Beállítja, hogy a jegyzetet ki kell-e töltenie az ügyintézőnek.',
        ...
        'Specifies the default article type for the ticket compose screen in the agent interface if the article type cannot be automatically detected.' =>
            'Megadja az alapértelmezett bejegyzéstípust a jegyírás képernyőnél az ügyintézői felületen, ha a bejegyzéstípust nem lehet automatikusan felismerni.',
        ...
        'Turns off SSL certificate validation, for example if you use a transparent HTTPS proxy. Use at your own risk!' =>
            'Kikapcsolja az SSL tanúsítvány ellenőrzést, például ha átlátszó HTTPS proxyt használ. Csak saját felelősségére használja!',

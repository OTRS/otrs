...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'within the last ...' => 'az utolsó ...',
        'within the next ...' => 'a következő ...',
        'Created within the last' => 'Létrehozva az utolsó ',
        ...
        'Need Action' => 'Beavatkozást Igényel',
        ...
        'Show Tree Selection' => 'Fa szerkezetű választás mutatása',
        'The field content is too long!' => 'A mező tartalma túl hosszú!',
        'Maximum size is %s characters.' => 'Maximum méret %s karakter.',
        'This field is required or' => 'A mező kitöltése kötelező vagy',
        ...
        'Please activate %s first!' => 'Kérjük aktiválja %s először!',
        ...
        'Login failed! Your user name or password was entered incorrectly.' =>
            'Sikertelen bejelentkezés! A felhasználónév vagy a jelszó helytelenül lett beírva.',
        'There is no acount with that user name.' => 'Nincs fiók ilyen felhasználónévvel.',
        'Please contact your administrator' => 'Lépjen kapcsolatba a rendszergazdával',
        'Authentication succeeded, but no customer record is found in the customer backend. Please contact your administrator.' =>
            'A hitelesítés sikerült, de nem található ügyfél rekord az ügyfél backend oldalon. Kérjük, lépjen kapcsolatba a rendszergazdával.',
        'This e-mail address already exists. Please log in or reset your password.' =>
            'Ez az e-mail cím már létezik. Kérjük, jelentkezzen be, vagy állítsa alaphelyzetbe a jelszót.',
        'Logout' => 'Kilépés',
        'Logout successful. Thank you for using %s!' => 'Sikeres kijelentkezés. Köszönjük, hogy használta a(z) %s!',
        'Feature not active!' => 'Képesség nem aktív!',
        'Agent updated!' => 'Ügyintéző módosítva!',
        'Database Selection' => 'Adatbázis választás',
        'Create Database' => 'Adatbázis létrehozása',
        'System Settings' => 'Rendszerbeállítások',
        'Mail Configuration' => 'Levelezés beállítás',
        'Finished' => 'Befejezve',
        'Install OTRS' => 'OTRS telepítése',
        'Intro' => 'Intró',
        'License' => 'Licensz',
        'Database' => 'Adatbázis',
        'Configure Mail' => 'Levelezés beállítás',
        'Database deleted.' => 'Adatbázis törölve.',
        'Enter the password for the administrative database user.' => 'Írja be a jelszót adminisztrációs adatbázis-felhasználóhoz.',
        'Enter the password for the database user.' => 'Írja be a jelszót az adatbázis felhasználóhoz.',
        'If you have set a root password for your database, it must be entered here. If not, leave this field empty.' =>
            'Ha beállította a root jelszót az adatbázishoz, akkor itt kell megadni. Ha nem, hagyja üresen a mezőt.',
        'Database already contains data - it should be empty!' => 'Adatbázis már tartalmaz adatokat - ennek üresnek kell lennie!',
        'Login is needed!' => 'Belépés szükséges!',
        'It is currently not possible to login due to a scheduled system maintenance.' =>
            'Jelenleg nem lehetséges a bejelentkezés a tervezett rendszer karbantartása miatt.',
        ...
        'Session invalid. Please log in again.' => 'A munkafolyamat érvénytelen. Kérjük jelentkezzen be újra.',
        ...
        'Package not correctly deployed! Please reinstall the package.' =>
            '',
        '%s is not writable!' => '%s nem írható!',
        'Cannot create %s!' => 'Nem lehet létrehozni: %s!',
        'Check to activate this date' => 'Ellenőrizze, hogy aktiválja ezt az időpontot',
        'You have Out of Office enabled, would you like to disable it?' =>
            'A házon kívül engedélyezve van, szeretné letiltani?',
        'News about OTRS releases!' => 'Hírek az OTRS kiadásairól!',
        'Customer %s added' => '%s ügyfél hozzáadva',
        'Role added!' => 'Szerep hozzáadva!',
        'Role updated!' => 'Szerep frissítve!',
        'Attachment added!' => 'Csatolmány hozzáadva!',
        'Attachment updated!' => 'Csatolmány frissítve!',
        ...
        'Customer company added!' => 'Ügyfél cég hozzáadva!',
        'Customer company updated!' => 'Ügyfél cég frissítve!',
        'Note: Company is invalid!' => 'Megjegyzés: Cég nem valós!',
        'Mail account added!' => 'Levelezési fiók hozzáadva!',
        'Mail account updated!' => 'Levelezési fiók frissítve!',
        ...
        'Articles' => '',
        'Attachments (DB, Without HTML)' => 'Csatolmányok (DB, HTML nélkül)',
        ...
        'My Locked Tickets' => 'Zárolt jegyeim',
        'My Watched Tickets' => 'Átnézett jegyek',
        'My Responsible Tickets' => 'Felelősségi körömbe tartozó jegyek',
        ...
        'Add Template' => '',
        'Edit Template' => '',
        'A standard template with this name already exists!' => 'Sablon neve',
        'Template' => '',
        ...
        'Attachment Name' => 'Csatolmány neve',
        '(e. g. m*file or myfi*)' => 'pl: f*jlom vagy énfá*',
        ...
        'Reset Filter' => '',
        'Show one article' => '',
        'Show all articles' => 'Mutasd az összes cikket',
        ...
        'To open links in the following article, you might need to press Ctrl or Cmd or Shift key while clicking the link (depending on your browser and OS).' =>
            'A következő cikkben szereplő hivatkozások megnyitásához szükséged lehet a Ctrl, Cmd vagy Shift billentyűk használatakor a linkre való kattintáskor (függően a böngésző fajtájától)',
        'Close this message' => '',
        ...
        'Welcome!' => 'Üdvözöllek!',
        'Please click the button below to create your first ticket.' => 'Klikkelj az alábbi gombra az első jegyed elkészítéséhez',
        'Create your first ticket' => 'Elkészítem az első jegyemet',
        ...
        'Customer ID' => '',
        'Fulltext search in tickets (e. g. "John*n" or "Will*")' => 'Teljes szöveges keresés a jegyekben (pl: "J*nos" vagy "Gabo*")',
        'Carbon Copy' => '',
        'e. g. m*file or myfi*' => 'pl: f*jlom vagy énfá*',
        'Types' => 'Típusok',
        'Time restrictions' => '',
        'No time settings' => '',
        'Only tickets created' => 'Jegyek készültek',
        'Only tickets created between' => 'Jegyek készültek között',
        'Ticket archive system' => '',
        'Save search as template?' => 'Elmentsem a keresést sablonként?',
        'Save as Template?' => 'Mentsem el sablonként?',
        'Save as Template' => 'Mentsd el sablonként',
        ...
        # SysConfig
        ' (work units)' => '',
        '"%s"-notification sent to "%s".' => 'Történet::ÜgyintézőÉrtesítésKüldés',
        '%s' => 'Történet::Vegyes',
        '%s time unit(s) accounted. Now total %s time unit(s).' => 'Történet::IdőElszámolás',
        ...
        'ActivityID' => '',
        'Added email. %s' => 'Történet::EmailÜgyfél',
        'Added link to ticket "%s".' => 'Történet::JegyCsatolásHozzáadás',
        'Added note (%s)' => 'Történet::MegjegyzésHozzáadás',
        ...
        'Agent called customer.' => 'Történet::ÜgyintézőTelefonHívás',
        ...
        'AutoFollowUp sent to "%s".' => 'Történet::AutomatikusReakcióKüldés',
        'AutoReject sent to "%s".' => 'Történet::AutomatikusElutasításKüldés',
        'AutoReply sent to "%s".' => 'Történet::AutomatikusVálaszKüldés',
        ...
        'Blocks all the incoming emails that do not have a valid ticket number in subject with From: @example.com address.' =>
            '',
        'Bounced to "%s".' => 'Történet::Visszaküld',
        ...
        'Changed priority from "%s" (%s) to "%s" (%s).' => 'Történet::PrioritásMódosítás',
        ...
        'Comment2' => '',
        'Company Status' => '',
        'Company Tickets' => 'Vállalati hibajegyek',
        ...
        'Customer called us.' => 'Történet::ÜgyfélTelefonHívás',
        'Customer item (icon) which shows the closed tickets of this customer as info block. Setting CustomerUserLogin to 1 searches for tickets based on login name rather than CustomerID.' =>
            '',
        'Customer item (icon) which shows the open tickets of this customer as info block. Setting CustomerUserLogin to 1 searches for tickets based on login name rather than CustomerID.' =>
            '',
        'Customer request via web.' => 'Történet::ÜgyfélWebKérés',
        ...
        'Defines an alternate URL, where the logout link refers to.' => 'Definiál egy alternatív URL-t ahova a logout hivatkozás utal',
        'Defines an alternate login URL for the customer panel..' => '',
        'Defines an alternate logout URL for the customer panel.' => 'Definiál egy alternatív logout URL-t a felhasználói felülethez',
        ...
        'Defines, which tickets of which ticket state types should not be listed in linked ticket lists.' =>
            '',
        'Deleted link to ticket "%s".' => 'Történet::JegyCsatolásTörlés',
        ...
        'Email sent to "%s".' => 'Történet::VálaszKüldés',
        'Email sent to customer.' => 'Történet::EmailÜgyintéző',
        ...
        'Enroll this ticket into a process' => 'Jegy bejegyzése folyamat jegyként',
        ...
        'FollowUp for [%s]. %s' => 'Történet::Válasz',
        ...
        'Forces to unlock tickets after being moved to another queue.' =>
            '',
        'Forwarded to "%s".' => 'Történet::Továbbít',
        'Frontend language' => '',
        ...
        'List of default Standard Templates which are assigned automatically to new Queues upon creation.' =>
            '',
        'List view' => '',
        'Locked ticket.' => 'Történet::Zárol',
        'Log file for the ticket counter.' => '',
        'Loop-Protection! No auto-response sent to "%s".' => 'Történet::VisszacsatolásVédelem',
        'Mail Accounts' => '',
        ...
        'Name of custom service. The custom service is a service selection of your preferred services and can be selected in the preferences settings.' =>
            '',
        'NameX' => '',
        'New Ticket [%s] created (Q=%s;P=%s;S=%s).' => 'Történet::ÚjJegy',
        'New Window' => '',
        'New email ticket' => 'Új email hibajegy',
        'New owner is "%s" (ID=%s).' => 'Történet::TulajdonosVáltás',
        'New phone ticket' => 'Új telefonos hibajegy',
        'New process ticket' => 'Új folyamat jegy',
        ...
        'No Notification' => '',
        'None' => '',
        'Notification sent to "%s".' => 'Történet::ÜgyfélÉrtesítésKüldés',
        'Notifications (Event)' => 'Értesítés (Esemény)',
        'Number of displayed tickets' => 'Megjelenítendő jegyek száma',
        ...
        'Number of tickets to be displayed in each page of a search result in the customer interface.' =>
            '',
        'Old: "%s" New: "%s"' => 'Történet::ÁllapotMódosítás',
        'Online' => '',
        ...
        'Shows all the articles of the ticket (expanded) in the zoom view.' =>
            'Mutasd az összes cikket bővített nézetben',
        ...
        'Shows the articles sorted normally or in reverse, under ticket zoom in the agent interface.' =>
            'Mutasd a cikkeket normál vagy fordított sorrendben, az ügynök nézetben',
        ...
        'This option will deny the access to customer company tickets, which are not created by the customer user.' =>
            'Ez az opció tiltani fogja a felhasználók számára a vállalati jegyekhez való hozzáférést, amit nem felhasználók hoztak létre',
        'This setting allows you to override the built-in country list with your own list of countries. This is particularly handy if you just want to use a small select group of countries.' =>
            '',
        'Ticket Queue Overview' => '',
        'Ticket event module that triggers the escalation stop events.' =>
            '',
        'Ticket moved into Queue "%s" (%s) from Queue "%s" (%s).' => 'Történet::Mozgat',
        ...
        'Unlock tickets whenever a note is added and the owner is out of office.' =>
            '',
        'Unlocked ticket.' => 'Történet::Feloldás',
        ...
        'Updated: %s' => 'Történet::VárakozásiIdőBeállítás',
        'Updated: %s=%s;%s=%s;%s=%s;' => 'Történet::JegySzabadSzövegMódosítás',

...
# --
# $Id: nb_NO.pm,v 1.107 2011-01-28 14:11:34 martin Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'New message!' => 'Ny melding!',
        'Please answer this ticket(s) to get back to the normal queue view!' => 'Vennligst besvar denne/disse sakene for å komme tilbake til det normale køvisningsbildet!',
        ...
        'Login failed! Your user name or password was entered incorrectly.' => 'Innlogging feilet! Brukernavn eller passord ble skrevet inn feil.',
        ...
        'No packages for your framework version found in this repository, it only contains packages for other framework versions.' => 'Ingen pakker ble funnet for din rammeverk-versjon, kun for andre versjoner',
        'No packages, or no new packages, found in selected repository.' => 'Ingen pakker, eller ingen nye pakker ble funnet i valgt fjernarkiv',
        ...
        'Dear %s,' => 'Kjære %s',
        'Hello %s,' => 'Kjære %s',
        'This email address already exists. Please log in or reset your password.' => 'Denne epostadressen eksisterer allerede. Vennligst logg inn eller nullstill passordet.',
        ...
        'Select the separator character used in CSV files (stats and searches). If you don\'t select a separator here, the default separator for your language will be used.' => 'Velg et separator-tegn for bruk i CSV-filer (statistikk og søk). Hvis du ikke velger en, vil standardtegnet for språket bli brukt.',
        ...
        'Pending' => 'På vent',
        'Owner' => 'Agent',
        'Owner Update' => 'Agent Oppdatering',
        ...
        'Reply All' => 'Svar Alle',
        'Direction' => 'Retning',
        'Agent (All with write permissions)' => 'Agent (Alle med skriverettigheter)',
        'Agent (Owner)' => 'Agent (Eier)',
        'Agent (Responsible)' => 'Agent (Ansvarlig)',
        'New ticket notification' => 'Varsling ved ny sak',
        'Send me a notification if there is a new ticket in "My Queues".' => 'Send meg en varsling dersom det kommer en ny sak i mine utvalgte køer.',
        ...
        'Send me a notification if a ticket is unlocked by the system.' => 'Send meg en varsling dersom systemet åpner en avsluttet sak.',
        ...
        'Send me a notification if a ticket is moved into one of "My Queues".' => 'Send meg en varsling dersom en sak flyttes over i en av mine utvalgte køer.',
        'Send ticket move notifications' => 'Send varsling om flytting av sak',
        'Your queue selection of your favourite queues. You also get notified about those queues via email if enabled.' => 'Her velger du dine utvalgte køer. Du vil også få varslinger fra disse køer, hvis du har valgt det.',
        ...
        'Send me the same notifications for my watched tickets that the ticket owners will get.' => 'Send meg samme varsling for overvåkede saker som sakens eier får',
        ...
        'All open tickets, these tickets have already been worked on, but need a response' => 'Alle åpne saker som trenger arbeid, men som også trenger et svar',
        ...
        'History::EmailAgent' => 'epost sendt til agent.',
        'History::EmailCustomer' => 'Lagt epost til sak. %s',
        'History::PhoneCallAgent' => 'Agent ringte kunde.',
        ...
        'History::OwnerUpdate' => 'Ny agent er "%s" (ID=%s).',
        ...
        'This field is required and needs to be a valid email address.' => 'Dette feltet er påkrevd og trenger å være en gyldig epostadresse',
        'This email address is not allowed due to the system configuration.' => 'Denne epostadressen er ikke tillatt i systemkonfigurasjonen',
        ...
        'You can manage these groups via the configuration setting "CustomerGroupAlwaysGroups".' => 'Du kan styre disse gruppene gjennom innstillingen "CustomerGroupAlwaysGroups"',
        ...
        'With this module, administrators can send messages to agents, group or role members.' => 'Med denne modulen kan administratorer sende meldinger til agenter, gruppe- eller rolle-medlemmer',
        ...
        'Send agent/customer notifications on changes' => 'Send en agent/kunde varsling ved endringer',
        'CMD' => 'Kommando',
        ...
        'Notifications are sent to an agent or a customer.' => 'Varslinger som sendes til agenter eller kunder.',
        ...
        'Recipient agents' => 'Mottakere - agenter',
        ...
        'To get the first 20 character of the subject (of the latest agent article).' => 'For å få de første 20 tegn av emnefeltet (fra den siste agentsaken).',
        'To get the first 5 lines of the body (of the latest agent article).' => 'For å få de første 5 linjene av meldingen (fra den siste agentsaken).',
        ...
        'To dispatch or filter incoming emails based on email headers. Matching using Regular Expressions is also possible.' => 'For å behandle eller filtrere innkommende epost basert på epost-headers. "Regular Expressions" kan også brukes.',
        ...
        'If you use Regular Expressions, you also can use the matched value in () as [***] in the \'Set\' action.' => 'Hvis du bruker "Regular Expressions" kan du også bruke verdien i () som [***] i "Sett"-verdier.',
        ...
        'If an agent locks a ticket and does not close it before the unlock timeout has passed, the ticket will unlock and will become available for other agents.' => 'Hvis en agent låser en sak og ikke stenger den før låsetiden har passert vil saken bli låst opp og komme tilgjengelig for andre agenter.',
        ...
        'If there is an article added, such as a follow-up via email or the customer portal, the escalation update time is reset. If there is no customer contact, either email-external or phone, added to a ticket before the time defined here expires, the ticket is escalated.' => 'Hvis det kommer inn et objekt, f.eks. en oppfølging på epost eller fra kundeportalen, vil eskaleringstiden bli nullstilt. Hvis ingen kundekontakt blir lagt til, enten som utgående epost eller utgående telefon, innen tiden som er spesifisert her, vil saken bli eskalert.',
        ...
        'Add role' => 'Ny rolle',
        'Create a role and put groups in it. Then add the role to the users.' => 'Opprett en rolle og legg grupper til rollen. Legg deretter til agenter til rollen.',
        ...
        'Manage Agent-Role Relations' => 'Koplinger mellom Agenter og Roller',
        'Filter for Agents' => 'Filter for Agenter',
        'Agents' => 'Agenter',
        'Manage Role-Agent Relations' => 'Koplinger mellom Rolle og Agent',
        'Change Role Relations for Agent' => 'Endre agentens kopling til roller',
        'Change Agent Relations for Role' => 'Endre rollens kopling til agenter',
        ...
        'The syntax of your SQL query has a mistake. Please check it.' => 'SQL-spørringen har en syntaksfeil. Vennligst sjekk den.',
        'There is at least one parameter missing for the binding. Please check it.' => 'Det mangler minst ett parameter i bindingen. Vennligst sjekk den.',
        ...
        'System Email Addresses Management' => 'Administrasjon av Systemets epostadresser',
        ...
        # Template: AdminUser
        'Add agent' => 'Ny agent',
        'Agents will be needed to handle tickets.' => 'Agenter trengs for å behandle saker',
        'Don\'t forget to add a new agent to groups and/or roles!' => 'Ikke glem å legge agenter i grupper og/eller roller',
        'Please enter a search term to look for agents.' => 'Skriv et søk for å finne agenter',
        'Last login' => 'Siste innlogging',
        'Login as' => 'Logg inn som',
        'Switch to agent' => 'Bytt til agent',
        'Add Agent' => 'Ny Agent',
        'Edit Agent' => 'Endre Agent',
        'Firstname' => 'Fornavn',
        'Lastname' => 'Etternavn',
        'Start' => 'Start',
        'End' => 'Slutt',
        ...
        'Manage Agent-Group Relations' => 'Koplinger mellom Agent og Gruppe',
        'Change Group Relations for Agent' => 'Endre gruppekoplinger for agent',
        'Change Agent Relations for Group' => 'Endre agentkoplinger for gruppe',
        'note' => 'notis',
        ...
        'Permissions' => 'Tilgang',
        'You can select one or more groups to define access for different agents.' => 'Du kan velge en eller flere grupper for å gi tilgang for forskjellige agenter',
        'Some result formats are disabled because at least one needed package is not installed.' => 'Noen resultatformater er deaktivert fordi minst en påkrevd pakke ikke er installert.',
        ...
        'If you don\'t select any attribute all attributes of the element will be used if you generate a stat, as well as new attributes which were added since the last configuration.' => 'Hvis du ikke velger noen attributter vil alle attributter vises hvis du lager en statistikk, i tillegg til nye attributter som har blitt lagt til siden sist.',
        'Scale' => 'Skala',
        'minimal' => 'minimal',
        ...
        'Here you can define the x-axis. You can select one element via the radio button.' => 'Her kan du definere x-aksen. Velg ett element med trykk-knappene.',
        ...
        'With the input and select fields you can influence the format and contents of the statistic.' => 'Du kan påvirke format og innhold i statistikken gjennom valgfeltene',
        'Exactly what fields and formats you can influence is defined by the statistic administrator.' => 'Nøyaktig hvilke felter du kan bruke er definert av statistikk-administratoren',
        ...
        'Could not open popup window. Please disable any popup blockers for this application.' => 'Kunne ikke åpne sprettoppvindu. Vennligst slå av eventuelle blokkefunksjoner i webleseren for dette webstedet.',
        ...
        'A popup of this screen is already open. Do you want to close it and load this one instead?' => 'En sprettoppvindu med denne skjermen er allerede åpen. Vil du stenge vinduet og laste det inn her i stedet?',
        ...
        'Error in the mail settings. Please correct and try again.' => 'Feil i epost-oppsettet. Korriger og prøv igjen.',
        ...
        'If you want to install OTRS on another database type, please refer to the file README.database.' => 'Hvis du vil installere OTRS på en annen databasetype, vennligst se filen README.database',
        ...
        'Email addresses that are manually entered are checked against the MX records found in DNS. Don\'t use this option if your DNS is slow or does not resolve public addresses.' => 'Epost-adresser som angis manuelt, sjekkes mot MX-oppføringer i DNS. Ikke bruk dette valget dersom din DNS er treg eller ikke gjør oppslag for offentlige addresser.',
        ...
        'Activates lost password feature for agents, in the agent interface.' => 'Slår på glemt-passord-funksjonalitet for agenter.',
        ...
        'Adds a suffix with the actual year and month to the OTRS log file. A logfile for every month will be created.' => 'Legger til år og måned på loggfilens navn. Dette gjør at man får én loggfil per måned.',
        'Adds customers email addresses to recipients in the ticket compose screen of the agent interface.' => 'Legger til kunders epostadresser som mottakere under Opprett Sak for agenter.',
        ...
        'Agent Notifications' => 'Agent-varslinger',
        'Agent interface article notification module to check PGP.' => 'Varslingsmodul for å sjekke PGP.',
        'Agent interface article notification module to check S/MIME.' => 'Varslingsmodul for å sjekke S/MIME.',
        'Agent interface module to access fulltext search via nav bar.' => 'Agentmodul som gir tilgang til fulltekstsøk via navigasjonsområdet.',
        'Agent interface module to access search profiles via nav bar.' => 'Agentmodul som gir tilgang til søkeprofiler via navigasjonsområdet.',
        'Agent interface module to check incoming emails in the Ticket-Zoom-View if the S/MIME-key is available and true.' => 'Agentmodul som sjekker innkommende epost i Zoom-visning dersom S/MIME-nøkkelen er tilgjengelig og korrekt.',
        'Agent interface notification module to check the used charset.' => 'Agentmodul som sjekker tegnsettet som er brukt.',
        'Agent interface notification module to see the number of tickets an agent is responsible for.' => 'Agentmodul som viser antall saker en agent er ansvarlig for',
        'Agent interface notification module to see the number of watched tickets.' => 'Agentmodul som viser antall overvåkede saker.',
        ...
        'Allows agents to exchange the axis of a stat if they generate one.' => 'Tillater agenter å bytte akse for statistikk de selv oppretter',
        'Allows agents to generate individual-related stats.' => 'Lar agenter opprette statistikk relatert til individer.',
        ...
        'Allows choosing the next compose state for customer tickets in the customer interface.' => 'Tillater å velge status ved opprettelse av kundesaker i kundeportalen.',
        'Allows customers to change the ticket priority in the customer interface.' => 'Lar kunder endre sakens prioritet i kundeportalen.',
        'Allows customers to set the ticket SLA in the customer interface.' => 'Lar kunder sette sakens SLA i kundeportalen.',
        'Allows customers to set the ticket priority in the customer interface.' => 'Lar kunder sette sakens prioritet i kundeportalen.',
        ...
        'Article free text options shown in the ticket message screen of the customer interface. Possible settings: 0 = Disabled, 1 = Enabled, 2 = Enabled and required. NOTE. If you want to display these fields also in the ticket zoom of the customer interface, you have to enable them in CustomerTicketZoom###AttributesView.' => 'Fritekstvalg for artikler vist i saksmeldingsskjermen i kundeportalen. Mulige innstillinger: 0 = Av, 1 = På, 2 = På og obligatorisk. MERK: Om du også vil vise disse i saksvisningen må du slå dette på i CustomerTicketZoom###AttributesView.',
        ...
        'Automatically lock and set owner to current Agent after selecting for an Bulk Action.' => 'Automatisk lås og sett eier til nåværende agent etter å ha blitt valgt i en masseredigeringshandling',
        ...
        'Changes the owner of tickets to everyone (useful for ASP). Normally only agent with rw permissions in the queue of the ticket will be shown.' => 'Endrer eier på saker til "alle" (brukbart for ASP). Normalt vil kun agenter med Les/skriv-tilgang til køen bli vist.',
        ...
        'Controls if customers have the ability to sort their tickets.' => 'Gir kunder mulighet til å sortere sakene sine.',
        ...
        'Create and manage agents.' => 'Administrasjon av agenter.',
        ...
        'Create and manage notifications that are sent to agents.' => 'Administrasjon av varslinger som sendes ut til agenter.',
        ...
        'Default queue ID used by the system in the agent interface.' => 'Standard køID brukt av systemet for agenter.',
        ...
        'Default ticket ID used by the system in the agent interface.' => 'Standard Saksnr brukt av systemet i agent-delen',
        'Default ticket ID used by the system in the customer interface.' => 'Standard Saksnr brukt av systemet i kundeportalen.',
        ...
        'Defines a regular expression that excludes some addresses from the syntax check (if "CheckEmailAddresses" is set to "Yes"). Please enter a regex in this field for email addresses, that aren\'t syntactically valid, but are necessary for the system (i.e. "root@localhost").' => 'Definerer en RegEx-setning som ekskluderer adresser fra syntakssjekken (hvis "sjekk epostadresser" er satt til Ja). Skriv inn en RegEx-setning for epostadresser som ikke er syntaktisk korrekte, men som er viktige for systemet (f.eks. "root@localhost").',
        'Defines a regular expression that filters all email addresses that should not be used in the application.' => 'Definerer en RegEx-setning som filtrerer ut alle epostadresser som ikke skal brukes i systemet.',
        ...
        'Defines all the parameters for the RefreshTime object in the customer preferences of the customer interface.' => 'Definerer alle parametre for gjenoppfriskning i kundeportalen.',
        'Defines all the parameters for the ShownTickets object in the customer preferences of the customer interface.' => 'Definerer alle parametre for viste saker i kundeportalen.',
        ...
        'Defines if time accounting is mandatory in the agent interface.' => 'Spesifiserer om tidskontering er obligatorisk for agenter.',
        ...
        'Defines the address of a dedicated DNS server, if necessary, for the "CheckMXRecord" look-ups.' => 'Definerer en dedikert DNS-tjener å bruke, hvis nødvendig, for å gjøre MX-sjekk på epostadresser.',
        'Defines the body text for notification mails sent to agents, about new password (after using this link the new password will be sent).' => 'Definerer meldingsteksten for nytt-passord-meldingen til agenter. Etter å ha brukt lenken vil det nye passordet bli sendt.',
        'Defines the body text for notification mails sent to agents, with token about new requested password (after using this link the new password will be sent).' => 'Definerer meldingsteksten for nytt-passord-meldingen til agenter. Etter å ha brukt lenken vil det nye passordet bli sendt.',
        ...
        'Defines the default body of a note in the ticket free text screen of the agent interface.' => 'Spesifiserer standardinnholdet for notiser i sakens fritekstdel for agenter.',
        'Defines the default front-end (HTML) theme to be used by the agents and customers. The default themes are Standard and Lite. If you like, you can add your own theme. Please refer the administrator manual located at http://doc.otrs.org/.' => 'Definerer standard webtema som skal brukes av agenter og kunder. De innebygde er Standard og Lite. Du kan legge til egne tema selv. Se i tilfelle manualen, på http://doc.otrs.org/',
        ...
        'Defines the default next state for a ticket after customer follow up in the customer interface.' => 'Setter standardverdi for neste status etter oppfølging fra kunde i kundeportalen.',
        'Defines the default next state of a ticket after adding a note, in the close ticket screen of the agent interface.' => 'Setter standardverdi for neste status etter å ha lagt til en notis når man stenger en sak i agentdelen.',
        'Defines the default next state of a ticket after adding a note, in the ticket bulk screen of the agent interface.' => 'Setter standardverdi for neste status etter å ha lagt til en notis i masseredigering i agentdelen.',
        'Defines the default next state of a ticket after adding a note, in the ticket free text screen of the agent interface.' => 'Setter standardverdi for neste status etter å ha lagt til en notis i sakens fritekstside i agentdelen.',
        'Defines the default next state of a ticket after adding a note, in the ticket note screen of the agent interface.' => 'Setter standardverdi for neste status når agent legger til en notis under interne notater.',
        'Defines the default next state of a ticket after adding a note, in the ticket owner screen of a zoomed ticket in the agent interface.' => 'Definerer standard for neste saksstatus når agent legger til en notis i eier-delen',
        'Defines the default next state of a ticket after adding a note, in the ticket pending screen of a zoomed ticket in the agent interface.' => 'Definerer standard for neste status for en sak etter å ha lagt til en notis i avventingsdelen av agents saksvisning',
        'Defines the default next state of a ticket after adding a note, in the ticket priority screen of a zoomed ticket in the agent interface.' => 'Definerer standard for neste saksstatus etter at agent har lagt til en notis og endret prioritet på en sak',
        'Defines the default next state of a ticket after adding a note, in the ticket responsible screen of the agent interface.' => 'Definerer standard for neste saksstatus etter at agent har lagt til en notis under saksansvar',
        'Defines the default next state of a ticket after being bounced, in the ticket bounce screen of the agent interface.' => 'Definerer standard for neste saksstatus etter at agent har lagt til en notis for en sak som blir avvist',
        'Defines the default next state of a ticket after being forwarded, in the ticket forward screen of the agent interface.' => 'Definerer standard for neste saksstatus når agent videresender en sak',
        'Defines the default next state of a ticket if it is composed / answered in the ticket compose screen of the agent interface.' => 'Setter standard for neste saksstatus når den blir opprettet/besvart av agent',
        'Defines the default note body text for phone tickets in the ticket phone outbound screen of the agent interface.' => 'Definerer standard notistekst for utgående telefon-saker i agentdelen',
        'Defines the default priority of follow up customer tickets in the ticket zoom screen in the customer interface.' => 'Setter standard prioritet på saksoppfølginger i kundeportalen',
        'Defines the default priority of new customer tickets in the customer interface.' => 'Setter standard prioritet på nye saker opprettet i kundeportalen',
        'Defines the default priority of new tickets.' => 'Setter standard prioritet på nye saker',
        'Defines the default queue for new customer tickets in the customer interface.' => 'Setter standardkø for nye saker opprettet i kundeportalen.',
        'Defines the default selection at the drop down menu for dynamic objects (Form: Common Specification).' => 'Definerer standard forvalg i menyen for dynamiske objekter (Form: Common Specification)',
        'Defines the default selection at the drop down menu for permissions (Form: Common Specification).' => 'Definerer standard forvalg i menyen for tilgangsrettigheter (Form: Common Specification)',
        'Defines the default selection at the drop down menu for stats format (Form: Common Specification). Please insert the format key (see Stats::Format).' => 'Definerer standard forvalg i menyen for statistikkformat (Form: Common Specification). Vennligst skriv inn formatnøkkelen (se Stats::Format)',
        'Defines the default selection of the free key field number 1 for articles (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 1 for innlegg (hvis mer enn et valg er angitt).',
        'Defines the default selection of the free key field number 1 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 1 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 10 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 10 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 11 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 11 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 12 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 12 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 13 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 13 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 14 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 14 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 15 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 15 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 16 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 16 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 2 for articles (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 2 for innlegg (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 2 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 2 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 3 for articles (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 3 for innlegg (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 3 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 3 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 4 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 4 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 5 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 5 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 6 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 6 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 7 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 7 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 8 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 8 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free key field number 9 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt nøkkelfelt 9 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 1 for articles (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 1 for innlegg (hvis mer enn et valg er angitt).',
        'Defines the default selection of the free text field number 1 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 1 for saker (hvis mer enn et valg er angitt).',
        'Defines the default selection of the free text field number 10 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 10 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 11 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 11 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 12 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 12 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 13 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 13 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 14 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 14 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 15 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 15 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 16 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 16 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 2 for articles (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 2 for innlegg (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 2 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 2 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 3 for articles (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 3 for innlegg (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 3 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 3 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 4 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 4 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 5 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 5 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 6 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 6 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 7 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 7 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 8 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 8 for saker (hvis mer enn et valg er angitt)',
        'Defines the default selection of the free text field number 9 for tickets (if more than one option is provided).' => 'Definerer standard forvalg i fritt tekstfelt 9 for saker (hvis mer enn et valg er angitt)',
        'Defines the default sender type for phone tickets in the ticket phone outbound screen of the agent interface.' => 'Setter standard sendertype for utgående telefonsaker i agentdelen',
        'Defines the default sender type for tickets in the ticket zoom screen of the customer interface.' => 'Setter standard sendertype for saker i saksvisningen i kundeportalen',
        'Defines the default shown ticket search attribute for ticket search screen.' => '',
        'Defines the default sort criteria for all queues displayed in the queue view, after sort by priority is done.' => 'Definerer standard sorteringskriterier for alle køer vist i køvisning, etter at de har blitt sortert etter prioritet.',
        'Defines the default sort order for all queues in the queue view, after priority sort.' => 'Definerer standard sorteringsrekkefølge for alle køer i køvisningen, etter at de er blitt sortert etter prioritet.',
        'Defines the default spell checker dictionary.' => 'Definerer standard ordliste for stavekontroll.',
        'Defines the default state of new customer tickets in the customer interface.' => 'Definerer standard status for nye kundesaker opprettet i kundeportalen.',
        'Defines the default state of new tickets.' => 'Definerer standard status for nye saker',
        'Defines the default subject for phone tickets in the ticket phone outbound screen of the agent interface.' => 'Definerer standardverdi for emnefeltet i skjermbildet for utgående telefonsak i agentbildet.',
        ...
        'Defines the default ticket order (after priority sort) in the escalation view of the agent interface. Up: oldest on top. Down: latest on top.' => 'Definerer standard saksrekkefølge (etter de er sortert etter prioritet) i eskaleringsvisningen. Opp: eldste først. Ned: nyeste først.',
        'Defines the default ticket order (after priority sort) in the status view of the agent interface. Up: oldest on top. Down: latest on top.' => 'Definerer standard saksrekkefølge (etter de er sortert etter prioritet) i statusvisningen. Opp: eldste først. Ned: nyeste først',
        'Defines the default ticket order in the responsible view of the agent interface. Up: oldest on top. Down: latest on top.' => '',
        'Defines the default ticket order in the ticket locked view of the agent interface. Up: oldest on top. Down: latest on top.' => '',
        'Defines the default ticket order in the ticket search result of the agent interface. Up: oldest on top. Down: latest on top.' => 'Definerer standard saksrekkefølge for søkeresultater i agentbildet. Opp: eldste først. Ned: nyeste først.',
        'Defines the default ticket order in the watch view of the agent interface. Up: oldest on top. Down: latest on top.' => '',
        'Defines the default ticket order of a search result in the customer interface. Up: oldest on top. Down: latest on top.' => 'Definerer standard saksrekkefølge i et søkeresultat i kundebildet. Opp: eldste først. Ned: nyeste først.',
        'Defines the default ticket priority in the close ticket screen of the agent interface.' => 'Definerer standard saksprioritet i "avslutt sak"-skjermen i agentbildet.',
        ...
        'Defines the default type for article in the customer interface.' => 'Definerer standard type for innlegg i kundebildet.',
        'Defines the default type of forwarded message in the ticket forward screen of the agent interface.' => '',
        'Defines the default type of the note in the close ticket screen of the agent interface.' => 'Definerer standard type notis i "Avslutt sak" bildet.',
        'Defines the default type of the note in the ticket bulk screen of the agent interface.' => '',
        'Defines the default type of the note in the ticket free text screen of the agent interface.' => '',
        'Defines the default type of the note in the ticket note screen of the agent interface.' => 'Definerer standard type notis i "Legg til notis" bildet.',
        ...
        'Defines the hours and week days of the calendar number 1, to count the working time.' => 'Definerer timer og ukedager i kalender 1, som telles som arbeidstid.',
        'Defines the hours and week days of the calendar number 2, to count the working time.' => 'Definerer timer og ukedager i kalender 2, som telles som arbeidstid.',
        'Defines the hours and week days of the calendar number 3, to count the working time.' => 'Definerer timer og ukedager i kalender 3, som telles som arbeidstid.',
        'Defines the hours and week days of the calendar number 4, to count the working time.' => 'Definerer timer og ukedager i kalender 4, som telles som arbeidstid.',
        'Defines the hours and week days of the calendar number 5, to count the working time.' => 'Definerer timer og ukedager i kalender 5, som telles som arbeidstid.',
        'Defines the hours and week days of the calendar number 6, to count the working time.' => 'Definerer timer og ukedager i kalender 6, som telles som arbeidstid.',
        'Defines the hours and week days of the calendar number 7, to count the working time.' => 'Definerer timer og ukedager i kalender 7, som telles som arbeidstid.',
        'Defines the hours and week days of the calendar number 8, to count the working time.' => 'Definerer timer og ukedager i kalender 8, som telles som arbeidstid.',
        'Defines the hours and week days of the calendar number 9, to count the working time.' => 'Definerer timer og ukedager i kalender 9, som telles som arbeidstid.',
        'Defines the hours and week days to count the working time.' => 'Definerer timer og ukedager som telles som arbeidstid.',
        'Defines the http link for the free text field number 1 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 1 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 10 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 10 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 11 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 11 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 12 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 12 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 13 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 13 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 14 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 14 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 15 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 15 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 16 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 16 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 2 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 2 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 3 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 3 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 4 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 4 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 5 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 5 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 6 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 6 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 7 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 7 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 8 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 8 for saker (vil bli brukt i alle saksvisninger).',
        'Defines the http link for the free text field number 9 for tickets (it will be used in every ticket view).' => 'Definerer http-lenken for fritt tekstfelt 9 for saker (vil bli brukt i alle saksvisninger).',
        ...
        'Defines the name of the application, shown in the web interface, tabs and title bar of the web browser.' => 'Definerer navnet på applikasjonen, som vises i webgrensesnittet, faner, og tittellinjen på nettleseren.',
        ...
        'Defines the name of the table, where the customer preferences are stored.' => 'Definerer navnet på tabellen der kundens innstillinger lagres.',
        ...
        'Defines the placement of the legend. This should be a two letter key of the form: \'B[LCR]|R[TCB]\'. The first letter indicates the placement (Bottom or Right), and the second letter the alignment (Left, Right, Center, Top, or Bottom).' => 'Definerer plassering av symbolforklaringen. Dette skal være en nøkkel på to bokstaver på formen: \'B[LCR]|R[TCB]\'. Den første bokstaven angir plassering (B=Bunn, R=Høyre), og den andre bokstaven angir justering (L=Venstre,R=Høyre,T=Topp,C=Sentrert,B=Bunn).',
        ...
        'Defines the state of a ticket if it gets a follow-up and the ticket was already closed.' => 'Definerer status på en sak hvis den får en oppfølging og saken allerede var avsluttet.',
        ...
        'Defines the time zone of the calendar number 1, which can be assigned later to a specific queue.' => 'Definerer tidssonen for kalender 1, som senere kan tilordnes en spesifikk kø.',
        'Defines the time zone of the calendar number 2, which can be assigned later to a specific queue.' => 'Definerer tidssonen for kalender 2, som senere kan tilordnes en spesifikk kø.',
        'Defines the time zone of the calendar number 3, which can be assigned later to a specific queue.' => 'Definerer tidssonen for kalender 3, som senere kan tilordnes en spesifikk kø.',
        'Defines the time zone of the calendar number 4, which can be assigned later to a specific queue.' => 'Definerer tidssonen for kalender 4, som senere kan tilordnes en spesifikk kø.',
        'Defines the time zone of the calendar number 5, which can be assigned later to a specific queue.' => 'Definerer tidssonen for kalender 5, som senere kan tilordnes en spesifikk kø.',
        'Defines the time zone of the calendar number 6, which can be assigned later to a specific queue.' => 'Definerer tidssonen for kalender 6, som senere kan tilordnes en spesifikk kø.',
        'Defines the time zone of the calendar number 7, which can be assigned later to a specific queue.' => 'Definerer tidssonen for kalender 7, som senere kan tilordnes en spesifikk kø.',
        'Defines the time zone of the calendar number 8, which can be assigned later to a specific queue.' => 'Definerer tidssonen for kalender 8, som senere kan tilordnes en spesifikk kø.',
        'Defines the time zone of the calendar number 9, which can be assigned later to a specific queue.' => 'Definerer tidssonen for kalender 9, som senere kan tilordnes en spesifikk kø.',
        ...
        'Enables PDF output. The CPAN module PDF::API2 is required, if not installed, PDF output will be disabled.' => 'Aktiverer utskrift til PDF. CPAN-modulen PDF::API2 er påkrevd, dersom denne ikke er installert vil PDF-utskrift deaktiveres.',
        ...
        'GenericAgent' => 'Administrasjon: Generisk Agent',
        ...
        'If any of the "SMTP" mechanisms was selected as SendmailModule, and authentication to the mail server is needed, a password must be specified.' => 'Hvis noen av "SMTP"-mekanismene er valgt som SendmailModule, og autentisering mot epost-tjeneren er nødvendig, må et passord spesifiseres.',
        'If any of the "SMTP" mechanisms was selected as SendmailModule, and authentication to the mail server is needed, an username must be specified.' => 'Hvis noen av "SMTP"-mekanismene er valgt som SendmailModule, og autentisering mot epost-tjeneren er nødvendig, må et brukernavn spesifiseres',
        'If any of the "SMTP" mechanisms was selected as SendmailModule, the mailhost that sends out the mails must be specified.' => 'Hvis noen av "SMTP"-mekanismene er valgt som SendmailModule, må epost-tjeneren som sender ut epost spesifiseres.',
        'If any of the "SMTP" mechanisms was selected as SendmailModule, the port where your mailserver is listening for incoming connections must be specified.' => 'Hvis noen av "SMTP"-mekanismene er valgt som SendmailModule, må porten der din epost-tjener lytter på innkommende forbindelser spesifiseres. ',
        ...
        'If enabled, OTRS will deliver all JavaScript files in minified form.' => 'Hvis slått på vil OTRS levere alle JavaScript-filer i minimert form',
        ...
        'If enabled, the OTRS version tag will be removed from the HTTP headers.' => 'Hvis slått på vil OTRS-versjonen bli fjernet fra HTTP-headeren',
        ...
        'Includes article create times in the ticket search of the agent interface.' => 'Inkludér opprettelsestidspunkt i søkedelen av agentdelen.',
        ...
        'Link agents to groups.' => 'Koble agenter til grupper',
        'Link agents to roles.' => 'Koble agenter til roller',
        ...
        'List of CSS files to always be loaded for the agent interface.' => 'Liste med CSS-filer som alltid skal lastes for agentdelen',
        'List of CSS files to always be loaded for the customer interface.' => 'Liste med CSS-filer som alltid skal lastes for kundeportalen',
        'List of IE6-specific CSS files to always be loaded for the customer interface.' => 'Liste med IE6-spesifikke CSS-filer som alltid skal lastes for kundeportalen',
        'List of IE7-specific CSS files to always be loaded for the agent interface.' => 'Liste med IE7-spesifikke CSS-filer som alltid skal lastes for agentdelen',
        'List of IE7-specific CSS files to always be loaded for the customer interface.' => 'Liste med IE7-spesifikke CSS-filer som alltid skal lastes for kundeportalen',
        'List of IE8-specific CSS files to always be loaded for the agent interface.' => 'Liste med IE8-CSS-filer som alltid skal lastes for agentdelen',
        'List of IE8-specific CSS files to always be loaded for the customer interface.' => 'Liste med IE8-spesifikke CSS-filer som alltid skal lastes for kundeportalen',
        'List of JS files to always be loaded for the agent interface.' => 'Liste over JS-filer som alltid skal lastes for agentdelen',
        'List of JS files to always be loaded for the customer interface.' => 'Liste over JS-filer som alltid skal lastes for kundeportalen',
        'Log file for the ticket counter.' => 'Loggfil for sakstelleren',
        'Makes the application check the MX record of email addresses before sending an email or submitting a telephone or email ticket.' => 'Gjør at systemet sjekker MX-oppføringen for epost-adressen før det sender en epost eller oppretter en telefonsak eller epostsak.',
        ...
        'Maximum number of tickets to be displayed in the result of a search in the agent interface.' => 'Maks. antall viste saker i søkeresultater (agentdelen)',
        'Maximum number of tickets to be displayed in the result of a search in the customer interface.' => 'Maks. antall viste saker i søkeresultater (kundeportalen)',
        ...
        'Module for To-selection in new ticket screen in the customer interface.' => 'Modul for valg av mottaker når man oppretter ny sak i kundeportalen.',
        ...
        'Module to inform agents, via the agent interface, about the used charset. A notification is displayed, if the default charset is not used, e.g. in tickets.' => 'Modul for å informere agenter, via agentsiden, om tegnsette som er i bruk. En varsling vises dersom et annet tegnsett enn standard benyttes, f.eks. i saker.',
        ...
        'Number of lines (per ticket) that are shown by the search utility in the agent interface.' => 'Antall linjer (per sak) som vises i søkeverktøyet.',
        'Number of tickets to be displayed in each page of a search result in the agent interface.' => 'Antall saker som vises per side i et søkeresultat.',
        'Number of tickets to be displayed in each page of a search result in the customer interface.' => 'Antall saker som vises per side i et søkeresultat i kundeportalen.',
        ...
        'Required permissions to change the customer of a ticket in the agent interface.' => 'Nødvendige rettigheter for å endre kunde på en sak.',
        'Required permissions to use the close ticket screen in the agent interface.' => 'Nødvendige rettigheter for å bruke "Avslutt sak" bildet.',
        'Required permissions to use the ticket bounce screen in the agent interface.' => '',
        'Required permissions to use the ticket compose screen in the agent interface.' => 'Nødvendige rettigheter for å bruke "Opprett sak" bildet.',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of the ticket or the ticket is unlocked and is in one of my subscribed queues.' => 'Send varsling hvis kunden sender en oppfølging og jeg eier saken, eller om saken er åpen og i en av mine abonnerte køer.',
        ...
        'Sends agent follow-up notification only to the owner, if a ticket is unlocked (the default is to send the notification to all agents).' => 'Send varsling kun til sakens eier dersom en sak låses opp (normalt sendes meldingen til alle agenter).',
        ...
        'Sends the notifications which are configured in the admin interface under "Notfication (Event)".' => 'Sender varslingene som er spesifiserte i admin-delen under "Melding (Hendelse)"',
        ...
        'Sets if ticket owner must be selected by the agent.' => 'Angir om sakseier må velges av agenten.',
        ...
        'Shows all open tickets (even if they are locked) in the escalation view of the agent interface.' => 'Viser alle åpne saker (også låste) i eskaleringsvinduet i agentdelen',
        'Shows all open tickets (even if they are locked) in the status view of the agent interface.' => 'Viser alle åpne saker (også låste) i statusvinduet i agentdelen',
        'Shows all the articles of the ticket (expanded) in the zoom view.' => 'Viser alle innlegg i saken (utvidet) i zoom-visning',
        'Shows all the customer identifiers in a multi-select field (not useful if you have a lot of customer identifiers).' => 'Viser alle kunde-identifikatorer i et multivalg-felt (ikke brukbart hvis du har mange identifikatorer)',
        'Shows an owner selection in phone and email tickets in the agent interface.' => 'Viser et eier-valg i telefon- og epost-saker i agentdelen',
        'Shows customer history tickets in AgentTicketPhone, AgentTicketEmail and AgentTicketCustomer.' => 'Viser kundehistorikk i agentdelen.',
        'Shows either the last customer article\'s subject or the ticket title in the small format overview.' => 'Viser enten emnet til siste kundeartikkel eller sakens emne i "liten" oversikt.',
        'Shows existing parent/child queue lists in the system in the form of a tree or a list.' => 'Viser eksisterende foredldre/barn kølister i systemet i form av et tre eller en liste',
        'Shows the activated ticket attributes in the customer interface (0 = Disabled and 1 = Enabled).' => 'Viser de aktiverte saksattributtene i kundeportalen (0 = Av og 1 = På)',
        'Shows the articles sorted normally or in reverse, under ticket zoom in the agent interface.' => 'Viser artiklene sortert normalt eller reversert i saksvisning i agentdelen.',
        'Shows the customer user information (phone and email) in the compose screen.' => 'Viser kundens brukerinformasjon (telefon og epost) når man komponerer en sak',
        'Shows the customer user\'s info in the ticket zoom view.' => 'Viser kundebrukerens info i saksvisningen.',
        'Shows the message of the day (MOTD) in the agent dashboard. "Group" is used to restrict access to the plugin (e. g. Group: admin;group1;group2;). "Default" indicates if the plugin is enabled by default or if the user needs to enable it manually.' => 'Viser Dagens Melding (MOTD) i agent-kontrollpanelet. "Gruppe" brukes til å begrense tilgang til innstikket (f.eks. Gruppe: admin;gruppe1;gruppe2). "Standard" betyr at innstikket er slått på som standard, hvis ikke må agenten selv slå det på under Innstillinger',
        'Shows the message of the day on login screen of the agent interface.' => 'Viser Dagens Melding på innloggingsskjermen til agentdelen',
        'Shows the ticket history (reverse ordered) in the agent interface.' => 'Viser sakshistorikken (nyeste først) i agentdelen.',
        'Shows the ticket priority options in the close ticket screen of the agent interface.' => 'Viser sakens prioritetsvalg i agentdelens skjerm for å avslutte saker',
        'Shows the ticket priority options in the move ticket screen of the agent interface.' => 'Viser sakens prioritetsvalg i agentdelens skjerm for å flytte saker',
        'Shows the ticket priority options in the ticket bulk screen of the agent interface.' => 'Viser sakens prioritetsvalg i agentdelens skjerm for å masseredigere saker.',
        'Shows the ticket priority options in the ticket free text screen of the agent interface.' => 'Viser sakens prioritetsvalg i agentdelens skjerm for fritekst.',
        'Shows the ticket priority options in the ticket note screen of the agent interface.' => 'Viser sakens prioritetsvalg i agentdelens skjerm for notiser',
        'Shows the ticket priority options in the ticket owner screen of a zoomed ticket in the agent interface.' => 'Viser sakens prioritetsvalg i agentdelens sakseier-skjerm i saksvisning',
        ...
        'Spam Assassin example setup. Ignores emails that are marked with SpamAssassin.' => 'Eksempeloppsett for SpamAssassin. Ignorerer eposter som er merket av SpamAssassin.',
        'Spam Assassin example setup. Moves marked mails to spam queue.' => 'Eksempeloppsett for SpamAssassin. Flytter merkede eposter til køen for søppelpost.',
        'Specifies if an agent should receive email notification of his own actions.' => 'Angir om en agent skal motta epostvarsling om sine egne handlinger.',
        ...
        'Specifies the different article types that will be used in the system.' => 'Spesifiserer de ulike artikkeltypene som skal brukes i systemet.',
        'Specifies the different note types that will be used in the system.' => 'Spesifiserer de forskjellige notis-typene som skal brukes i systemet.',
        'Specifies the directory to store the data in, if "FS" was selected for TicketStorageModule.' => 'Spesifiserer mappen der data skal lagres dersom "FS" er valgt for lagring av saker.',
        'Specifies the directory where SSL certificates are stored.' => 'Spesifiserer mappen der SSL-sertifikatene lagres',
        'Specifies the directory where private SSL certificates are stored.' => 'Spesifiserer mappen der private SSL-sertifikater lagres.',
        'Specifies the email address that should be used by the application when sending notifications. The email address is used to build the complete display name for the notification master (i.e. "OTRS Notification Master" otrs@your.example.com). You can use the OTRS_CONFIG_FQDN variable as set in your configuation, or choose another email address. Notifications are messages such as en::Customer::QueueUpdate or en::Agent::Move.' => 'Spesifiserer epostadressen som skal brukes av systemet når det sender varslinger. Epostadressen brukes til å bygge opp det komplette visningsnavnet for varslingsautomaten (dvs. "OTRS Varslingsautomat" otrs@din.server.no). Du kan bruke variabelen OTRS_CONFIG_FQDN satt i oppsettet, eller velge en annen epostadresse. Varslinger er slike som nb_NO::Customer::QueueUpdate eller nb_NO::Agent::Move.',
        'Specifies the left margin of the chart.' => 'Spesifiserer venstre marg for grafer.',
        'Specifies the name that should be used by the application when sending notifications. The sender name is used to build the complete display name for the notification master (i.e. "OTRS Notification Master" otrs@your.example.com). Notifications are messages such as en::Customer::QueueUpdate or en::Agent::Move.' => 'Spesifiserer navnet som skal brukes av systemet når det sender varslinger. Navnet brukes til å bygge opp det komplette visningsnavnet for varslingsautomaten (dvs. "OTRS Meldingsautomat" otrs@din.server.no). Du kan bruke variabelen OTRS_CONFIG_FQDN satt i oppsettet, eller velge en annen epostadresse. Varslinger er slike som nb_NO::Customer::QueueUpdate eller nb_NO::Agent::Move.',
        'Specifies the path of the file for the logo in the page header (gif|jpg|png, 700 x 100 pixel).' => 'Spesifiserer stien til logofilen i toppen av siden (gif|jpg|png, 700x100 piksler).',
        'Specifies the path of the file for the performance log.' => 'Spesifiserer stien til ytelseslogg-filen.',
        'Specifies the path to the converter that allows the view of Microsoft Excel files, in the web interface.' => 'Spesifiserer stien til konverteringsprogrammet som tillater visning av Microsoft Excel-filer i webvisningen',
        'Specifies the path to the converter that allows the view of Microsoft Word files, in the web interface.' => 'Spesifiserer stien til konverteringsprogrammet som tillater visning av Microsoft Word-filer i webvisningen',
        'Specifies the path to the converter that allows the view of PDF documents, in the web interface.' => 'Spesifiserer stien til konverteringsprogrammet som tillater visning av PDF-filer i webvisningen',
        'Specifies the path to the converter that allows the view of XML files, in the web interface.' => 'Spesifiserer stien til konverteringsprogrammet som tillater visning av XML-filer',
        ...
        'Specifies the text that should appear in the log file to denote a CGI script entry.' => 'Spesifiserer teksten som skal skrives til loggfilen for å markere et innslag fra et CGI-script.',
        ...
        'Standard available permissions for agents within the application. If more permissions are needed, they can be entered here. Permissions must be defined to be effective. Some other good permissions have also been provided built-in: note, close, pending, customer, freetext, move, compose, responsible, forward, and bounce. Make sure that "rw" is always the last registered permission.' => 'Standard tilgjengelige rettigheter for agenter i systemet. Hvis flere rettigheter trengs kan de skrives inn her. Noen andre fine rettigheter finnes også innebygde: note, close, pending, customer, freetext, move, compose, responsible, forward og bounce. Pass på at "rw" alltid er den siste i listen.',
        'Start number for statistics counting. Every new stat increments this number.' => 'Starttall for statistikktelling. Nye statistikker legger til på dette tallet.',
        ...
        'The "bin/PostMasterMailAccount.pl" will reconnect to POP3/POP3S/IMAP/IMAPS host after the specified count of messages.' => 'Skriptet "bin/PostMasterMailAccount.pl" vil kople til eposttjeneren (POP3/POP3S/IMAP/IMAPS) på nytt etter det spesifiserte antall meldinger.',
        'The agent skin\'s InternalName which should be used in the agent interface. Please check the available skins in Frontend::Agent::Skins.' => '',
        'The customer skin\'s InternalName which should be used in the customer interface. Please check the available skins in Frontend::Customer::Skins.' => '',
        'The divider between TicketHook and ticket number. E.g \': \'.' => 'Skilletegnet mellom TicketHook og saksnummeret, f.eks. ":"',
        ...
        'The identifier for a ticket, e.g. Ticket#, Call#, MyTicket#. The default is Ticket#.' => 'Identifikatoren for en sak, f.eks. Sak#, Ticket#, MinSak#. Standard er Ticket#',
        'The logo shown in the header of the agent interface. The URL to the image must be a relative URL to the skin image directory.' => 'Logoen som vises i toppen av agentdelen. URL til bildet må være en relativ URL til temaets image-mappe.',
        'The logo shown in the header of the customer interface. The URL to the image must be a relative URL to the skin image directory.' => 'Logoen som vises i toppen av kundeportalen. URLen må være en relativ URL til temaets image-mappe.',
        'The logo shown on top of the login box of the agent interface. The URL to the image must be relative URL to the skin image directory.' => 'Logoen som synes over innloggingsboksen i agentdelen. URLen må være relativ til image-mappen i den valgte temamappen.',
        'The text at the beginning of the subject in an email reply, e.g. RE, AW, or AS.' => 'Teksten i begynnelsen av emnet på et epost-svar, f.eks. RE, SV',
        'The text at the beginning of the subject when an email is forwarded, e.g. FW, Fwd, or WG.' => 'Teksten i begynnelsen av emnet på en epost som er videresendt, f.eks. VS, FW',
        ...
        'Uses richtext for viewing and editing: articles, salutations, signatures, standard responses, auto responses and notifications.' => 'Bruker rikt tekstformat for visning og redigerer: innlegg, hilsninger, signaturer, standardsvar, autosvar og varslinger.',
        ...
        'Add a new Agent.' => 'Legg til en ny agent.',
        ...
        'Agent based' => 'Agentbasert',
        'Agent-Area' => 'Agent-område',
        'All Agent variables.' => 'Alle variabler for agenter.',
        ...
        'Change owner of ticket' => 'Endre agent for sak',
        ...
        'Customer Owner Notify' => 'Kundenotifikasjon ved skifte av agent',
        ...
        'Defines the default front-end (HTML) theme to be used by the agents and customers. The default themes are Standard and Lite. If you like, you can add your own theme. Please refer the the administrator manual located at http://doc.otrs.org/.' => 'Standard HTML-tema til bruk for agenter og kunder. Standardtemaene tilgjengelig er Standard og Lite. Hvis du vil kan du selv legge til ditt eget tema. Se administratormanualen på http://doc.otrs.org for mer informasjon om dette.',
        'Defines the default skin to agent frontend. Please write the Skin InternalName. If you want, you can add your own skins.' => 'Definerer standard-skin for agentsidene. Skriv inn InternalName for skin. Hvis du vil kan du legge til dine egne skins',
        ...
        'Don\'t forget to add a new user to groups and/or roles!' => 'Ikke glem å legge til nye agenter til grupper og/eller roller!',
        ...
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.' => 'Hvis en kunde sender oppfølgings epost på en avsluttet sak, blir saken låst til forrige agent.',
        ...
        'Message for new Owner' => 'Melding til ny agent',
        ...
        'OTRS sends an notification email to the customer if the ticket owner has changed.' => 'OTRS sender en merknad til kunden ved skifte av agent.',
        ...
        'Role' => 'Rolle',
        'Roles <-> Agents' => 'Roller <-> Agenter',
        'Roles <-> Groups Management' => 'Administrasjon: Roller <-> Grupper',
        'Roles <-> Users' => 'Roller <-> Agenter',
        'Roles <-> Users Management' => 'Administrasjon: Roller <-> Agenter',
        ...
        'Send Administrative Message to Agents' => 'Send Administrativ melding til Agenter',
        'Send Notification' => 'Send notis',
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.' => 'Send meg en melding ved kundekorrespondanse på saker jeg står som agent av.',
        ...
        'Users <-> Groups Management' => 'Administrer: Agenter <-> Gruppe',
        ...
        'Xaxis' => 'X-akse',
        'Yes means, send no agent and customer notifications on changes.' => 'Ja betyr at man ikke sender agent eller kunde endringsnotiser.',
        ...
        'for agent login' => 'for agent-innlogging',

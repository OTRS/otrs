...
# --
# $Id: nb_NO.pm,v 1.106 2011-01-24 12:32:56 martin Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Notification article type' => 'Artikkeltype for notis',
        'Only for notifications to specified email addresses' => 'Kun for notis til spesifiserte epostadresser',
        'To get the first 20 character of the subject (of the latest agent article).' => 'For å få de første 20 tegn av emnefeltet (fra den siste agent saken).',
        'To get the first 5 lines of the body (of the latest agent article).' => 'For å få de første 5 linjene av meldingen (fra den siste agent saken).',
        ...
        'Permissions' => 'Tilgang',
        'You can select one or more groups to define access for different agents.' => 'Du kan velge en eller flere grupper for å go tilgang for forskjellige agenter',
        ...
        'You have the possibility to select one or two elements.' => 'Du kan velge ett eller to elementer',
        ...
        'Agent Notifications' => 'Agent-meldinger',
        ...
        'Create and manage notifications that are sent to agents.' => 'Administrasjon av meldinger som sendes ut til agenter.',
        ...
        'Defines the body text for notification mails sent to agents, about new password (after using this link the new password will be sent).' => 'Definerer meldingseksten for nytt-passord-meldingen til agenter. Etter å ha brukt lenken vil det nye passordet bli sendt.',
        'Defines the body text for notification mails sent to agents, with token about new requested password (after using this link the new password will be sent).' => 'Definerer meldingseksten for nytt-passord-meldingen til agenter. Etter å ha brukt lenken vil det nye passordet bli sendt.',
        ...
        'Link agents to groups.' => 'Kople agenter til grupper',
        'Link agents to roles.' => 'Kople agenter til roller',
        ...
        'Sends agent follow-up notification only to the owner, if a ticket is unlocked (the default is to send the notification to all agents).' => 'Send melding kun til sakens eier dersom en sak låses opp (normalt sendes meldingen til alle agenter).',
        ...
        'Specifies the text color of the legend.' => 'Spesifiserer tekstfarge for symboloversikten.',

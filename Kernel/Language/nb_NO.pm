...
# --
# $Id: nb_NO.pm,v 1.44 2007-07-16 10:10:51 martin Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' => 'Vennligst skriv inn en verdi i det valgte input feltet, eller skru av \'Fixed\' avkryssingsboksen!',
        ...
        'Solution' => 'Løsning',
        'QueueView' => 'Mapper',
        'Please select only one element or turn of the button \'Fixed\' where the select field is marked!' => 'Vennligst velg kun ett element, eller skru av \'Fixed\' knappen der valgt felt er markert!',

...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Undo' => 'atcelt',
        'Redo' => 'atjaunot',
        'Scheduler process is registered but might not be running.' => 'Plānotāja process ir reģistrēts, bet, iespējams, nav palaists.',
        'Scheduler is not running.' => 'Plānotājs nav palaists.',
        ...
        'NLS_LANG must be set to AL32UTF8 (e.g. GERMAN_GERMANY.AL32UTF8).' =>
            'NLS_LANG ir jāiestata uz AL32UTF8 (piem., GERMAN_GERMANY.AL32UTF8).',
        ...
        'Default SOAP Username and Password' => 'SOAP Lietotājvārds un Parole pēc noklusējuma',
        ...
        'Ticket Search Index module' => 'Pieteikumu meklēšanas indekss modulis',
        ...
        'Direction' => 'Virziens',
        'Agent (All with write permissions)' => 'Aģents (visi ar rakstīšanas atļauju)',
        'Agent (Owner)' => 'Aģents (Īpašnieks)',
        'Agent (Responsible)' => 'Aģents (Atbildīgais)',

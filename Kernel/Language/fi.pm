...
# --
# $Id: fi.pm,v 1.68 2008-05-15 12:49:31 tr Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'The recommended charset for your language is %s!' =>
            'Suositeltava kirjainasetus kielellesi on %s',
        'Passwords doesn\'t match! Please try it again!' =>
            'Salasana ei täsmää! Ole hyvä ja yritä uudestaan!',
        'Password is already in use! Please use an other password!' =>
            'Salasana on jo käytössä! Ole hyvä ja käytä toista salasanaa!',
        ...
        'Login failed! Your username or password was entered incorrectly.' =>
            'Kirjautuminen epäonnistui! Käyttäjätunnus tai salasanan virheellinen.',
        'Please contact your admin' => 'Ota yhteyttä ylläpitäjääsi',
        'Logout successful. Thank you for using OTRS!' =>
            'Uloskirjautuminen onnistui. Kiitos kun käytit OTRS-järjestelmää',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' =>
            'Ei toimi käyttäjäID:llä 1(järjestelmätunnus). Tee uusia käyttäjiä ',
        'Dispatching by email To: field.' => '',
        'Dispatching by selected Queue.'  => '',
        'No entry found!'                 => 'Tietoa ei löytynyt!',
        'Session has timed out. Please log in again.' =>
            'Istunto on vanhentunut. Ole hyvä ja kirjaudu uudestaan.',
        'No Permission!' => 'Ei oikeutta!',
        'To: (%s) replaced with database email!' =>
            'Vastaanottaja: (%s) korvattu tietokannasta löytyvällä!',
        ...
        'Can\'t update password, invalid characters!' =>
            'Salasanan päivitys ei onnistunut, virheellisiä merkkejä.',
        'Can\'t update password, need min. 8 characters!' =>
            'Salasanan päivitys ei onnistunut, minimi 8 merkkiä.',
        'Can\'t update password, need 2 lower and 2 upper characters!' =>
            'Salasanan päivitys ei onnistunut, vähintään 2 isoa ja 2 pientä kirjainta.',
        'Can\'t update password, need min. 1 digit!' =>
            'Salasanan päivitys ei onnistunut, vähintään 1 numero.',
        'Can\'t update password, need min. 2 characters!' =>
            'Salasanan päivitys ei onnistunut, vähintään 2 kirjainta.',
        ...
        'The selected start time is before the allowed start time!' =>
            'Valittu aloitusaika on suurempi kuin sallittu aloitusaika!',
        'The selected end time is after the allowed end time!' =>
            'Valittu lopetusaika on sallitun ajan jälkeen!',
        ...
        'This message was written in a character set other than your own.' =>
            'Tämä teksti on kirjoitettu eri kirjaisinasetuksilla kuin omasi',
        ...
        'This is a HTML email. Click here to show it.' =>
            'Tämä sähköposti on HTML-muodossa. Klikkaa tästä katsoaksesi sitä',
        ...
        'No such Ticket Number "%s"! Can\'t link it!' =>
            'Ei tikettiä numerolla"%s"! Valitse toinen.',
        ...
        'Create new Email Ticket and send this out (Outbound)' =>
            'Luo uusi sähköpostitiketti ja lähetä se ulos',
        ...
        'Select your screen after creating a new ticket.' =>
            'Valitse näkymä uuden tiketin luonnin jälkeen.',
        ...
        'History::TimeAccounting' =>
            '%s aikayksikköä lisätty. Kokonaisaika on nyt %s aikayksikköä.',
        'History::Remove'         => '%s',
        ...
        'To get the first 20 character of the subject.' =>
            'Saadaksesi ensimmäiset 20 merkkiä otsikosta.',
        'To get the first 5 lines of the email.' => 'Saadaksesi viisi riviä viestistä.',
        'To get the realname of the sender (if given).' =>
            'Saadaksesi lähettäjän nimitieto (jos asetettu).',
        ...
        'Ticket owner options (e. g. <OTRS_OWNER_UserFirstname>).' =>
            'Tiketin omistajaasetukset (esim. <OTRS_OWNER_UserFirstname>).',
        ...
        'Read only access to the ticket in this group/queue.' =>
            'Vain lukuoikeus tiketteihin tässä ryhmässä/jonossa.',
        'rw' => 'rw',
        ...
        'Fulltext-Search in Article (e. g. "Mar*in" or "Baue*")' =>
            'Kokosanahaku artikkeleista (esim "Mar*ku tai "Penti*")',
        ...
        'The admin group is to get in the admin area and the stats group to get stats area.' =>
            'Admin-ryhmän jäsenet pääsevät ylläpito- ja tilastoalueille.',
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).'
            => 'Lisää uusi käyttäjäryhmä, että voit määritellä käyttöoikeuksia useammille eri tukiryhmille (Huolto, Ostot, Markkinointi jne.)',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'Huomautukset lähetetään joko agentille tai käyttäjälle',
        ...
        'Do you really want to uninstall this package?' =>
            'Haluatko varmasti poistaa paketin asennuksen?',
        'Reinstall' => 'Uudelleen',
        'Do you really want to reinstall this package (all manual changes get lost)?' =>
            'Haluatko varmasti asentaa paketin uudestaan (kaikki manuaaliset asetukset poistuvat)?',
        'Continue'                    => 'Jatka',
        'Install'                     => 'Asenna',
        'Package'                     => 'Paketti',
        'Online Repository'           => '',
        ...
        'Logfile too large, you need to reset it!' =>
            'Lokitiedosto on liian iso, sinun tulee puhdistaa se!',
        'Range'            => 'Väli',
        'Interface'        => '',
        'Requests'         => '',
        'Min Response'     => '',
        ...
        'Will be the sender address of this queue for email answers.' =>
            'Lähettäjäosoite jonosta lähetetyille sähköposteille.',
        ...
        'Don\'t forget to add a new response a queue!' =>
            'Älä unohda lisätä uutta vastauspohjaa jonotuslistalle.',
        ...
        'It\'s useful for a lot of users and groups.' =>
            'Tämä on kätevä useammalle käyttäjälle ja ryhmälle.',
        ...
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' =>
            'Kaikki viestit joissa tämä "Email" (To:)-kenttä.',
        ...
        'Discard all changes and return to the compose screen' =>
            'Hylkää muutokset ja palaa viestin kirjoitusikkunaan',
        ...
        'Here you can insert a description of the stat.' =>
            'Voit lisätä tähän selityksen tilastolle.',
        'Dynamic-Object'                                                               => '',
        ...
        'After doing so your OTRS is up and running.' =>
            'Tämän jälkeen OTRS järjestelmä on käytettävissä.',
        ...
        'Home' => 'Etusivu',
        'Config options (e. g. <OTRS_CONFIG_HttpType>)' =>
            'Asetusvaihtoehdot (esim. <OTRS_CONFIG_HttpType>)',
        ...
        'to get the first 20 character of the subject' =>
            'nähdäksesi ensimmäiset 20 kirjainta otsikosta',

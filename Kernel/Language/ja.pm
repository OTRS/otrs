...
sub Data {
    ...
    $Self->{Completeness}        = 0.680235579421445;
    ...
    $Self->{Translation} = {
        ...
        'Ready-to-run Web Services' => 'Ready-to-run Webサービス',
        ...
        'Please note that these web services may depend on other modules only available with certain %s contract levels (there will be a notification with further details when importing).' =>
            '',
        'Import ready-to-run web service' => '"ready to run"Webサービスをインポート',
...
OTRSが443ポートを用いてcloud.otrs.comに接続できることを確認して下さい。',
        ...
        'Read more about statistics in OTRS' => 'OTRSの統計について詳細を読む',
...
詳細は、ログファイルを参照してください。',
        ...
        'Please upload a valid statistic file.' => '有効な統計ファイルをアップロードして下さい。',
        ...
        'Loading draft failed!' => 'ドラフトのロードに失敗しました！',
        'Sorry, you need to be the ticket owner to perform this action.' =>
            'この操作を行うには担当者または責任者になる必要があります。',
        'Please change the owner first.' => '最初に担当者を変更してください。',
        'FormDraft functionality disabled!' => 'FormDraft機能が無効になっています！',
        'Draft name is required!' => 'ドラフト名は必須です！',
        ...
        'Group for statistics access.' => '統計レポート操作用のグループ',
        'new' => '新規',
        ...
        'A package upgrade was recently finished. Click here to see the results.' =>
            '',
        'Upgrade all packages' => '全てのパッケージをアップグレード',
        'Dismiss' => '非表示',
        'Upgrade All Packages' => '全てのパッケージをアップグレード',
        ...
        'Do you really want to delete this statistic?' => 'この統計を削除してよろしいですか？',
        ...
        'Add new draft' => '新規草稿を追加',
        'Delete draft' => '草稿を削除',
        'There are no more drafts available.' => '草稿がありません',
        'It was not possible to delete this draft.' => 'この草稿は削除できません',
...
',
        ...
        'Choose for which kind of ticket changes you want to receive notifications. Please note that you can\'t completely disable notifications marked as mandatory.' =>
            '',
        'Choose which notifications would you like to receive.' => '受け取る通知を選択します。',
...
\'Search_DynamicField_XTimeSlotStartYear=1974; Search_DynamicField_XTimeSlotStartMonth=01; Search_DynamicField_XTimeSlotStartDay=26; Search_DynamicField_XTimeSlotStartHour=00; Search_DynamicField_XTimeSlotStartMinute=00; Search_DynamicField_XTimeSlotStartSecond=00; Search_DynamicField_XTimeSlotStopYear=2013; Search_DynamicField_XTimeSlotStopMonth=01; Search_DynamicField_XTimeSlotStopDay=26; Search_DynamicField_XTimeSlotStopHour=23; Search_DynamicField_XTimeSlotStopMinute=59; Search_DynamicField_XTimeSlotStopSecond=59;\' and or \'Search_DynamicField_XTimePointFormat=week; Search_DynamicField_XTimePointStart=Before; Search_DynamicField_XTimePointValue=7\';',
        ...
        'Disables the communication between this system and OTRS Group servers that provides cloud services. If active, some functionality will be lost such as system registration, support data sending, upgrading to and use of OTRS Business Solution™, OTRS Verify™, OTRS News and product News dashboard widgets, among others.' =>
            'OTRSグループが提供するクラウドサービスへのアクセスを停止します。有効にするとシステム登録やサポートデータの送信、OTRS Business Solution™️ やOTRS Verify™️の使用、ダッシュボードでのOTRS関連のお知らせなどの機能が利用できなくなります。',

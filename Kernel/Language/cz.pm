...
# --
# $Id: cz.pm,v 1.92 2010-09-24 07:42:30 mg Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2010-09-24 09:40:13
    ...
    $Self->{Translation} = {
        ...
        # Template: DevelFredDProf

        # Template: DevelFredEnvDump

        # Template: DevelFredHTMLCheck

        # Template: DevelFredHTMLValidate
        ...
        'Config' => '',
        'Attention: You can\'t use any of SmallProf, DProf, NYTProf, and Cover at the same time!' => '',

        # Template: DevelFredSmallProf
        'Profiled packages:' => '',
        'Calls' => '',
        'Time executing (ms)' => '',
        'Time expended (ms)' => '',
        'For more information, especially \'time execution\' and \'time expended\' read perldoc SmallProf!' => '',
        'If you change the package config you have to reload this site two times!' => '',

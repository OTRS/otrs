...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Please answer this ticket(s) to get back to the normal queue view!' =>
            'Prosím, odpovìzte na tento (tyto) tiket(y) pro návrat do normálního náhledu fronty!',
        ...
        'The recommended charset for your language is %s!' =>
            'Doporuèená znaková sada pro Vá¹ jazyk je %s!',
        ...
        'There is no account with that login name.' =>
            '®ádný úèet s tímto pøihla¹ovacím jménem neexistuje.',
        'Login failed! Your username or password was entered incorrectly.' =>
            'Pøihlá¹ení neúspì¹né! Va¹e u¾ivatelské jméno èi heslo bylo zadáno nesprávnì.',
        'Please contact your admin' => 'Kontaktujte, prosím, Va¹eho administrátora',
        'Logout successful. Thank you for using OTRS!' =>
            'Odhlá¹ení bylo úspìsné. Dìkujeme Vám za pou¾ívání OTRS!',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' =>
            'Z bezpeènostních dùvodù nepracujte se superu¾ivatelským úètem - vytvoøte si nového u¾ivatele!',
        ...
        'Session has timed out. Please log in again.' =>
            'Relace vypr¹ela. Prosím, pøihla¹te se znovu.',
        'No Permission!'                         => '',
        ...
        'This message was written in a character set other than your own.' =>
            'Tato zpráva byla napsána v jiné znakové sadì ne¾ Va¹e.',
        ...
        'This is a HTML email. Click here to show it.' =>
            'Toto je HTML email. Pro zobrazení kliknìte zde.',
        'Free Fields'                                 => '',
        'Merge'                                       => '',
        'merged'                                      => '',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.'
            => 'Po¹li mi oznámení, pokud klient po¹le následující a jsem vlastník tohoto tiketu.',
        'Ticket lock timeout notification' => 'Oznámení o vypr¹ení èasu uzamèení tiketu',
        'Send me a notification if a ticket is unlocked by the system.' =>
            'Po¹li mi oznámení, pokud je tiket odemknut systémem.',
        ...
        'Max. shown Tickets a page in QueueView.' =>
            'Max. zobrazených tiketù v náhledu fronty na stránku',
        'CompanyTickets'            => '',
        'MyTickets'                 => '',
        'New Ticket'                => '',
        'Create new Ticket'         => '',
        ...
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).'
            => 'Pokud nebylo nic vybráno, nejsou v této skupinì ¾ádná práva (tikety nebudou pro u¾ivatele dostupné).',
        'Permission' => 'Práva',
        'ro'         => 'jen ètení',
        'Read only access to the ticket in this group/queue.' =>
            'Pøístup pouze pro ètení tiketu v této skupinì/øadì.',
        'rw' => 'ètení/psaní',
        ...
        'Fulltext-Search in Article (e. g. "Mar*in" or "Baue*")' =>
            'Fulltextové vyhledávání v polo¾ce (napø. "Mar*in" or "Baue*")',
        ...
        'The admin group is to get in the admin area and the stats group to get stats area.' =>
            'Skupina administrátora má pøístup do administraèní a statistické zóny.',
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).'
            => 'Vytvoøit nové skupiny pro pøiøazení práv pøístupù ruzným skupinám agentù (napø. oddìlení nákupu, oddìlení podpory, oddìlení prodeje...).',
        ...
        'Notifications are sent to an agent or a customer.' =>
            'Oznámení jsou odeslána agentovi èi klientovi',
        ...
        'All incoming emails with one account will be dispatched in the selected queue!' =>
            'V¹echny pøíchozí emaily z daného úètu budou zaøazeny do vybrané fronty!',
        ...
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.'
            => 'Pokud agent uzamkne tiket a neode¹le v této dobì odpovìï, tiket bude automaticky odemknut. Tak se stane tiket viditelný pro v¹echny ostatní agenty.',
        'Escalation time' => 'Doba stupòování',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' => '',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.'
            => 'Pokud je tiket uzavøen a klient ode¹le následující, tiket bude pro starého vlastníka uzamknut.',
        'Will be the sender address of this queue for email answers.' =>
            'Bude adresou odesílatele z této fronty pro emailové odpovìdi.',
        ...
        'OTRS sends an notification email to the customer if the ticket is moved.' =>
            'OTRS po¹le klientovi emailem oznámení, pokud bude tiket pøesunut.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' =>
            'OTRS po¹le klientovi emailem oznámení, pokud se zmìní stav tiketu.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' =>
            'OTRS po¹le klientovi emailem oznámení, pokud se zmìní vlastník tiketu.',
        ...
        'A response is default text to write faster answer (with default text) to customers.' =>
            'Odpovìï je obsahuje výchozí text slou¾ící k rychlej¹í reakci (spolu s výchozím textem) klientùm.',
        'Don\'t forget to add a new response a queue!' =>
            'Nezapomeòte pøidat novou reakci odpoveï do fronty!',
        ...
        'Permissions to move tickets into this group/queue.' =>
            'Práva pøesunout tikety do této skupiny/fronty',
        'create' => 'vytvoøit',
        'Permissions to create tickets in this group/queue.' =>
            'Práva vytvoøit tikety v této skupinì/frontì',
        'owner' => 'vlastník',
        'Permissions to change the ticket owner in this group/queue.' =>
            'Práva zmìnit vlastník tiketu v této skupinì/frontì',
        'priority' => 'priorita',
        'Permissions to change the ticket priority in this group/queue.' =>
            'Práva zmìnit prioritu tiketu v této skupinì/frontì',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' =>
            'Ujistìte se, ¾e jste aktualizovali také výchozí hodnoty ve Va¹em Kernel/Config.pm!',
        'See also' => 'Viz. také',
        ...
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' =>
            'V¹echny pøíchozí emaily obsahující tohoto adresáta (v poli KOMU) budou zaøazeny to vybrané fronty!',
        ...
        'User will be needed to handle tickets.' =>
            'U¾ivatel bude potøebovat práva pro ovládání tiketù.',
        ...
        'Discard all changes and return to the compose screen' =>
            'Zru¹it v¹echny zmìny a vrátit se zpìt do okna vytváøení',
        ...
        'Set customer user and customer id of a ticket' =>
            'Nastavit klienta a nastavit ID klienta tiketu',
        ...
        'your MySQL DB should have a root password! Default is empty!' =>
            'Va¹e MySQL databáze by mìla mít root heslo! Výchozí je prázdné!',
        'Database-User'   => '',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)'
            => '(Identita systému. Ka¾dé èíslo tiketu a ID ka¾dá HTTP relace zaèíná tímto èíslem)',
        'System FQDN' => 'Systém FQDN',
        '(Full qualified domain name of your system)' =>
            '(Platný název domény pro vá¹ systém (FQDN))',
        ...
        '(Logfile just needed for File-LogModule!)' =>
            '(Pro logování do souboru je nutné zadat název souboru logu!)',
        'Webfrontend'     => 'Webove rozhraní',
        'Default Charset' => 'Výchozí znaková sada',
        'Use utf-8 it your database supports it!' =>
            'Pou¾ijte utf-8 pokud to Va¹e databáze podporuje',
        'Default Language'        => 'Výchozí jazyk',
        '(Used default language)' => '(Pou¾itý výchozí jazyk)',
        'CheckMXRecord'           => 'Kontrolovat MX záznam',
        '(Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behinde a dial-up line $!)'
            => '(Kontroluj MX záznamy pou¾itých emailových adres pøi sestavování odpovìdi. Nepou¾ívejte pokud OTRS server pøipojen pomocí vytáèené linky!)',
        'To be able to use OTRS you have to enter the following line in your command line (Terminal/Shell) as root.'
            => 'Abyste mohli pou¾ívat OTRS, musíte zadat následující øádek do Va¹eho pøíkazového øádku (Terminal/Shell) jako root.',
        'Restart your webserver' => 'Restartujte Vá¹ webserver',
        'After doing so your OTRS is up and running.' =>
            'Po dokonèení následujících operací je Vá¹ OTRS spu¹tìn a pobì¾í',
        ...
        '(Ticket identifier. Some people want toset this to e. g. \'Ticket#\', \'Call#\' or \'MyTicket#\')'
            => '(Identifikátor tiketù. Nekteøí lidé chtìjí nastavit napø. \'Tiket#\',  \'Hovor#\' nebo \'MujTiket#\')',
        ...
        'Customer history search (e. g. "ID342425").' =>
            'Vyhledávání historie klienta (napø. "ID342425")',
        'Close!'              => 'Zavøít!',
        'for agent firstname' => 'pro køestní jméno agenta',
        'The message being composed has been closed.  Exiting.' =>
            'Vytváøená zpráva byla uzavøena. Opou¹tím.',
        'A web calendar' => '',
        'to get the realname of the sender (if given)' =>
            'pro získaní skuteèného jména odesílatele (pokud je zadáno)',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further informations.'
            => 'Vá¹ email s èíslem ticketu "<OTRS_TICKET>" je odeslán zpìt na "<OTRS_BOUNCE_TO>". Kontaktujte tuto adresu pro dal¹í infromace.',
        ...
        'This window must be called from compose window' =>
            'Toto okno musí být vyvoláno z okna vytváøení',
        ...
        'If a ticket will not be answered in thos time, just only this ticket will be shown.' =>
            'Nebude-li tiket odpovìzen v daném èase, bude zobrazen pouze tento Tiket.',
        'All Agent variables.'                                               => '',
        ...
        'Don\'t forget to add a new user to groups!' =>
            'Nezapomeòte pøidat nového u¾ivatele do skupin!',
        'You need a email address (e. g. customer@example.com) in To:!' =>
            'Musíte mít  uvedenu emailovou adresu (napø. klient@priklad.cz) v poli Komu:!',

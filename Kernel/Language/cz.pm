...
# --
# $Id: cz.pm,v 1.91 2010-09-24 07:39:58 mg Exp $
# --
...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Customer Companies' => 'Spoleènosti klienta',
        'Company' => 'Spoleènost',
        'go!' => 'jdi!',
        'go' => 'jdi',
        'All' => 'V¹e',
        ...
        'Select the separator character used in CSV files (stats and searches). If you don\'t select a separator here, the default separator for your language will be used.' => 'Zvolte oddìlovací znak pou¾ívaný v CSV souborech. Pokud zde nezvolíte oddìlovaè bude pou¾it výchozí oddìlovaè pro Va¹í jazykovou sadu.',
        'CSV Separator' => 'CSV oddìlovaè',

...
# --
# $Id: vi_VN.pm,v 1.51 2011-09-06 10:26:54 mg Exp $
# --
...
sub Data {
    ...
    # $$START$$
    # Last translation file sync: 2011-09-06 12:20:23
    ...
    $Self->{Translation} = {
        ...
        'New message!' => 'Tin nhắn mới!',
        'Please answer this ticket(s) to get back to the normal queue view!' => 'Hãy trả lời thẻ này để trở lại phần xem các hàng đợi thông thường!',
        ...
        'Security Note: You should activate %s because application is already running!' => 'Lưu ý bảo mật: Bạn nên kích hoạt %s bởi ứng dụng đã hoạt động!',
        ...
        'Please select only one element or turn off the button \'Fixed\' where the select field is marked!' => 'Hãy chọn duy nhất 1 thành tố hoặc tắt nút \'Đã sửa\'nơi trường đã chọn được đánh dấu!',
        'If you use a checkbox you have to select some attributes of the select field!' => 'Nếu bạn sử dụng một hộp chọn bạn phải chọn một số thuộc tính của trường đã chọn!',
        'Please insert a value in the selected input field or turn off the \'Fixed\' checkbox!' => 'Hãy chèn một giá trị trong trường nhập đã chọn hoặc tắt hộp chọn \'Đã sửa\'!',
        'The selected end time is before the start time!' => 'Thời gian kết thúc đã chọn trước thời gian bắt đầu!',
        'You have to select one or more attributes from the select field!' => 'Bạn phải chọn 1 hoặc nhiều thuộc tính từ trường đã chọn!',
        ...
        'If you use a time scale element you can only select one element!' => 'Nếu bạn sử dụng thành tố khung thời gian bạn có thể chỉ chọn 1 thành tố!',
        'You have an error in your time selection!' => 'Có 1 lỗi trong quá trình chọn thời gian của bạn!',
        'Your reporting time interval is too small, please use a larger time scale!' => 'Khoảng thời gian báo cáo quá nhỏ, hãy sử dụng khung thời gian lớn hơn!',
        ...
        'The selected time period is larger than the allowed time period!' => 'Khoảng thời gian đã chọn lớn hơn khoảng thời gian cho phép!',
        ...
        'This message was written in a character set other than your own.' => 'Tin nhắn này đã được viết bằng bộ ký tự khác với của bạn.',
        ...
        'Your email with ticket number "<OTRS_TICKET>" is merged to "<OTRS_MERGE_TO_TICKET>".' => 'E-mail của bạn với số thẻ "<OTRS_TICKET>" được trộn thành "<OTRS_MERGE_TO_TICKET>"!',
        ...
        'Send me a notification if there is a new ticket in "My Queues".' => 'Gửi thông báo cho tôi nếu có thẻ mới trong "Hàng đợi của tôi".',
        ...
        'Send me a notification if a ticket is unlocked by the system.' => 'Gửi thông báo cho tôi nếu một thẻ chưa được khóa bởi hệ thống.',
        ...
        'rw' => 'đọc và ghi',
        'Full read and write access to the tickets in this group/queue.' => 'Quyền đọc và ghi truy cập vào thẻ trong nhóm/hàng đợi này.',
        ...
        'CMD' => 'CMD',
        'This command will be executed. ARG[0] will be the ticket number. ARG[1] the ticket id.' => 'Lệnh này sẽ được chạy. ARG[0] sẽ là số thẻ. ARG[1] là mã thẻ.',
        ...
        'Add group' => '',
        'The admin group is to get in the admin area and the stats group to get stats area.' => 'Nhóm quản trị lấy trong khu vực quản trị và nhóm thống kê lấy trong khu vực thống kê.',
        ...
        'Add mail account' => '',
        'All incoming emails with one account will be dispatched in the selected queue!' => 'Tất cả các email đến với 1 tài khoản sẽ được gửi vào trong hàng đợi đã chọn!',
        'If your account is trusted, the already existing X-OTRS header at arrival time (for priority, ...) will be used! PostMaster filter will be used anyway.' => 'Nếu tài khoản của bạn là đáng tin cậy, đầu trang X-OTRS đã có tại thời gian đến (cho mức độ ưu tiên, ...) sẽ được sử dụng! Bộ lọc PostMaster cũng sẽ được dùng.',
        'Host' => 'Máy chủ host',
        'Delete account' => '',
        'Fetch mail' => '',
        'Add Mail Account' => '',
        ...
        'Add PGP key' => '',
        'In this way you can directly edit the keyring configured in SysConfig.' => 'Theo cách này bạn có thể sửa trực tiếp cấu hình khóa trong Cấu hình hệ thống.',
        'Introduction to PGP' => '',
        'Result' => 'Kết quả',
        ...
        'If you want to match only the email address, use EMAILADDRESS:info@example.com in From, To or Cc.' => 'Nếu bạn muốn kết hợp các địa chỉ email, hãy dùng EMAILADDRESS:info@example.com trong trường Từ, Đến hoặc Cc.',
        ...
        'Manage Responses' => '',
        'Add response' => '',
        'A response is default text to write faster answer (with default text) to customers.' => 'Một phản hồi là một văn bản mặc định được viết câu trả lời nhanh gửi cho khách hàng.',
        ...
        'Add role' => '',
        'Create a role and put groups in it. Then add the role to the users.' => 'Tạo 1 vai trò và đặt các nhóm vào đó. Rồi thêm vai trò cho người dùng.',
        ...
        'priority' => 'Ưu tiên',
        'Permissions to change the ticket priority in this group/queue.' => 'Các quyền để thay đổi ưu tiên thẻ trong nhóm/hàng đợi này.',
        ...
        'See also' => 'Xem',
        'In this way you can directly edit the certification and private keys in file system.' => 'Theo cách này bạn có thể sửa chứng chỉ và khóa cá nhân trực tiếp trong hệ thống file.',
        'Hash' => 'Băm',
        'Create' => 'Tạo',
        ...
        'If you remove the hook in the "Fixed" checkbox, the agent generating the stat can change the attributes of the corresponding element.' => 'Nếu bạn bỏ đánh dấu trong ô "Đã sửa", nhân viên phụ trách sinh thống kê có thể thay đổi các thuộc tính của thành tố liên quan.',
        'Fixed' => 'Đã sửa',
        'Please select only one element or turn off the button \'Fixed\'.' => 'Hãy chọn chỉ 1 thành tố hoặc tắt nút \'Đã sửa\'!',
        'Absolute Period' => '',
        'Between' => 'Giữa',
        ...
        'Please contact your administrator.' => '',
        'Graph size' => '',
        'If you use a graph as output format you have to select at least one graph size.' => 'Nếu bạn dùng một biểu đồ làm định dạng đầu ra, bạn phải chọn ít nhất 1 cỡ biểu đồ.',
        'Sum rows' => 'Tổng số hàng',
        'Sum columns' => 'Tổng số cột',
        'Use cache' => '',
        'Most of the stats can be cached. This will speed up the presentation of this stat.' => 'Hầu hết các thống kê đều có thể được lưu. Điều này sẽ đẩy nhanh tốc độ trình diễn của thống kê.',
        ...
        'Scale' => 'Phạm vi',
        'minimal' => 'tối thiểu',
        'Please remember, that the scale for value series has to be larger than the scale for the X-axis (e.g. X-Axis => Month, ValueSeries => Year).' => 'Hãy nhớ rằng, phạm vi cho chuỗi giá trị phải lớn hơn phạm vi cho trục X (ví dụ: trục X => Tháng; Chuỗi giá trị => Năm).',
        ...
        'To be able to use OTRS you have to enter the following line in your command line (Terminal/Shell) as root.' => 'Để có thể sử dụng OTRS bạn phải nhập dòng sau vào dòng lệnh của bạn (Terminal/Shell) làm gốc.',
        ...
        '(Checks MX recordes of used email addresses by composing an answer. Don\'t use CheckMXRecord if your OTRS machine is behinde a dial-up line $!)' => '(Kiểm tra các bản ghi MX của các địa chỉ email đã sử dụng bằng cách tạo một trả lời. Không dùng Kiểm tra bản ghi MX nếu hệ thống OTRS của bạn nằm sau 1 đường dial-up!)',
        ...
        '(Note: It depends on your installation how many dynamic objects you can use)' => '(Lưu ý: Nó phụ thuộc vào cài đặt của bạn có bao nhiêu đối tượng động bạn muốn dùng)',
        ...
        '(The identify of the system. Each ticket number and each http session id starts with this number)' => '(Nhận dạng của hệ thống. Mỗi số thẻ và mỗi mã phiên http đều bắt đầu bằng số này)',
        '(Ticket identifier. Some people want toset this to e. g. \'Ticket#\', \'Call#\' or \'MyTicket#\')' => '(Nhận dạng thẻ. Một số người muốn thiết đặt điều này thành ví dụ như \'Ticket#\', \'Call#\' hoặc \'MyTicket#\')',
        ...
        'All Customer variables like defined in config option CustomerUser.' => 'Tất cả các biến số khách hàng đã định nghĩa trong cấu hình tùy chọn người dùng khách hàng.',
        'All customer tickets.' => 'Tất cả các thẻ khách hàng.',
        'All incoming emails with this "Email" (To:) will be dispatched in the selected queue!' => 'Tất cả các email đến với có từ "Email" (Tới:) sẽ được gửi vào trong hàng đợi đã chọn.',
        ...
        'Can\'t update password, must contain 2 lower and 2 upper characters!' => 'Không thể cập nhật mật khẩu, cần có 2 ký tự dưới và 2 ký tự trên.',
        ...
        'Can\'t update password, your new passwords do not match! Please try again!' => 'Không thể cập nhật mật khẩu, các mật khẩu không khớp nhau! Hãy thử lại lần nữa!',
        ...
        'Create new groups to handle access permissions for different groups of agent (e. g. purchasing department, support department, sales department, ...).' => 'Tạo các nhóm mới để điều khiển quyền truy cập cho các nhóm nhân viên khác nhau (ví dụ: bộ phận mua hàng, bộ phận hỗ trợ, bộ phận kinh doanh,...).',
        ...
        'Customer user will be needed to have a customer history and to login via customer panel.' => 'Người dùng khách hàng sẽ cần có một lịch sử khách hàng và đăng nhập thông qua bảng điều khiển khách hàng',
        ...
        'Do dispatch or filter incoming emails based on email X-Headers! RegExp is also possible.' => 'Gửi hoặc lọc các email đến dựa trên X-Headers email! RegExp cũng có thể.',
        'Do you really want to delete this Object?' => 'Bạn có thực sự muốn xóa đối tượng này không?',
        'Do you really want to reinstall this package (all manual changes get lost)?' => 'Bạn có thực sự muốn cài lại đặt gói này (tất cả những thay đổi bị mất)?',
        ...
        'Don\'t work with UserID 1 (System account)! Create new users!' => 'Không làm việc với mã người dùng 1 (tài khoản hệ thống)! Hãy tạo người dùng mới!',
        ...
        'For very complex stats it is possible to include a hardcoded file.' => 'Đối với các thống kê phức tạp có thể bao gồm cả file đã mã hóa.',
        'Frontend' => 'Mặt ngoài',
        ...
        'Here you can define the value series. You have the possibility to select one or two elements. Then you can select the attributes of elements. Each attribute will be shown as single value series. If you don\'t select any attribute all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' => 'Bạn có thể định nghĩa chuỗi giá trị tại đây. Bạn có khả năng chon 1 hoặc 2 thành tố. Sau đó có thể chọn các thuộc tính của thành tố. Mỗi thuộc tính sẽ được hiển thị là một chuỗi giá trị đơn lẻ. Nếu không chọn thuộc tính nào, tất cả thuộc tính của thành tố sẽ được sử dụng nếu bạn sinh thống kê. Cùng với đó một thuộc tính mới cũng được thêm kể từ lần cấu hình cuối cùng.',
        'Here you can define the x-axis. You can select one element via the radio button. Then you you have to select two or more attributes of the element. If you make no selection all attributes of the element will be used if you generate a stat. As well a new attribute is added since the last configuration.' => 'Bạn có thể định nghĩa trục X tại đây. Bạn có thể chọn 1 thành tố thông qua nút bấm radio. Sau đó phải chọn 1 hoặc nhiều thuộc tính của thành tố. Nếu không chọn tất cả thuộc tính của thành tố sẽ được sử dụng nếu bạn sinh thống kê. Cùng với đó một thuộc tính mới cũng được thêm kể từ lần cấu hình cuối cùng.',
        ...
        'Home' => 'Trang chủ',
        'If a new hardcoded file is available this attribute will be shown and you can select one.' => 'Nếu một file đã mã hóa sẵn sàng sử dụng, thuộc tính này sẽ được hiển thị và bạn có thể chọn nó.',
        'If a ticket is closed and the customer sends a follow up the ticket will be locked for the old owner.' => 'Nếu một thẻ được đóng và khách hàng gửi theo dõi, thẻ sẽ bị khóa cho người phụ trách cũ.',
        'If a ticket will not be answered in this time, just only this ticket will be shown.' => 'Nếu một thẻ không được trả lời trong thời gian này, chỉ duy nhất thẻ này sẽ được hiển thị.',
        'If an agent locks a ticket and he/she will not send an answer within this time, the ticket will be unlock automatically. So the ticket is viewable for all other agents.' => 'Nếu 1 nhân viên khóa thẻ và họ không gửi trả lời trong thời gian này, thẻ sẽ được tự động mở khóa. Do vậy tất cả các nhân viên khác đều có thể nhìn thấy thẻ đó.',
        'If nothing is selected, then there are no permissions in this group (tickets will not be available for the user).' => 'Nếu không chọn cái gì thì sẽ không có quyền nào trong nhóm này (các thẻ sẽ không sẵn sàng sử dụng đối với người dùng).',
        ...
        'If you use RegExp, you also can use the matched value in () as [***] in \'Set\'.' => 'Nếu bạn dùng RegExp, bạn cũng có thể sử dụng giá trị kết hợp trong () thành [***] trong \'Thiết đặt\'.',
        'Image' => 'Ảnh',
        ...
        'In this way you can directly edit the keyring configured in Kernel/Config.pm.' => 'Theo cách này bạn có thể sửa trực tiếp cấu hình khóa trong Kernel/Config.pm',
        ...
        'Login failed! Your username or password was entered incorrectly.' => 'Đăng nhập thất bại! Tên truy cập hoặc mật khẩu nhập không chính xác.',
        'Lookup' => 'Tra',
        ...
        'No Packages for requested Framework in this Online Repository, but Packages for other Frameworks!' => 'Không có gói nào cho cấu trúc yêu cầu trong Kho chứa trực tuyến này, nhưng có các gói cho những cấu trúc khác.',
        'No Packages or no new Packages in selected Online Repository!' => 'Không có gói nào hoặc không có gói mới nào trong Kho chứa trực tuyến đã chọn!',
        'No Permission' => 'Không có quyền',
        ...
        'OTRS sends an notification email to the customer if the ticket is moved.' => 'OTRS gửi một email thông báo tới khách hàng nếu thẻ được chuyển.',
        'OTRS sends an notification email to the customer if the ticket owner has changed.' => 'OTRS gửi một email thông báo tới khách hàng nếu phụ trách thẻ thay đổi.',
        'OTRS sends an notification email to the customer if the ticket state has changed.' => 'OTRS gửi một email thông báo tới khách hàng nếu trạng thái thẻ thay đổi.',
        'Of couse this feature will take some system performance it self!' => 'Tất nhiên tính năng này sẽ tự thực thi hệ thống.',
        'Open Tickets' => 'Mở thẻ',
        'Options of the current customer user data (e. g. &lt;OTRS_CUSTOMER_DATA_USERFIRSTNAME&gt;)' => 'Các tùy chọn của dữ liệu người dùng khách hàng hiện tại ((ví dụ: &lt;OTRS_CUSTOMER_DATA_USERFIRSTNAME&gt;).',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>)' => 'Các tùy chọn của dữ liệu người dùng khách hàng hiện tại (ví dụ: <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current customer user data (e. g. <OTRS_CUSTOMER_DATA_UserFirstname>).' => 'Các tùy chọn của dữ liệu người dùng khách hàng hiện tại (ví dụ: <OTRS_CUSTOMER_DATA_UserFirstname>)',
        'Options of the current user who requested this action (e. g. &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)' => 'Các tùy chọn của người dùng hiện tại yêu cầu hành động này (ví dụ: &lt;OTRS_CURRENT_USERFIRSTNAME&gt;)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>)' => 'Các tùy chọn của người dùng hiện tại người yêu cầu hành động này (ví dụ: <OTRS_CURRENT_UserFirstname>)',
        'Options of the current user who requested this action (e. g. <OTRS_CURRENT_UserFirstname>).' => 'Các tùy chọn của người dùng khách hàng yêu cầu hành động này (ví dụ: <OTRS_CURRENT_UserFirstname).',
        'Options of the ticket data (e. g. &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)' => 'Các tùy chọn của dữ liệu thẻ (ví dụ: &lt;OTRS_TICKET_Number&gt;, &lt;OTRS_TICKET_ID&gt;, &lt;OTRS_TICKET_Queue&gt;, &lt;OTRS_TICKET_State&gt;)',
        'Options of the ticket data (e. g. <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' => 'Các tùy chọn của dữ liệu thẻ (ví dụ: <OTRS_TICKET_Number>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)' => 'Các tùy chọn của dữ liệu thẻ (ví dụ: <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_ID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>)',
        'Options of the ticket data (e. g. <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>).' => 'Các tùy chọn của dữ liệu thẻ (ví dụ: <OTRS_TICKET_TicketNumber>, <OTRS_TICKET_TicketID>, <OTRS_TICKET_Queue>, <OTRS_TICKET_State>).',
        'Other Options' => 'Các tùy chọn khác',
        'POP3 Account Management' => 'Quản trị tài khoản POP3',
        'Package' => 'Gói',
        'Package not correctly deployed! You should reinstall the Package again!' => 'Gói chưa được triển khai chính xác! Bạn nên cài đặt lại gói lần nữa!',
        'Param 1' => 'Tham số 1',
        'Param 2' => 'Tham số 2',
        'Param 3' => 'Tham số 3',
        'Param 4' => 'Tham số 4',
        ...
        'Permission settings. You can select one or more groups to make the configurated stat visible for different agents.' => 'Các thiết đặt quyền. Bạn có thể lựa chọn 1 hoặc nhiều nhóm để tạo thống kê đã được cấu hình mà các nhân viên khác nhau đều có thể nhìn thấy.',
        ...
        'Send me a notification if a customer sends a follow up and I\'m the owner of this ticket.' => 'Gửi thông báo cho tôi nếu có khách hàng gửi theo dõi và tôi là phụ trách của thẻ này.',
        ...
        'Take care that you also updated the default states in you Kernel/Config.pm!' => 'Hãy lưu ý rằng bạn đã cập nhật các trạng thái mặc định trong Kernel/Config.pm!',
        ...
        'This is useful if you want that no one can get the result of the stat or the stat isn\'t ready configurated.' => 'Điều này sẽ có ích nếu bạn muốn không ai có thể lấy kết quả của thống kê hoặc thống kê không sẵn sàng được cấu hình.',
        ...
        'Ticket owner options (e. g. &lt;OTRS_OWNER_USERFIRSTNAME&gt;)' => 'Các tùy chọn phụ trách thẻ (ví dụ: &lt;OTRS_OWNER_USERFIRSTNAME&gt;)',
        ...
        'Ticket responsible options (e. g. <OTRS_RESPONSIBLE_UserFirstname>).' => 'Các tùy chọn trách nhiệm thẻ (ví dụ:<OTRS_RESPONSIBLE_UserFirstname>).',
        ...
        'To get the article attribute (e. g. (<OTRS_CUSTOMER_From>, <OTRS_CUSTOMER_To>, <OTRS_CUSTOMER_Cc>, <OTRS_CUSTOMER_Subject> and <OTRS_CUSTOMER_Body>).' => 'Lấy thuộc tính bài viết (ví dụ: (<OTRS_CUSTOMER_From>, <OTRS_CUSTOMER_To>, <OTRS_CUSTOMER_Cc>, <OTRS_CUSTOMER_Subject> and <OTRS_CUSTOMER_Body>).',
        ...
        'Warning! This tickets will be removed from the database! This tickets are lost!' => 'Lưu ý! Các thẻ này sẽ bị gỡ bỏ khỏi cơ sở dữ liệu! Các thẻ này sẽ bị mất!',
        ...
        'With the input and select fields you can configurate the stat at your needs. Which elements of a stat you can edit depends on your stats administrator who configurated the stat.' => 'Với các trường đầu vào và đã chọn bạn có thể cấu hình thống kê theo yêu cầu. Với các thành tố của một thống kê bạn có thể sửa tùy theo người quản trị thống kê đó đã cấu hình',
        'Workflow Groups' => 'Các nhóm Dòng công việc',
        'Yes means, send no agent and customer notifications on changes.' => 'Có, nghĩa là, không gửi thông báo cho nhân viên và khách hàng nào về các thay đổi.',
        'Yes, save it with name' => 'Có, lưu với cùng một tên',
        'You got new message!' => 'Bạn có tin nhắn mới!',
        'You have to select two or more attributes from the select field!' => 'Bạn phải chọn 2 hay nhiều thuộc tính từ trường đã chọn!',
        'You need a email address (e. g. customer@example.com) in To:!' => 'Bạn cần địa chỉ email trong trường Tới (ví dụ: kunde@example.com)!',
        ...
        'You use the DELETE option! Take care, all deleted Tickets are lost!!!' => 'Bạn sử dụng tùy chọn Xóa! Hãy cẩn thận, tất cả các thẻ xóa sẽ bị mất!',
        'Your email address is new' => 'Địa chỉ email của bạn là mới',
        'Your email with ticket number "<OTRS_TICKET>" is bounced to "<OTRS_BOUNCE_TO>". Contact this address for further information.' => 'Email của bạn với số thẻ "<OTRS_TICKET>" được chuyển tới "<OTRS_BOUNCE_TO>". Hãy liên hệ với địa chỉ này để có thêm thông tin.',
        ...
        'verified' => 'xác nhận',
        'x' => 'x',
        'your MySQL DB should have a root password! Default is empty!' => 'Cơ sở dữ liệu MySQL của bạn nên có mật khẩu gốc! Mặc định là để trống!',

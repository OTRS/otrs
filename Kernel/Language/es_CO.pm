...
sub Data {
    ...
    $Self->{Translation} = {
        ...
        'Logout successful. Thank you for using OTRS!' => 'Sesión terminada satisfactoriamente.',
        ...
        'Undo' => 'Deshacer',
        'Redo' => 'Rehacer',
        'Scheduler process is registered but might not be running.' => 'El proceso del planificador se encuentra registrado, pero podría no estar corriendo.',
        ...
        'Customer automatically added in Cc.' => 'Cliente automáticamente agregado en Cc.',
        ...
        'Search for customers.' => 'Búsqueda de clientes.',
        ...
        'To add a new field, select the field type form one of the object\'s list, the object defines the boundary of the field and it can\'t be changed after the field creation.' =>
            'Para agregar un nuevo campo, seleccione el tipo de campo desde el listado de objetos, el objeto define el límite del campo y no puede ser cambiado despues de la creación del campo.',
        ...
        'Custom text for the page shown to customers that have no tickets yet.' =>
            'Texto personalizado que verán los clientes que aún no han creado tickets.',
        ...
        'DEPRECATED! This setting is not used any more and will be removed in a future version of OTRS.' =>
            'EN DESUSO! Esta opción no se usará mas y  será eliminada en una versión futura de OTRS.',

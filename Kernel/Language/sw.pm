...
Matatizo<br>&nbsp;-utendaji wa matatizo<br><br> tafadhali kumbuka kwamba mambo yanayosababishwa na kufanya kazi na kifurushi hayajausishwa kwneye makataba wa huduma wa OTRS.',
        ...
        'We are happy to welcome you as one of our contracting partners to upgrade to %s. You can start the upgrade now!' =>
            'Tunafuraha kukukaribisha kama mmoja wa mshika wetu kuboresha kwenda %s. Unaweza ukaanza uboreshaji sasa!',
        ...
        'Did not find a required feature? OTRS Group provides their service contract customers with exclusive Add-Ons:' =>
            'Kipangele kinachohitajika hakijapatikana? Kikundi cha OTRS kinatoa huduma zake kwa wateja wenye mkataba kwa vifaa vya nyongeza kipekee:',
        ...
        'Uninstall' => 'Sakinusha',
        'Reinstall' => 'Sakinisha',
        'Feature Add-Ons' => 'Kipengele cha Kifaa cha nyongeza',
...
"Mwaka wa kuanza wa muda wa kutengeneza tiketi=2010; Mwezi wa kuanza wa muda wa kutengeneza tiketi=10; Siku ya kuanza ya muda wa kutengeneza tiketi=4; Mwaka wa kuacha wa muda wa kutengeneza tiketi =2010; Mwezi wa kuacha wa muda wa kutengeneza tiketi = 11; Siku ya kuacha ya muda wa kutengeneza tiketi=3; ".',
        ...
        'Defines the receipent target of the phone ticket and the sender of the email ticket ("Queue" shows all queues, "SystemAddress" displays all system addresses) in the agent interface.' =>
            'Inafafanua lengo la mpokeaji wa tiketi za simu na mtumaji wa tiketi ya barua pepe ("Foleni" inaonyesha foleni zote, "Anwani ya Mfumo" inaonyesha anwani zote za mfumo) katika kiolesura cha mteja. ',
